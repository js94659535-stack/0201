...
### ✨ **현재 상태 (v4.2.0 - Quality Patch)**
- **✅ 완성**: UI + 학습엔진 v4.2 + 구조화 + PDF 전처리
- **⏳ 미완성**: LLM 연결, D1 연결, 프로덕션 배포
- **🔧 동작 모드**: quality-v4.2 (학습엔진 품질 패치)
...
- ✅ Standard: 30% (문장 선택)
- ✅ Detail: 55% (불릿 선택)
- 기존: 글자수 자르기 → **개선: 문장/불릿 선택**

#### **2. 구조화 포맷 혁신**
- ✅ **기존**: (1)(2)(3) 번호 나열
- ✅ **개선**: 논지/대립/현황/괴리/변천/시사점
- 학습엔진다운 7-섹션 구조

#### **3. 마인드맵 절단 방지**
- ✅ **기존**: "말하…", "듣기와…" 중간 절단
- ✅ **개선**: 노드 단위 축약 (shortenSentence)
- 쉼표 기준 완만 축약
...
#### **5. 계층적 일관성**
- ✅ detail 1회 생성 → server downsample
