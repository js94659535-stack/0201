...
// ../.wrangler/tmp/bundle-HIBi3s/checked-fetch.js
...
// ../.wrangler/tmp/bundle-HIBi3s/strip-cf-connecting-ip-header.js
...
var Lt = /* @__PURE__ */ __name((t, e, r) => e in t ? Ht(t, e, { enumerable: true, configurable: true, writable: true, value: r }) : t[e] = r, "Lt");
var x = /* @__PURE__ */ __name((t, e, r) => Lt(t, typeof e != "symbol" ? e + "" : e, r), "x");
var Je = /* @__PURE__ */ __name((t, e, r) => e.has(t) || et("Cannot " + r), "Je");
var h = /* @__PURE__ */ __name((t, e, r) => (Je(t, e, "read from private field"), r ? r.call(t) : e.get(t)), "h");
var w = /* @__PURE__ */ __name((t, e, r) => e.has(t) ? et("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, r), "w");
var g = /* @__PURE__ */ __name((t, e, r, s) => (Je(t, e, "write to private field"), s ? s.call(t, r) : e.set(t, r), r), "g");
var j = /* @__PURE__ */ __name((t, e, r) => (Je(t, e, "access private method"), r), "j");
var tt = /* @__PURE__ */ __name((t, e, r, s) => ({ set _(n) {
  g(t, e, n, r);
}, get _() {
  return h(t, e, s);
} }), "tt");
var rt = /* @__PURE__ */ __name((t, e, r) => (s, n) => {
  let i = -1;
  return a(0);
  async function a(l) {
    if (l <= i)
...
var qt = Symbol();
var Ft = /* @__PURE__ */ __name(async (t, e = /* @__PURE__ */ Object.create(null)) => {
...
var Yt = /* @__PURE__ */ __name((t) => Xe(t, decodeURI), "Yt");
...
var Ve = /* @__PURE__ */ __name((t) => /[%+]/.test(t) ? (t.indexOf("+") !== -1 && (t = t.replace(/\+/g, " ")), t.indexOf("%") !== -1 ? Xe(t, St) : t) : t, "Ve");
var bt = /* @__PURE__ */ __name((t, e, r) => {
  let s;
  if (!r && e && !/[%+]/.test(e)) {
    let a = t.indexOf("?", 8);
    if (a === -1)
...
var Qt = bt;
var Zt = /* @__PURE__ */ __name((t, e) => bt(t, e, true), "Zt");
var St = decodeURIComponent;
var st = /* @__PURE__ */ __name((t) => Xe(t, St), "st");
var xe;
var H;
var z;
var jt;
...
var er = { Stringify: 1 };
var Tt = /* @__PURE__ */ __name(async (t, e, r, s, n) => {
...
var fe;
var ft;
var rr = (ft = /* @__PURE__ */ __name(class {
  constructor(t, e) {
    w(this, Y);
    w(this, $e);
    w(this, Ie);
    ...
    x(this, "html", (t2, e2, r) => {
      const s = /* @__PURE__ */ __name((n) => j(this, Y, fe).call(this, n, e2, Be("text/html; charset=UTF-8", r)), "s");
...
var ar = /* @__PURE__ */ __name((t) => t.text("404 Not Found", 404), "ar");
...
var He;
var be;
var or = (be = /* @__PURE__ */ __name(class {
  constructor(e = {}) {
    w(this, k);
    x(this, "get");
    x(this, "post");
  ...
  route(e, r) {
    ...
    return r.routes.map((n) => {
      var a;
      let i;
      r.errorHandler === nt ? i = n.handler : (i = /* @__PURE__ */ __name(async (l, c) => (await rt([], r.errorHandler)(l, () => n.handler(l, c))).res, "i"), i[ir] = n.handler), j(a = s, k, te).call(a, n.method, n.path, i);
    }), this;
  }
  basePath(e) {
...
}, "be"), L = /* @__PURE__ */ new WeakMap(), k = /* @__PURE__ */ new WeakSet(), $t = /* @__PURE__ */ __name(function() {
...
}, "$t"), q = /* @__PURE__ */ new WeakMap(), te = /* @__PURE__ */ __name(function(e, r, s) {
...
}, "te"), Ne = /* @__PURE__ */ __name(function(e, r) {
  if (e instanceof Error)
    return this.errorHandler(e, r);
  throw e;
}, "Ne"), He = /* @__PURE__ */ __name(function(e, r, s, n) {
  if (n === "HEAD")
...
var F;
var ce;
var hr = (ce = /* @__PURE__ */ __name(class {
  constructor() {
    w(this, ne);
    w(this, ie);
...
var Me;
var pt;
var dr = (pt = /* @__PURE__ */ __name(class {
  constructor() {
...
var Ct;
var mt;
var gr = (mt = /* @__PURE__ */ __name(class {
  constructor() {
    w(this, Ge);
...
}, "mt"), X = /* @__PURE__ */ new WeakMap(), Q = /* @__PURE__ */ new WeakMap(), Ge = /* @__PURE__ */ new WeakSet(), Ct = /* @__PURE__ */ __name(function(t) {
  const e = [];
  let r = t === A;
...
var V;
var gt;
var xr = (gt = /* @__PURE__ */ __name(class {
  constructor(t) {
...
}, "Ee"), ee = /* @__PURE__ */ new WeakMap(), _ = /* @__PURE__ */ new WeakMap(), ae = /* @__PURE__ */ new WeakMap(), Se = /* @__PURE__ */ new WeakMap(), R = /* @__PURE__ */ new WeakMap(), B = /* @__PURE__ */ new WeakSet(), re = /* @__PURE__ */ __name(function(e, r, s, n) {
  const i = [];
...
var Pt = /* @__PURE__ */ __name(class extends or {
  constructor(t = {}) {
...
var kr = /* @__PURE__ */ __name(async (t, e) => {
  let r;
...
var $r = /* @__PURE__ */ __name((t) => async function(r, s) {
...
var Ir = /* @__PURE__ */ __name((t) => $r(t), "Ir");
function _t(t) {
  let e = 2166136261;
...
// ../.wrangler/tmp/bundle-HIBi3s/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-HIBi3s/middleware-loader.entry.ts
...
//# sourceMappingURL=bundledWorker-0.6572651444745172.mjs.map
