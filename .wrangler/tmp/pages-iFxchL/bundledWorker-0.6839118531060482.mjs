...
// ../.wrangler/tmp/bundle-iZzeH9/checked-fetch.js
...
// ../.wrangler/tmp/bundle-iZzeH9/strip-cf-connecting-ip-header.js
...
var Ht = /* @__PURE__ */ __name((t, e, r) => e in t ? Dt(t, e, { enumerable: true, configurable: true, writable: true, value: r }) : t[e] = r, "Ht");
var g = /* @__PURE__ */ __name((t, e, r) => Ht(t, typeof e != "symbol" ? e + "" : e, r), "g");
var Ve = /* @__PURE__ */ __name((t, e, r) => e.has(t) || et("Cannot " + r), "Ve");
var h = /* @__PURE__ */ __name((t, e, r) => (Ve(t, e, "read from private field"), r ? r.call(t) : e.get(t)), "h");
var y = /* @__PURE__ */ __name((t, e, r) => e.has(t) ? et("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, r), "y");
var m = /* @__PURE__ */ __name((t, e, r, n) => (Ve(t, e, "write to private field"), n ? n.call(t, r) : e.set(t, r), r), "m");
var E = /* @__PURE__ */ __name((t, e, r) => (Ve(t, e, "access private method"), r), "E");
var tt = /* @__PURE__ */ __name((t, e, r, n) => ({ set _(s) {
  m(t, e, s, r);
}, get _() {
  return h(t, e, n);
} }), "tt");
var rt = /* @__PURE__ */ __name((t, e, r) => (n, s) => {
  let i = -1;
  return a(0);
  async function a(c) {
    if (c <= i)
...
var Lt = Symbol();
var qt = /* @__PURE__ */ __name(async (t, e = /* @__PURE__ */ Object.create(null)) => {
  const { all: r = false, dot: n = false } = e, i = (t instanceof Et ? t.raw.headers : t.headers).get("Content-Type");
  return i != null && i.startsWith("multipart/form-data") || i != null && i.startsWith("application/x-www-form-urlencoded") ? Ft(t, { all: r, dot: n }) : {};
}, "qt");
...
var Bt = /* @__PURE__ */ __name((t) => {
  const { groups: e, path: r } = Gt(t), n = vt(r);
  return zt(n, e);
}, "Bt");
var Gt = /* @__PURE__ */ __name((t) => {
  const e = [];
...
var Ut = /* @__PURE__ */ __name((t, e) => {
  ...
  if (r) {
    const n = `${t}#${e}`;
    return Pe[n] || (r[2] ? Pe[n] = e && e[0] !== ":" && e[0] !== "*" ? [n, r[1], new RegExp(`^${r[2]}(?=/${e})`)] : [t, r[1], new RegExp(`^${r[2]}$`)] : Pe[n] = [t, r[1], true]), Pe[n];
  }
  return null;
}, "Ut");
var Ye = /* @__PURE__ */ __name((t, e) => {
  try {
    return e(t);
  } catch {
...
var Wt = /* @__PURE__ */ __name((t) => Ye(t, decodeURI), "Wt");
var yt = /* @__PURE__ */ __name((t) => {
  ...
  for (; n < e.length; n++) {
    ...
    if (s === 37) {
      ...
      return Wt(a.includes("%25") ? a.replace(/%25/g, "%2525") : a);
    } else if (s === 63)
      break;
  }
  return e.slice(r, n);
...
var de = /* @__PURE__ */ __name((t, e, ...r) => (r.length && (e = de(e, ...r)), `${(t == null ? void 0 : t[0]) === "/" ? "" : "/"}${t}${e === "/" ? "" : `${(t == null ? void 0 : t.at(-1)) === "/" ? "" : "/"}${(e == null ? void 0 : e[0]) === "/" ? e.slice(1) : e}`}`), "de");
...
var Be = /* @__PURE__ */ __name((t) => /[%+]/.test(t) ? (t.indexOf("+") !== -1 && (t = t.replace(/\+/g, " ")), t.indexOf("%") !== -1 ? Ye(t, bt) : t) : t, "Be");
var St = /* @__PURE__ */ __name((t, e, r) => {
  ...
  if (!r && e && !/[%+]/.test(e)) {
    ...
    for (t.startsWith(e, a + 1) || (a = t.indexOf(`&${e}`, a + 1)); a !== -1; ) {
      ...
      if (c === 61) {
        ...
        return Be(t.slice(l, o === -1 ? void 0 : o));
  ...
  for (; i !== -1; ) {
    ...
    if (n && (l = Be(l)), i = a, l === "")
      continue;
    let o;
    c === -1 ? o = "" : (o = t.slice(c + 1, a === -1 ? void 0 : a), n && (o = Be(o))), r ? (s[l] && Array.isArray(s[l]) || (s[l] = []), s[l].push(o)) : s[l] ?? (s[l] = o);
  }
  return e ? s[e] : s;
}, "St");
var Yt = St;
var Qt = /* @__PURE__ */ __name((t, e) => St(t, e, true), "Qt");
var bt = decodeURIComponent;
var nt = /* @__PURE__ */ __name((t) => Ye(t, bt), "nt");
var xe;
var H;
var z;
var jt;
...
var W;
var dt;
var Et = (dt = /* @__PURE__ */ __name(class {
  constructor(t, e = "/", r = [[]]) {
    y(this, z);
    g(this, "raw");
    y(this, xe);
    ...
    this.raw = t, this.path = e, m(this, H, r), m(this, xe, {});
  }
  param(t) {
    return t ? E(this, z, jt).call(this, t) : E(this, z, Ot).call(this);
  }
  query(t) {
    return Yt(this.url, t);
  }
  queries(t) {
  ...
  async parseBody(t) {
    var e;
    return (e = this.bodyCache).parsedBody ?? (e.parsedBody = await qt(this, t));
  }
  json() {
...
}, "dt"), xe = /* @__PURE__ */ new WeakMap(), H = /* @__PURE__ */ new WeakMap(), z = /* @__PURE__ */ new WeakSet(), jt = /* @__PURE__ */ __name(function(t) {
  const e = h(this, H)[0][this.routeIndex][1][t], r = E(this, z, We).call(this, e);
  return r && /\%/.test(r) ? nt(r) : r;
}, "jt"), Ot = /* @__PURE__ */ __name(function() {
  const t = {}, e = Object.keys(h(this, H)[0][this.routeIndex][1]);
  for (const r of e) {
    const n = E(this, z, We).call(this, h(this, H)[0][this.routeIndex][1][r]);
    n !== void 0 && (t[r] = /\%/.test(n) ? nt(n) : n);
  }
  return t;
}, "Ot"), We = /* @__PURE__ */ __name(function(t) {
  return h(this, H)[1] ? h(this, H)[1][t] : t;
}, "We"), W = /* @__PURE__ */ new WeakMap(), dt);
var Zt = { Stringify: 1 };
var Tt = /* @__PURE__ */ __name(async (t, e, r, n, s) => {
...
var Ge = /* @__PURE__ */ __name((t, e) => ({ "Content-Type": t, ...e }), "Ge");
var ke;
var Re;
var K;
var ve;
...
var fe;
var ft;
var tr = (ft = /* @__PURE__ */ __name(class {
  constructor(t, e) {
    y(this, X);
    y(this, ke);
    y(this, Re);
    ...
    y(this, Ce);
    y(this, Me);
    g(this, "render", (...t2) => (h(this, ye) ?? m(this, ye, (e2) => this.html(e2)), h(this, ye).call(this, ...t2)));
    g(this, "setLayout", (t2) => m(this, Ie, t2));
    g(this, "getLayout", () => h(this, Ie));
    g(this, "setRenderer", (t2) => {
      m(this, ye, t2);
    });
    g(this, "header", (t2, e2, r) => {
      this.finalized && m(this, N, new Response(h(this, N).body, h(this, N)));
      const n = h(this, N) ? h(this, N).headers : h(this, ne) ?? m(this, ne, new Headers());
    ...
    g(this, "set", (t2, e2) => {
      h(this, K) ?? m(this, K, /* @__PURE__ */ new Map()), h(this, K).set(t2, e2);
    });
    g(this, "get", (t2) => h(this, K) ? h(this, K).get(t2) : void 0);
    g(this, "newResponse", (...t2) => E(this, X, fe).call(this, ...t2));
    g(this, "body", (t2, e2, r) => E(this, X, fe).call(this, t2, e2, r));
    g(this, "text", (t2, e2, r) => !h(this, ne) && !h(this, ve) && !e2 && !r && !this.finalized ? new Response(t2) : E(this, X, fe).call(this, t2, e2, Ge(er, r)));
    g(this, "json", (t2, e2, r) => E(this, X, fe).call(this, JSON.stringify(t2), e2, Ge("application/json", r)));
    g(this, "html", (t2, e2, r) => {
      const n = /* @__PURE__ */ __name((s) => E(this, X, fe).call(this, s, e2, Ge("text/html; charset=UTF-8", r)), "n");
      return typeof t2 == "object" ? Tt(t2, Zt.Stringify, false, {}).then(n) : n(t2);
    });
    g(this, "redirect", (t2, e2) => {
      const r = String(t2);
      return this.header("Location", /[^\x00-\xFF]/.test(r) ? encodeURI(r) : r), this.newResponse(null, e2 ?? 302);
    });
    g(this, "notFound", () => (h(this, we) ?? m(this, we, () => new Response()), h(this, we).call(this, this)));
    m(this, ke, t), e && (m(this, V, e.executionCtx), this.env = e.env, m(this, we, e.notFoundHandler), m(this, Me, e.path), m(this, Ce, e.matchResult));
  }
  get req() {
    return h(this, Re) ?? m(this, Re, new Et(h(this, ke), h(this, Me), h(this, Ce))), h(this, Re);
  }
  get event() {
  ...
  get res() {
    return h(this, N) || m(this, N, new Response(null, { headers: h(this, ne) ?? m(this, ne, new Headers()) }));
  }
  set res(t) {
    if (h(this, N) && t) {
      t = new Response(t.body, t);
      for (const [e, r] of h(this, N).headers.entries())
        if (e !== "content-type")
          if (e === "set-cookie") {
    ...
    m(this, N, t), this.finalized = true;
  }
  get var() {
    return h(this, K) ? Object.fromEntries(h(this, K)) : {};
  }
}, "ft"), ke = /* @__PURE__ */ new WeakMap(), Re = /* @__PURE__ */ new WeakMap(), K = /* @__PURE__ */ new WeakMap(), ve = /* @__PURE__ */ new WeakMap(), V = /* @__PURE__ */ new WeakMap(), N = /* @__PURE__ */ new WeakMap(), Ie = /* @__PURE__ */ new WeakMap(), ye = /* @__PURE__ */ new WeakMap(), we = /* @__PURE__ */ new WeakMap(), ne = /* @__PURE__ */ new WeakMap(), Ce = /* @__PURE__ */ new WeakMap(), Me = /* @__PURE__ */ new WeakMap(), X = /* @__PURE__ */ new WeakSet(), fe = /* @__PURE__ */ __name(function(t, e, r) {
  const n = h(this, N) ? new Headers(h(this, N).headers) : h(this, ne) ?? new Headers();
  ...
  const s = typeof e == "number" ? e : (e == null ? void 0 : e.status) ?? h(this, ve);
...
var ir = /* @__PURE__ */ __name((t) => t.text("404 Not Found", 404), "ir");
var st = /* @__PURE__ */ __name((t, e) => {
  if ("getResponse" in t) {
...
var ar = (Se = /* @__PURE__ */ __name(class {
  constructor(e = {}) {
    ...
    g(this, "notFound", (e2) => (m(this, q, e2), this));
    g(this, "fetch", (e2, ...r) => E(this, $, He).call(this, e2, r[1], r[0], e2.method));
    g(this, "request", (e2, r, n2, s2) => e2 instanceof Request ? this.fetch(r ? new Request(e2, r) : e2, n2, s2) : (e2 = e2.toString(), this.fetch(new Request(/^https?:\/\//.test(e2) ? e2 : `http://localhost${de("/", e2)}`, r), n2, s2)));
    g(this, "fire", () => {
      addEventListener("fetch", (e2) => {
        e2.respondWith(E(this, $, He).call(this, e2.request, e2, void 0, e2.request.method));
      });
    });
    [...nr, rr].forEach((i) => {
      this[i] = (a, ...c) => (typeof a == "string" ? m(this, L, a) : E(this, $, te).call(this, i, h(this, L), a), c.forEach((l) => {
        E(this, $, te).call(this, i, h(this, L), l);
      }), this);
    }), this.on = (i, a, ...c) => {
      for (const l of [a].flat()) {
        ...
        for (const o of [i].flat())
          c.map((u) => {
            E(this, $, te).call(this, o.toUpperCase(), h(this, L), u);
          });
      }
      return this;
    }, this.use = (i, ...a) => (typeof i == "string" ? m(this, L, i) : (m(this, L, "*"), a.unshift(i)), a.forEach((c) => {
      E(this, $, te).call(this, A, h(this, L), c);
    }), this);
    const { strict: n, ...s } = e;
    Object.assign(this, s), this.getPath = n ?? true ? e.getPath ?? yt : Xt;
  }
  route(e, r) {
    ...
    return r.routes.map((s) => {
      var a;
      let i;
      r.errorHandler === st ? i = s.handler : (i = /* @__PURE__ */ __name(async (c, l) => (await rt([], r.errorHandler)(c, () => s.handler(c, l))).res, "i"), i[sr] = s.handler), E(a = n, $, te).call(a, s.method, s.path, i);
    }), this;
  }
  basePath(e) {
    const r = E(this, $, kt).call(this);
  ...
  mount(e, r, n) {
    ...
    s || (s = (() => {
      const l = de(this._basePath, e), o = l === "/" ? 0 : l.length;
      return (u) => {
    ...
    return E(this, $, te).call(this, A, de(e, "*"), c), this;
  }
}, "Se"), L = /* @__PURE__ */ new WeakMap(), $ = /* @__PURE__ */ new WeakSet(), kt = /* @__PURE__ */ __name(function() {
  const e = new Se({ router: this.router, getPath: this.getPath });
  return e.errorHandler = this.errorHandler, m(e, q, h(this, q)), e.routes = this.routes, e;
}, "kt"), q = /* @__PURE__ */ new WeakMap(), te = /* @__PURE__ */ __name(function(e, r, n) {
  ...
  if (s === "HEAD")
    return (async () => new Response(null, await E(this, $, He).call(this, e, r, n, "GET")))();
  const i = this.getPath(e, { env: n }), a = this.router.match(s, i), c = new tr(e, { path: i, matchResult: a, env: n, executionCtx: r, notFoundHandler: h(this, q) });
  if (a[0].length === 1) {
    let o;
    try {
      o = a[0][0][0][0](c, async () => {
        c.res = await h(this, q).call(this, c);
      });
    } catch (u) {
      return E(this, $, De).call(this, u, c);
    }
    return o instanceof Promise ? o.then((u) => u || (c.finalized ? c.res : h(this, q).call(this, c))).catch((u) => E(this, $, De).call(this, u, c)) : o ?? h(this, q).call(this, c);
  }
  const l = rt(a[0], this.errorHandler, h(this, q));
  return (async () => {
    try {
      const o = await l(c);
      if (!o.finalized)
      ...
      return E(this, $, De).call(this, o, c);
    }
  })();
}, "He"), Se);
var Rt = [];
...
var F;
var ce;
var ur = (ce = /* @__PURE__ */ __name(class {
  constructor() {
    y(this, se);
    y(this, ie);
    y(this, F, /* @__PURE__ */ Object.create(null));
  }
  insert(e, r, n, s, i) {
    if (e.length === 0) {
      if (h(this, se) !== void 0)
    ...
    const [a, ...c] = e, l = a === "*" ? c.length === 0 ? ["", "", Oe] : ["", "", qe] : a === "/*" ? ["", "", Te] : a.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);
    let o;
    if (l) {
      const u = l[1];
      let d = l[2] || qe;
      ...
      if (o = h(this, F)[d], !o) {
        ...
        if (i)
          return;
        o = h(this, F)[d] = new ce(), u !== "" && m(o, ie, s.varIndex++);
      }
      !i && u !== "" && n.push([u, h(o, ie)]);
  ...
  buildRegExpStr() {
    const r = Object.keys(h(this, F)).sort(lr).map((n) => {
      const s = h(this, F)[n];
      return (typeof h(s, ie) == "number" ? `(${n})@${h(s, ie)}` : cr.has(n) ? `\\${n}` : n) + s.buildRegExpStr();
    });
    return typeof h(this, se) == "number" && r.unshift(`#${h(this, se)}`), r.length === 0 ? "" : r.length === 1 ? r[0] : "(?:" + r.join("|") + ")";
  }
}, "ce"), se = /* @__PURE__ */ new WeakMap(), ie = /* @__PURE__ */ new WeakMap(), F = /* @__PURE__ */ new WeakMap(), ce);
var Fe;
var _e;
var pt;
var hr = (pt = /* @__PURE__ */ __name(class {
  constructor() {
    y(this, Fe, { varIndex: 0 });
    y(this, _e, new ur());
  }
  insert(t, e, r) {
    const n = [], s = [];
    ...
    return h(this, _e).insert(i, e, n, h(this, Fe), r), n;
  }
  buildRegExp() {
    let t = h(this, _e).buildRegExpStr();
    if (t === "")
      return [/^$/, [], []];
    let e = 0;
    const r = [], n = [];
...
}, "pt"), Fe = /* @__PURE__ */ new WeakMap(), _e = /* @__PURE__ */ new WeakMap(), pt);
...
var Ct;
var mt;
var mr = (mt = /* @__PURE__ */ __name(class {
  constructor() {
    y(this, Je);
  ...
  add(t, e, r) {
    ...
    if (/\*$/.test(e)) {
      ...
      t === A ? Object.keys(n).forEach((o) => {
        var u;
        (u = n[o])[e] || (u[e] = he(n[o], e) || he(n[A], e) || []);
      }) : (c = n[t])[e] || (c[e] = he(n[t], e) || he(n[A], e) || []), Object.keys(n).forEach((o) => {
    ...
    for (let l = 0, o = a.length; l < o; l++) {
      ...
      Object.keys(s).forEach((d) => {
        var f;
        (t === A || t === d) && ((f = s[d])[u] || (f[u] = [...he(n[d], u) || he(n[A], u) || []]), s[d][u].push([r, i - o + l + 1]));
      });
    }
  }
  buildAllMatchers() {
    ...
    return Object.keys(h(this, Q)).concat(Object.keys(h(this, Y))).forEach((e) => {
      t[e] || (t[e] = E(this, Je, Ct).call(this, e));
    }), m(this, Y, m(this, Q, void 0)), fr(), t;
  }
}, "mt"), Y = /* @__PURE__ */ new WeakMap(), Q = /* @__PURE__ */ new WeakMap(), Je = /* @__PURE__ */ new WeakSet(), Ct = /* @__PURE__ */ __name(function(t) {
  const e = [];
  let r = t === A;
...
var B;
var gt;
var gr = (gt = /* @__PURE__ */ __name(class {
  constructor(t) {
  ...
  match(t, e) {
    ...
    const r = h(this, Z), n = h(this, B), s = r.length;
    let i = 0, a;
    for (; i < s; i++) {
      const c = r[i];
      try {
      ...
      this.match = c.match.bind(c), m(this, Z, [c]), m(this, B, void 0);
      break;
    }
    if (i === s)
      throw new Error("Fatal error");
  ...
  get activeRouter() {
    if (h(this, B) || h(this, Z).length !== 1)
      throw new Error("No active router has been determined yet.");
    return h(this, Z)[0];
  }
}, "gt"), Z = /* @__PURE__ */ new WeakMap(), B = /* @__PURE__ */ new WeakMap(), gt);
...
var re;
var Ee;
var xr = (Ee = /* @__PURE__ */ __name(class {
  constructor(e, r, n) {
    y(this, G);
    y(this, ee);
    y(this, _);
    ...
    y(this, be, 0);
    y(this, I, je);
    if (m(this, _, n || /* @__PURE__ */ Object.create(null)), m(this, ee, []), e && r) {
  ...
  insert(e, r, n) {
    m(this, be, ++tt(this, be)._);
    let s = this;
    const i = Bt(r), a = [];
    for (let c = 0, l = i.length; c < l; c++) {
      const o = i[c], u = i[c + 1], d = Ut(o, u), f = Array.isArray(d) ? d[0] : o;
      if (f in h(s, _)) {
        s = h(s, _)[f], d && a.push(d[1]);
        continue;
      }
      h(s, _)[f] = new Ee(), d && (h(s, ae).push(d), a.push(d[1])), s = h(s, _)[f];
    }
    return h(s, ee).push({ [e]: { handler: n, possibleKeys: a.filter((c, l, o) => o.indexOf(c) === l), score: h(this, be) } }), s;
  }
  search(e, r) {
    var l;
    const n = [];
    ...
    for (let o = 0, u = a.length; o < u; o++) {
      ...
      for (let x = 0, O = i.length; x < O; x++) {
        const v = i[x], j = h(v, _)[d];
        j && (m(j, I, h(v, I)), f ? (h(j, _)["*"] && n.push(...E(this, G, re).call(this, h(j, _)["*"], e, h(v, I))), n.push(...E(this, G, re).call(this, j, e, h(v, I)))) : p.push(j));
        for (let b = 0, P = h(v, ae).length; b < P; b++) {
          const D = h(v, ae)[b], T = h(v, I) === je ? {} : { ...h(v, I) };
          if (D === "*") {
            const R = h(v, _)["*"];
            R && (n.push(...E(this, G, re).call(this, R, e, h(v, I))), m(R, I, T), p.push(R));
            continue;
          }
          const [Ne, U, w] = D;
          if (!d && !(w instanceof RegExp))
            continue;
          const S = h(v, _)[Ne], C = a.slice(o).join("/");
          if (w instanceof RegExp) {
            const R = w.exec(C);
            if (R) {
              if (T[U] = R[0], n.push(...E(this, G, re).call(this, S, e, h(v, I), T)), Object.keys(h(S, _)).length) {
                m(S, I, T);
                const k = ((l = R[0].match(/\//)) == null ? void 0 : l.length) ?? 0;
                (c[k] || (c[k] = [])).push(S);
              }
              continue;
            }
          }
          (w === true || w.test(d)) && (T[U] = d, f ? (n.push(...E(this, G, re).call(this, S, e, T, h(v, I))), h(S, _)["*"] && n.push(...E(this, G, re).call(this, h(S, _)["*"], e, T, h(v, I)))) : (m(S, I, T), p.push(S)));
        }
      }
      i = p.concat(c.shift() ?? []);
    }
...
}, "Ee"), ee = /* @__PURE__ */ new WeakMap(), _ = /* @__PURE__ */ new WeakMap(), ae = /* @__PURE__ */ new WeakMap(), be = /* @__PURE__ */ new WeakMap(), I = /* @__PURE__ */ new WeakMap(), G = /* @__PURE__ */ new WeakSet(), re = /* @__PURE__ */ __name(function(e, r, n, s) {
  const i = [];
  for (let a = 0, c = h(e, ee).length; a < c; a++) {
    const l = h(e, ee)[a], o = l[r] || l[A], u = {};
    if (o !== void 0 && (o.params = /* @__PURE__ */ Object.create(null), i.push(o), n !== je || s && s !== je))
...
var oe;
var xt;
var vr = (xt = /* @__PURE__ */ __name(class {
  constructor() {
...
var Mt = /* @__PURE__ */ __name(class extends ar {
  constructor(t = {}) {
    super(t), this.router = t.router ?? new gr({ routers: [new mr(), new vr()] });
  }
}, "Mt");
var yr = /* @__PURE__ */ __name((t) => {
...
var jr = Object.keys(_t);
var Or = "index.html";
var Tr = /* @__PURE__ */ __name((t) => {
  const e = t.root ?? "./", r = t.path, n = t.join ?? Er;
  return async (s, i) => {
    var u, d, f, p;
    if (s.finalized)
      return i();
    ...
    t.isDir && await t.isDir(c) && (c = n(c, Or));
    ...
    if (o) {
      ...
      if (s.header("Content-Type", x || "application/octet-stream"), t.precompressed && (!x || wr.test(x))) {
...
var Ar = /* @__PURE__ */ __name(async (t, e) => {
  let r;
...
var $r = /* @__PURE__ */ __name((t) => async function(r, n) {
  return Tr({ ...t, getContent: async (i) => Ar(i, { manifest: t.manifest, namespace: t.namespace ? t.namespace : r.env ? r.env.__STATIC_CONTENT : void 0 }) })(r, n);
}, "$r");
var kr = /* @__PURE__ */ __name((t) => $r(t), "kr");
function Rr(t) {
  let e = 2166136261;
...
__name(ot, "ot");
function ze(t, e) {
  const r = e === "brief", n = e === "standard", s = M(t.narrative.coreClaim, r ? 80 : n ? 100 : 120), i = r ? 3 : n ? 5 : 7, a = (t.narrative.grounds || []).slice(0, i).map((w) => M(w, r ? 90 : n ? 120 : 150)), c = r ? 1 : n ? 2 : 3, l = (t.narrative.comparisons || []).slice(0, c).map((w) => M(w, r ? 100 : n ? 140 : 180)), o = r || n ? 2 : 3, u = (t.narrative.implications || []).slice(0, o).map((w) => M(w, r ? 100 : n ? 140 : 160));
  let d = "";
  if (e === "detail")
    d = String(t.narrative.summaryDetail || "").trim();
  else {
    const w = [];
    if (w.push(`${s}`), a.length > 0) {
      const R = a.map((k, ue) => r ? `${k}` : ue === 0 ? `${k}` : `\uB610\uD55C ${k}`).join(r ? ", " : ". ");
      w.push(R);
    }
    if (!r && l.length > 0) {
      const R = l.map((k, ue) => ue === 0 ? `${k}` : `\uBC18\uBA74 ${k}`).join(". ");
      w.push(R);
    }
    if (u.length > 0) {
      const R = u.map((k, ue) => r ? k : ue === 0 ? `\uC774\uB294 ${k}` : `\uB354\uBD88\uC5B4 ${k}`).join(". ");
      w.push(R);
    }
    d = w.join(". ") + ".";
    const S = 1423, C = r ? S * 0.1 : S * 0.25;
    d.length < C && r && l.length > 0 && (d += ` ${l[0]}.`);
  }
  const f = t.structured.toc || [], p = r ? 2 : n ? 4 : 10, x = (t.structured.glossary || []).slice(0, p).map((w) => ({ term: M(w.term, 20), def: M(w.def, r ? 70 : 120) })), O = r ? 2 : n ? 3 : 5, v = /* @__PURE__ */ __name((w) => (w || []).map((S) => ({ title: M(S.title, 60), keywords: (S.keywords || []).slice(0, r ? 3 : n ? 4 : 6).map((C) => M(C, 16)), bullets: (S.bullets || []).slice(0, O).map((C) => M(C, r ? 90 : 140)), children: S.children ? v(S.children) : void 0 })), "v"), j = v(t.structured.hierarchy || []), b = Ir({ toc: f, hierarchy: j, glossary: x }), P = JSON.parse(JSON.stringify(t.mindmap || { title: "\uB9C8\uC778\uB4DC\uB9F5", children: [] })), D = r ? 70 : n ? 110 : 160, T = r ? 2 : 3;
  for (const w of P.children || [])
    for (const S of w.children || [])
      Array.isArray(S.pack) && (S.pack = S.pack.slice(0, T).map((C) => M(C, 20))), typeof S.explain == "string" && (S.explain = M(S.explain, D)), Array.isArray(S.children) || (S.children = []);
  const Ne = r || n ? 2 : 4, U = (t.selftest.items || []).slice(0, Ne).map((w) => {
    var S, C, R;
    return { id: w.id, type: w.type, question: M(w.question, r ? 140 : 220), hint: w.hint ? M(w.hint, r ? 90 : 140) : void 0, rubric: { mustInclude: (((S = w.rubric) == null ? void 0 : S.mustInclude) || []).slice(0, r ? 2 : 4).map((k) => M(k, 20)), mustNotInclude: (((C = w.rubric) == null ? void 0 : C.mustNotInclude) || []).slice(0, 2).map((k) => M(k, 20)), maxChars: ((R = w.rubric) == null ? void 0 : R.maxChars) ?? (r ? 140 : 220) }, answerKey: w.answerKey ? M(w.answerKey, r ? 160 : 260) : void 0 };
  });
  return { narrative: { text: d, coreClaim: s, grounds: a, comparisons: l, implications: u }, structured: { text: b, toc: f, hierarchy: j, glossary: x }, mindmap: { tree: P }, selftest: { passScorePct: 90, items: U } };
}
__name(ze, "ze");
function Ir(t) {
  var n, s;
...
`);
      ...
      const d = ze(o, "brief"), f = ze(o, "standard"), p = ze(o, "detail"), x = Mr({ brief: d, standard: f, detail: p });
      if (x.length)
...
__name(Dr, "Dr");
function Hr(t, e) {
  const r = Math.max(60, ge(t)), n = 0.53, s = Math.floor(r * n * 0.85), i = Math.ceil(r * n * 1.15), a = Math.floor(r * n), c = Math.ceil(r * 0.05);
  return { base: r, min: s, max: i, keep: a, tol: c };
}
__name(Hr, "Hr");
function Lr(t) {
  const e = String((t == null ? void 0 : t.text) || "").trim(), r = Dr((t == null ? void 0 : t.viewType) || "narrative"), n = Pr(t == null ? void 0 : t.level), s = "detail", { base: i, min: a, max: c } = Hr(e), l = String((t == null ? void 0 : t.grade) || "general").toLowerCase(), o = String((t == null ? void 0 : t.subject) || "general").toLowerCase(), d = ["\uB2F9\uC2E0\uC740 \uD559\uC2B5 \uCF58\uD150\uCE20\uB97C \uCC38\uACE0\uC11C/\uAD50\uACFC\uC11C \uC218\uC900\uC73C\uB85C \uC7AC\uAD6C\uC131\uD558\uB294 \uC9C0\uC2DD \uAD6C\uC870\uD654 \uC5D4\uC9C4\uC785\uB2C8\uB2E4.", `
[\uAD6C\uC870\uD654 \uD575\uC2EC \uC9C0\uCE68(\uAC15\uC81C)]
- \uD559\uC2B5 \uB2E8\uC704(Learning Unit):
...
__name(Fr, "Fr");
function me(t, e) {
  const n = Ke(t).map((i, a) => ({ s: i, i: a, score: Fr(i) }));
  return n.sort((i, a) => a.score - i.score || i.i - a.i), n.slice(0, Nr(e, 1, 12)).sort((i, a) => i.i - a.i).map((i) => i.s);
}
__name(me, "me");
function ge(t) {
...
__name(ge, "ge");
var Xe = { brief: { min: 0.1, max: 0.18 }, standard: { min: 0.25, max: 0.38 }, detail: { min: 0.45, max: 0.62 } };
function lt(t, e, r) {
  const n = Math.max(60, ge(t)), s = ge(e), i = Math.floor(n * Xe[r].min), a = Math.ceil(n * Xe[r].max);
...
__name(lt, "lt");
function $e(t, e, r) {
  const n = Math.max(60, ge(t)), s = Math.ceil(n * Xe[r].max);
  let i = String(e || "").trim();
  if (ge(i) <= s)
    return i;
  const a = Ke(i);
...
__name(Ue, "Ue");
function Jr(t) {
  const e = Ze(t), r = { id: "root", title: "\uD575\uC2EC \uAD6C\uC870", type: "root", collapsed: false, children: [] }, n = /* @__PURE__ */ new Map();
  return e.forEach((s, i) => {
    const a = Ue("sec", i + 1), c = { id: a, title: s.title, type: "section", collapsed: false, children: [] }, l = me(s.body, 6), o = [];
    for (const b of l)
      (b.match(/[가-힣A-Za-z·/()]{2,20}/g) || []).slice(0, 8).forEach((D) => {
        const T = D.replace(/[()]/g, "").trim();
        T.length >= 2 && T.length <= 12 && !/^(그리고|하지만|또한|이와|이에|우선|한편)$/.test(T) && o.push(T);
      });
    const u = /* @__PURE__ */ new Map();
    o.forEach((b) => u.set(b, (u.get(b) || 0) + 1));
    const d = Array.from(u.entries()).sort((b, P) => P[1] - b[1]).map((b) => b[0]).filter((b) => b.length <= 10).slice(0, 3), f = me(s.body, 3).join(" "), p = me(s.body, 2).join(" "), x = me(s.body, 1).join(" "), O = { id: Ue(a + "_kw", 1), title: "\uD575\uC2EC \uAC1C\uB150", type: "keyword", collapsed: false, pack: d, explain: f, explainStandard: p, explainBrief: x, children: [] };
    d.forEach((b) => {
      n.has(b) || n.set(b, `\uBCF8\uBB38 \uB9E5\uB77D\uC5D0\uC11C "${b}"\uC758 \uD575\uC2EC \uC758\uBBF8\uB97C \uC694\uC57D\uD558\uBA74, ${me(s.body, 1)[0] || "\uAD00\uB828 \uB0B4\uC6A9\uC758 \uD575\uC2EC \uAC1C\uB150\uC774\uB2E4."}`);
    });
    const j = Ke(s.body).filter((b) => /(\d{4}|%|가산점|전형|평가|프로그램|운영)/.test(b)).slice(0, 2);
    j.length && O.children.push({ id: Ue(a + "_adv", 1), title: j.join(" "), type: "advanced", collapsed: true, children: [] }), c.children.push(O), r.children.push(c);
...
function Kr(t, e, r, n) {
  ...
  }), c = n === "brief" ? 4 : n === "standard" ? 6 : 10, l = r.slice(0, c).map((u) => ({ term: u.term, def: $e(t, u.def, n) })), o = [];
  return o.push("\u2160. \uBAA9\uCC28"), s.forEach((u, d) => o.push(`  ${d + 1}. ${u}`)), o.push(""), o.push("\u2161. \uD575\uC2EC \uC815\uB9AC(\uC704\uACC4)"), a.forEach((u, d) => {
    var f;
    o.push(`  ${d + 1}. ${u.title}`), (f = u.key) != null && f.length && o.push(`     - \uD575\uC2EC\uD0A4\uC6CC\uB4DC: ${u.key.join(" \xB7 ")}`), u.summary && o.push(`     - \uC694\uC9C0: ${$e(t, u.summary, n)}`), o.push("");
...
__name(Kr, "Kr");
function Vr(t, e) {
  const r = Ze(t), n = e === "brief" ? 2 : e === "standard" ? 4 : 7, s = [];
  r.forEach((a) => {
...
function Br(t, e) {
  Ze(t);
  const r = Ke(t), n = [], s = r.find((c) => /(일컫|정의|란)/.test(c)) || r[0] || "";
...
__name(Gr, "Gr");
function ut(t) {
  const e = le(t), { tree: r, glossary: n } = Jr(e), s = { originalMeta: { textHash: Qe(e), chars: e.length, ts: Ae() }, modes: {} };
  return ["detail", "standard", "brief"].forEach((i) => {
    const a = Vr(e, i), c = Kr(e, r, n, i), l = Nt(r, i), o = Br(e), d = lt(e, a, i).ok ? a : $e(e, a, i), f = c.renderText || "", p = lt(e, f, i);
    c.renderText = p.ok ? f : $e(e, f, i), s.modes[i] = { narrative: d, structured: c, mindmap: { tree: l }, selftest: o };
  }), s;
}
__name(ut, "ut");
...
J.post("/api/engine", async (t) => {
  ...
  if (c && t.env.GEMINI_API_KEY)
    try {
      const D = Lr({ text: l, viewType: s, level: "detail", grade: i, subject: a }), T = t.env.GEMINI_MODEL || "gemini-2.0-flash-exp", U = await (await fetch(`https://generativelanguage.googleapis.com/v1beta/models/${T}:generateContent?key=${t.env.GEMINI_API_KEY}`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ contents: [{ parts: [{ text: D }] }], generationConfig: { temperature: 0.7, maxOutputTokens: 8192 } }) })).json(), S = (((j = (v = (O = (x = (p = U == null ? void 0 : U.candidates) == null ? void 0 : p[0]) == null ? void 0 : x.content) == null ? void 0 : O.parts) == null ? void 0 : v[0]) == null ? void 0 : j.text) || "").match(/\{[\s\S]*\}/);
      if (S) {
        const C = JSON.parse(S[0]);
        u = { originalMeta: { textHash: Qe(l), chars: l.length, ts: Ae() }, modes: { detail: { [s]: C }, standard: { [s]: C }, brief: { [s]: C } } }, o = "gemini-" + T;
      } else
        throw new Error("Gemini \uC751\uB2F5\uC744 JSON\uC73C\uB85C \uD30C\uC2F1\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.");
    } catch (D) {
      console.error("[Gemini Error]", D), u = ut(l), o = "v5-local-fallback";
    }
  else
    u = ut(l);
  const d = (P = (b = u.modes) == null ? void 0 : b[n]) == null ? void 0 : P[s], f = { engine: o, mode: n, viewType: s, ts: Ae(), textHash: u.originalMeta.textHash, grade: i, subject: a };
  return t.json({ ok: true, data: d, allSummaries: u.modes, meta: f });
});
J.post("/api/selftest/score", async (t) => {
  const e = await t.req.json().catch(() => ({})), r = Array.isArray(e == null ? void 0 : e.questions) ? e.questions : [], n = e != null && e.answers && typeof e.answers == "object" ? e.answers : {}, s = Gr(r, n);
...
J.post("/api/saveSummary", async (t) => {
  ...
  const a = String((r == null ? void 0 : r.id) || `s_${Date.now()}_${Math.random().toString(36).slice(2, 8)}`), c = Ae(), l = Qe(s), o = JSON.stringify(i);
...
var ht = new Mt();
var zr = Object.assign({ "/src/index.tsx": J });
var Pt = false;
for (const [, t] of Object.entries(zr))
...
// ../.wrangler/tmp/bundle-iZzeH9/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-iZzeH9/middleware-loader.entry.ts
...
//# sourceMappingURL=bundledWorker-0.6839118531060482.mjs.map
