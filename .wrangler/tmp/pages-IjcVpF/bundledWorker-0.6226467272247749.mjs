...
// ../.wrangler/tmp/bundle-DjBHyP/checked-fetch.js
...
// ../.wrangler/tmp/bundle-DjBHyP/strip-cf-connecting-ip-header.js
...
var A = /* @__PURE__ */ __name((t, e, r) => e.has(t) ? st("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, r), "A");
var E = /* @__PURE__ */ __name((t, e, r, n) => (We(t, e, "write to private field"), n ? n.call(t, r) : e.set(t, r), r), "E");
...
var Xe = /* @__PURE__ */ __name((t) => /[%+]/.test(t) ? (t.indexOf("+") !== -1 && (t = t.replace(/\+/g, " ")), t.indexOf("%") !== -1 ? nt(t, Ct) : t) : t, "Xe");
var _t = /* @__PURE__ */ __name((t, e, r) => {
  let n;
  if (!r && e && !/[%+]/.test(e)) {
    let a = t.indexOf("?", 8);
    if (a === -1)
...
var pr = _t;
var fr = /* @__PURE__ */ __name((t, e) => _t(t, e, true), "fr");
var Ct = decodeURIComponent;
var ot = /* @__PURE__ */ __name((t) => nt(t, Ct), "ot");
var ye;
var G;
var ee;
var Rt;
...
var te;
var vt;
var Nt = (vt = /* @__PURE__ */ __name(class {
  constructor(t, e = "/", r = [[]]) {
    A(this, ee);
    S(this, "raw");
    A(this, ye);
    ...
    this.raw = t, this.path = e, E(this, G, r), E(this, ye, {});
  }
  param(t) {
    return t ? R(this, ee, Rt).call(this, t) : R(this, ee, Mt).call(this);
  }
  query(t) {
...
}, "vt"), ye = /* @__PURE__ */ new WeakMap(), G = /* @__PURE__ */ new WeakMap(), ee = /* @__PURE__ */ new WeakSet(), Rt = /* @__PURE__ */ __name(function(t) {
  const e = d(this, G)[0][this.routeIndex][1][t], r = R(this, ee, rt).call(this, e);
  return r && /\%/.test(r) ? ot(r) : r;
}, "Rt"), Mt = /* @__PURE__ */ __name(function() {
  const t = {}, e = Object.keys(d(this, G)[0][this.routeIndex][1]);
  for (const r of e) {
    const n = R(this, ee, rt).call(this, d(this, G)[0][this.routeIndex][1][r]);
    n !== void 0 && (t[r] = /\%/.test(n) ? ot(n) : n);
  }
  return t;
}, "Mt"), rt = /* @__PURE__ */ __name(function(t) {
...
var ve;
var bt;
var xr = (bt = /* @__PURE__ */ __name(class {
  constructor(t, e) {
    A(this, re);
    A(this, ke);
    A(this, Ie);
    ...
    S(this, "setLayout", (t2) => E(this, $e, t2));
    S(this, "getLayout", () => d(this, $e));
    S(this, "setRenderer", (t2) => {
      E(this, Se, t2);
    });
    S(this, "header", (t2, e2, r) => {
      this.finalized && E(this, B, new Response(d(this, B).body, d(this, B)));
      const n = d(this, B) ? d(this, B).headers : d(this, le) ?? E(this, le, new Headers());
    ...
    S(this, "set", (t2, e2) => {
      d(this, W) ?? E(this, W, /* @__PURE__ */ new Map()), d(this, W).set(t2, e2);
    });
    S(this, "get", (t2) => d(this, W) ? d(this, W).get(t2) : void 0);
    S(this, "newResponse", (...t2) => R(this, re, ve).call(this, ...t2));
    S(this, "body", (t2, e2, r) => R(this, re, ve).call(this, t2, e2, r));
    S(this, "text", (t2, e2, r) => !d(this, le) && !d(this, Ee) && !e2 && !r && !this.finalized ? new Response(t2) : R(this, re, ve).call(this, t2, e2, Qe(gr, r)));
    S(this, "json", (t2, e2, r) => R(this, re, ve).call(this, JSON.stringify(t2), e2, Qe("application/json", r)));
    S(this, "html", (t2, e2, r) => {
      const n = /* @__PURE__ */ __name((s) => R(this, re, ve).call(this, s, e2, Qe("text/html; charset=UTF-8", r)), "n");
    ...
    E(this, ke, t), e && (E(this, X, e.executionCtx), this.env = e.env, E(this, Oe, e.notFoundHandler), E(this, Le, e.path), E(this, Pe, e.matchResult));
  }
  get req() {
    return d(this, Ie) ?? E(this, Ie, new Nt(d(this, ke), d(this, Le), d(this, Pe))), d(this, Ie);
  }
  get event() {
  ...
  get res() {
    return d(this, B) || E(this, B, new Response(null, { headers: d(this, le) ?? E(this, le, new Headers()) }));
  }
  set res(t) {
    if (d(this, B) && t) {
      t = new Response(t.body, t);
      for (const [e, r] of d(this, B).headers.entries())
        if (e !== "content-type")
          if (e === "set-cookie") {
            const n = d(this, B).headers.getSetCookie();
    ...
    E(this, B, t), this.finalized = true;
  }
  get var() {
    return d(this, W) ? Object.fromEntries(d(this, W)) : {};
  }
}, "bt"), ke = /* @__PURE__ */ new WeakMap(), Ie = /* @__PURE__ */ new WeakMap(), W = /* @__PURE__ */ new WeakMap(), Ee = /* @__PURE__ */ new WeakMap(), X = /* @__PURE__ */ new WeakMap(), B = /* @__PURE__ */ new WeakMap(), $e = /* @__PURE__ */ new WeakMap(), Se = /* @__PURE__ */ new WeakMap(), Oe = /* @__PURE__ */ new WeakMap(), le = /* @__PURE__ */ new WeakMap(), Pe = /* @__PURE__ */ new WeakMap(), Le = /* @__PURE__ */ new WeakMap(), re = /* @__PURE__ */ new WeakSet(), ve = /* @__PURE__ */ __name(function(t, e, r) {
  const n = d(this, B) ? new Headers(d(this, B).headers) : d(this, le) ?? new Headers();
...
var Ge;
var Te;
var Er = (Te = /* @__PURE__ */ __name(class {
  constructor(e = {}) {
    A(this, $);
    S(this, "get");
    S(this, "post");
    ...
    S(this, "fetch", (e2, ...r) => R(this, $, Ge).call(this, e2, r[1], r[0], e2.method));
    ...
    [...br, vr].forEach((i) => {
      this[i] = (a, ...o) => (typeof a == "string" ? E(this, K, a) : R(this, $, oe).call(this, i, d(this, K), a), o.forEach((l) => {
        R(this, $, oe).call(this, i, d(this, K), l);
      }), this);
    }), this.on = (i, a, ...o) => {
      for (const l of [a].flat()) {
        ...
        for (const c of [i].flat())
          o.map((u) => {
            R(this, $, oe).call(this, c.toUpperCase(), d(this, K), u);
          });
      }
      return this;
    }, this.use = (i, ...a) => (typeof i == "string" ? E(this, K, i) : (E(this, K, "*"), a.unshift(i)), a.forEach((o) => {
      R(this, $, oe).call(this, I, d(this, K), o);
    }), this);
    const { strict: n, ...s } = e;
  ...
  route(e, r) {
    ...
    return r.routes.map((s) => {
      var a;
      let i;
      r.errorHandler === ct ? i = s.handler : (i = /* @__PURE__ */ __name(async (o, l) => (await it([], r.errorHandler)(o, () => s.handler(o, l))).res, "i"), i[wr] = s.handler), R(a = n, $, oe).call(a, s.method, s.path, i);
    }), this;
  }
  basePath(e) {
  ...
  mount(e, r, n) {
    ...
    return R(this, $, oe).call(this, I, xe(e, "*"), o), this;
  }
}, "Te"), K = /* @__PURE__ */ new WeakMap(), $ = /* @__PURE__ */ new WeakSet(), $t = /* @__PURE__ */ __name(function() {
...
}, "$t"), z = /* @__PURE__ */ new WeakMap(), oe = /* @__PURE__ */ __name(function(e, r, n) {
  ...
  if (a[0].length === 1) {
    ...
    return c instanceof Promise ? c.then((u) => u || (o.finalized ? o.res : d(this, z).call(this, o))).catch((u) => R(this, $, qe).call(this, u, o)) : c ?? d(this, z).call(this, o);
  }
  ...
  return (async () => {
    try {
      ...
      return R(this, $, qe).call(this, c, o);
    }
  })();
}, "Ge"), Te);
var Pt = [];
...
var U;
var me;
var Ar = (me = /* @__PURE__ */ __name(class {
  constructor() {
    A(this, de);
    A(this, ue);
    A(this, U, /* @__PURE__ */ Object.create(null));
  }
  insert(e, r, n, s, i) {
    if (e.length === 0) {
      if (d(this, de) !== void 0)
    ...
    if (l) {
      ...
      if (u && l[2] && (h === ".*" || (h = h.replace(/^\((?!\?:)(?=[^)]+\)$)/, "(?:"), /\((?!\?:)/.test(h))))
        throw be;
      if (c = d(this, U)[h], !c) {
        if (Object.keys(d(this, U)).some((m) => m !== Me && m !== je))
          throw be;
        if (i)
          return;
        c = d(this, U)[h] = new me(), u !== "" && E(c, ue, s.varIndex++);
      }
      !i && u !== "" && n.push([u, d(c, ue)]);
    } else if (c = d(this, U)[a], !c) {
      if (Object.keys(d(this, U)).some((u) => u.length > 1 && u !== Me && u !== je))
        throw be;
      if (i)
        return;
      c = d(this, U)[a] = new me();
  ...
  buildRegExpStr() {
    const r = Object.keys(d(this, U)).sort(Tr).map((n) => {
      const s = d(this, U)[n];
...
}, "me"), de = /* @__PURE__ */ new WeakMap(), ue = /* @__PURE__ */ new WeakMap(), U = /* @__PURE__ */ new WeakMap(), me);
var Ue;
var He;
var wt;
var _r = (wt = /* @__PURE__ */ __name(class {
  constructor() {
    A(this, Ue, { varIndex: 0 });
    A(this, He, new Ar());
  }
  insert(t, e, r) {
    const n = [], s = [];
    ...
    return d(this, He).insert(i, e, n, d(this, Ue), r), n;
  }
  buildRegExp() {
    let t = d(this, He).buildRegExpStr();
    if (t === "")
      return [/^$/, [], []];
    let e = 0;
    const r = [], n = [];
...
function Rr(t) {
  ...
  if (t.length === 0)
    return Cr;
  const n = t.map((u) => [!/\*|\/:/.test(u[0]), ...u]).sort(([u, h], [m, b]) => u ? 1 : m ? -1 : h.length - b.length), s = /* @__PURE__ */ Object.create(null);
  for (let u = 0, h = -1, m = n.length; u < m; u++) {
    const [b, O, _] = n[u];
    b ? s[O] = [_.map(([M]) => [M, /* @__PURE__ */ Object.create(null)]), Pt] : h++;
    let T;
    try {
      T = e.insert(O, h, b);
    } catch (M) {
      throw M === be ? new It(O) : M;
    }
    b || (r[h] = _.map(([M, C]) => {
  ...
  for (let u = 0, h = r.length; u < h; u++)
    for (let m = 0, b = r[u].length; m < b; m++) {
...
var Ht;
var yt;
var Mr = (yt = /* @__PURE__ */ __name(class {
  constructor() {
    A(this, Je);
    ...
    A(this, se);
    S(this, "match", Sr);
    E(this, ne, { [I]: /* @__PURE__ */ Object.create(null) }), E(this, se, { [I]: /* @__PURE__ */ Object.create(null) });
  }
  add(t, e, r) {
    var o;
    ...
    if (!n || !s)
      throw new Error(kt);
    n[t] || [n, s].forEach((l) => {
      l[t] = /* @__PURE__ */ Object.create(null), Object.keys(l[I]).forEach((c) => {
        l[t][c] = [...l[I][c]];
      });
    }), e === "/*" && (e = "*");
    ...
    if (/\*$/.test(e)) {
      const l = Lt(e);
      t === I ? Object.keys(n).forEach((c) => {
        var u;
        (u = n[c])[e] || (u[e] = ge(n[c], e) || ge(n[I], e) || []);
      }) : (o = n[t])[e] || (o[e] = ge(n[t], e) || ge(n[I], e) || []), Object.keys(n).forEach((c) => {
        (t === I || t === c) && Object.keys(n[c]).forEach((u) => {
          l.test(u) && n[c][u].push([r, i]);
        });
      }), Object.keys(s).forEach((c) => {
        (t === I || t === c) && Object.keys(s[c]).forEach((u) => l.test(u) && s[c][u].push([r, i]));
      });
      return;
    }
    const a = At(e) || [e];
    for (let l = 0, c = a.length; l < c; l++) {
      ...
      Object.keys(s).forEach((h) => {
        var m;
        (t === I || t === h) && ((m = s[h])[u] || (m[u] = [...ge(n[h], u) || ge(n[I], u) || []]), s[h][u].push([r, i - c + l + 1]));
      });
    }
  }
  buildAllMatchers() {
    ...
    return Object.keys(d(this, se)).concat(Object.keys(d(this, ne))).forEach((e) => {
      t[e] || (t[e] = R(this, Je, Ht).call(this, e));
    }), E(this, ne, E(this, se, void 0)), Nr(), t;
  }
}, "yt"), ne = /* @__PURE__ */ new WeakMap(), se = /* @__PURE__ */ new WeakMap(), Je = /* @__PURE__ */ new WeakSet(), Ht = /* @__PURE__ */ __name(function(t) {
  const e = [];
  let r = t === I;
...
var ce;
var _e;
var kr = (_e = /* @__PURE__ */ __name(class {
  constructor(e, r, n) {
    A(this, Z);
    A(this, ie);
    A(this, D);
    ...
    A(this, Ae, 0);
    A(this, L, Ne);
    if (E(this, D, n || /* @__PURE__ */ Object.create(null)), E(this, ie, []), e && r) {
  ...
  insert(e, r, n) {
    E(this, Ae, ++at(this, Ae)._);
    let s = this;
    const i = or(r), a = [];
    for (let o = 0, l = i.length; o < l; o++) {
      const c = i[o], u = i[o + 1], h = dr(c, u), m = Array.isArray(h) ? h[0] : c;
      if (m in d(s, D)) {
        s = d(s, D)[m], h && a.push(h[1]);
        continue;
      }
      d(s, D)[m] = new _e(), h && (d(s, he).push(h), a.push(h[1])), s = d(s, D)[m];
    }
    return d(s, ie).push({ [e]: { handler: n, possibleKeys: a.filter((o, l, c) => c.indexOf(o) === l), score: d(this, Ae) } }), s;
  }
  search(e, r) {
    var l;
    const n = [];
    ...
    for (let c = 0, u = a.length; c < u; c++) {
      const h = a[c], m = c === u - 1, b = [];
      for (let O = 0, _ = i.length; O < _; O++) {
        const T = i[O], M = d(T, D)[h];
        M && (E(M, L, d(T, L)), m ? (d(M, D)["*"] && n.push(...R(this, Z, ce).call(this, d(M, D)["*"], e, d(T, L))), n.push(...R(this, Z, ce).call(this, M, e, d(T, L)))) : b.push(M));
        for (let C = 0, k = d(T, he).length; C < k; C++) {
          const F = d(T, he)[C], y = d(T, L) === Ne ? {} : { ...d(T, L) };
          if (F === "*") {
            const w = d(T, D)["*"];
            w && (n.push(...R(this, Z, ce).call(this, w, e, d(T, L))), E(w, L, y), b.push(w));
            continue;
          }
          const [j, v, g] = F;
          if (!h && !(g instanceof RegExp))
            continue;
          const f = d(T, D)[j], x = a.slice(c).join("/");
          if (g instanceof RegExp) {
            const w = g.exec(x);
            if (w) {
              if (y[v] = w[0], n.push(...R(this, Z, ce).call(this, f, e, d(T, L), y)), Object.keys(d(f, D)).length) {
                E(f, L, y);
          ...
          (g === true || g.test(h)) && (y[v] = h, m ? (n.push(...R(this, Z, ce).call(this, f, e, y, d(T, L))), d(f, D)["*"] && n.push(...R(this, Z, ce).call(this, d(f, D)["*"], e, y, d(T, L)))) : (E(f, L, y), b.push(f)));
        }
      }
      i = b.concat(o.shift() ?? []);
    }
...
}, "_e"), ie = /* @__PURE__ */ new WeakMap(), D = /* @__PURE__ */ new WeakMap(), he = /* @__PURE__ */ new WeakMap(), Ae = /* @__PURE__ */ new WeakMap(), L = /* @__PURE__ */ new WeakMap(), Z = /* @__PURE__ */ new WeakSet(), ce = /* @__PURE__ */ __name(function(e, r, n, s) {
  const i = [];
  for (let a = 0, o = d(e, ie).length; a < o; a++) {
    const l = d(e, ie)[a], c = l[r] || l[I], u = {};
    if (c !== void 0 && (c.params = /* @__PURE__ */ Object.create(null), i.push(c), n !== Ne || s && s !== Ne))
      for (let h = 0, m = c.possibleKeys.length; h < m; h++) {
        const b = c.possibleKeys[h], O = u[c.score];
        c.params[b] = s != null && s[b] && !O ? s[b] : n[b] ?? (s == null ? void 0 : s[b]), u[c.score] = true;
      }
  }
  return i;
}, "ce"), _e);
var pe;
var St;
var Ir = (St = /* @__PURE__ */ __name(class {
  constructor() {
...
var Dt = /* @__PURE__ */ __name(class extends Er {
  constructor(t = {}) {
    super(t), this.router = t.router ?? new jr({ routers: [new Mr(), new Ir()] });
  }
}, "Dt");
var $r = /* @__PURE__ */ __name((t) => {
  ...
  return async (s, i) => {
    ...
    if (c) {
      ...
      if (s.header("Content-Type", O || "application/octet-stream"), t.precompressed && (!O || Pr.test(O))) {
        const _ = new Set((h = s.req.header("Accept-Encoding")) == null ? void 0 : h.split(",").map((T) => T.trim()));
        for (const T of Br) {
          if (!_.has(T))
            continue;
          const M = await l(o + Bt[T], s);
          if (M) {
            c = M, s.header("Content-Encoding", T), s.header("Vary", "Accept-Encoding", { append: true });
            break;
          }
        }
      }
...
var Fr = /* @__PURE__ */ __name(async (t, e) => {
  let r;
...
function an(t, e, r) {
  ...
  const n = Math.max(1, Number(r) || 1), s = e === "brief" ? { min: 10, max: 15 } : e === "detail" ? { min: 45, max: 55 } : { min: 25, max: 30 }, i = ["\uB610\uD55C", "\uC544\uC6B8\uB7EC", "\uB354\uBD88\uC5B4"], a = ["\uD55C\uD3B8", "\uC774\uC640 \uD568\uAED8", "\uC774\uC640 \uB354\uBD88\uC5B4", "\uB610 \uB2E4\uB978 \uCE21\uBA74\uC5D0\uC11C"], o = /* @__PURE__ */ __name((y) => {
    const j = String(y || "").trim().slice(0, 24);
    if (/^(또한|아울러|더불어|한편|이와\s|그리고|그러나|하지만)\b/.test(j))
      return null;
    const v = j.match(/^(.{1,20}?(은|는|이|가))\s+/);
    return v ? v[1] : null;
  }, "o"), l = /* @__PURE__ */ __name((y) => {
    const j = String(y || "").trim();
    return j && (/[.!?…]$/.test(j) ? j : j + ".");
  }, "l"), c = /* @__PURE__ */ __name((y) => {
    let j = String(y || "").trim(), v = "";
    const g = j.match(/([.!?…])$/);
    return g && (v = g[1], j = j.slice(0, -1).trim()), j = j.replace(/합니다$/, "\uD55C\uB2E4").replace(/되었습니다$/, "\uB418\uC5C8\uB2E4").replace(/입니다$/, "\uC774\uB2E4").replace(/습니다$/, "\uB2E4"), (j + (v || ".")).trim();
  ...
  let m = t.map((y, j) => {
    ...
    if (u(v))
      return c(l(v));
    const g = String(t[j - 1] || "").trim(), f = o(g), x = o(v), w = /* @__PURE__ */ __name((p) => p[j % p.length], "w");
    if (x && f && x === f) {
  ...
  let _ = b(O) / n * 100;
  for (; _ > s.max && m.length > 1; )
    m.pop(), O = m.join(" "), _ = b(O) / n * 100;
  _ < s.min && console.warn(`[\uC820\uC2A4] \uC694\uC57D\uC728 ${_.toFixed(1)}%\uAC00 \uBAA9\uD45C \uCD5C\uC18C\uCE58 ${s.min}% \uBBF8\uB9CC\uC785\uB2C8\uB2E4.`);
  const M = m.join(" ").replace(/[0-9]/g, " ").replace(/[^\uAC00-\uD7A3a-zA-Z\s]/g, " ").split(/\s+/).map((y) => y.trim()).filter((y) => y.length >= 2 && y.length <= 6), C = /* @__PURE__ */ new Map();
  for (const y of M)
    C.set(y, (C.get(y) || 0) + 1);
  const k = [...C.entries()].sort((y, j) => j[1] - y[1]).slice(0, 12).map(([y]) => y), F = { keywords: k, nodes: k.map((y, j) => ({ id: `k${j}`, label: y })), edges: [] };
  return { summary: O, mindmap: F, meta: { ratio: _, target: s } };
}
__name(an, "an");
function on(t, e, r) {
  const n = Qr(t);
...
async function un(t, e) {
  ...
  for (; a < 3; ) {
    ...
    if (b.ok) {
      ...
      return { ok: true, text: ((m = (h = (u = (c = (l = _ == null ? void 0 : _.candidates) == null ? void 0 : l[0]) == null ? void 0 : c.content) == null ? void 0 : u.parts) == null ? void 0 : h[0]) == null ? void 0 : m.text) ?? "", raw: _ };
    }
    if (b.status === 429 || b.status === 503) {
      await new Promise((_) => setTimeout(_, o)), o *= 2;
      continue;
    }
    const O = await b.text().catch(() => "");
    throw new Error(`Gemini error ${b.status}: ${O.slice(0, 200)}`);
  }
...
async function hn(t, e, r) {
  ...
  for (; o < 3; ) {
    ...
    if (O.ok) {
      ...
      return ((b = (m = (h = (u = (c = T == null ? void 0 : T.candidates) == null ? void 0 : c[0]) == null ? void 0 : u.content) == null ? void 0 : h.parts) == null ? void 0 : m[0]) == null ? void 0 : b.text) ?? "";
    }
    ...
    throw new Error(`Gemini error ${O.status}: ${_.slice(0, 200)}`);
  }
  throw new Error("Gemini retry exceeded");
}
__name(hn, "hn");
...
async function pn(t, e) {
  ...
  for (let n = 1; n <= 2; n++)
    try {
      ...
      const u = et(a.brief, "brief"), h = et(a.standard, "standard"), m = a.detail.\uAC1C\uB150 + " " + a.detail.\uC601\uD5A5 + " " + a.detail["\uAD50\uC721\uC801 \uAC00\uCE58"], b = et(m, "detail");
...
var fn = (() => {
  ...
  __name(i, "i");
  function a(v, g) {
    const x = Math.max(200, i(v || "").length), w = e[g] || e.standard, p = Math.floor(x * w.min), N = Math.ceil(x * w.max);
    return { base: x, min: Math.max(80, p), max: Math.max(120, N) };
  }
  __name(a, "a");
  function o(v) {
    const g = (v || "").trim();
...
`);
  ...
  function h({ originalText: v, mode: g, format: f }) {
    const x = a(v, g), w = Gt(v), p = f === "narrative" ? "\uC11C\uC220\uD615: \uC5F0\uACB0\uC5B4\uB97C \uC0AC\uC6A9\uD574 \uD750\uB984/\uC778\uACFC\uAC00 \uBCF4\uC774\uB3C4\uB85D 1~3\uBB38\uB2E8\uC73C\uB85C \uAD6C\uC131" : f === "structured" ? "\uAD6C\uC870\uD654: \uC0C1\uC704-\uD558\uC704 \uC704\uACC4\uAC00 \uB4DC\uB7EC\uB098\uB294 \uC870\uBAA9(\uAC00/\uB098/\uB2E4 \uB610\uB294 \u2460\u2461\u2462) \uD615\uD0DC" : "\uB9C8\uC778\uB4DC\uB9F5: \uD14D\uC2A4\uD2B8\uB85C \uD45C\uD604\uB41C \uB178\uB4DC-\uAD00\uACC4 \uBAA9\uB85D(\uC911\uC2EC\uB178\uB4DC/\uD558\uC704\uB178\uB4DC/\uC5F0\uACB0\uB77C\uBCA8) \uD615\uD0DC";
...
`);
  ...
  __name(h, "h");
  function m({ summaryText: v, format: g }) {
...
`);
  ...
  __name(m, "m");
  function b({ mode: v, purpose: g, format: f, summaryText: x, sentTable: w, anchors: p }) {
    const N = r[v] || 10, q = g === "preview" ? "\uC608\uC2B5\uC6A9 \uC140\uD504\uD14C\uC2A4\uD2B8: \uC694\uC57D\uBB38 \uC548\uC5D0\uC11C \uBC14\uB85C \uD655\uC778 \uAC00\uB2A5\uD55C \uC7AC\uC778 \uC911\uC2EC(\uC2A4\uD0A4\uB9C8 \uD615\uC131). \uACFC\uB3C4\uD55C \uCD94\uB860 \uAE08\uC9C0." : "\uC2DC\uD5D8\uB300\uBE44 \uC140\uD504\uD14C\uC2A4\uD2B8: \uC694\uC57D\uBB38\uC5D0 \uC788\uB294 \uADFC\uAC70\uB97C \uBC14\uD0D5\uC73C\uB85C \uC778\uACFC/\uAD00\uACC4/\uBD84\uB958\uB97C \uC778\uCD9C\uD558\uB294 \uD68C\uC0C1 \uC911\uC2EC. \uC694\uC57D\uC5D0 \uC5C6\uB294 \uC815\uBCF4 \uAE08\uC9C0.", Y = f === "narrative" ? "\uBB38\uD56D \uC2A4\uD0C0\uC77C: \uBB38\uC7A5 \uBE48\uCE78, \uBB38\uC7A5 \uC21C\uC11C \uBC30\uC5F4, \uC778\uACFC\uAD00\uACC4 \uB2E8\uB2F5/\uC11C\uC220(\uC694\uC57D \uADFC\uAC70 \uD544\uC218)" : f === "structured" ? "\uBB38\uD56D \uC2A4\uD0C0\uC77C: \uD56D\uBAA9-\uC815\uC758 \uB9E4\uCE6D, \uBD84\uB958 \uCC44\uC6B0\uAE30, \uC0C1\uD558\uC704 \uCCB4\uACC4, \uC0AC\uB840-\uBC94\uC8FC \uB9E4\uCE6D(\uC694\uC57D \uADFC\uAC70 \uD544\uC218)" : "\uBB38\uD56D \uC2A4\uD0C0\uC77C: \uB178\uB4DC \uB77C\uBCA8 \uB9DE\uCD94\uAE30, \uC5F0\uACB0 \uB77C\uBCA8\uB9C1, \uB204\uB77D \uB178\uB4DC/\uC5F0\uACB0 \uBCF5\uC6D0, \uAD00\uACC4 \uC774\uC720 \uB2E8\uB2F5(\uC694\uC57D \uADFC\uAC70 \uD544\uC218)";
    return ["[TASK] \uC544\uB798 \uC694\uC57D\uBB38\uACFC \uC575\uCEE4\uB9CC\uC744 \uADFC\uAC70\uB85C \uC140\uD504\uD14C\uC2A4\uD2B8 \uBB38\uD56D\uC744 \uC0DD\uC131\uD558\uB77C.", `- \uBAA8\uB4DC: ${v} (\uBB38\uD56D\uC218 ${N})`, `- \uBAA9\uC801: ${g} (${q})`, `- \uC694\uC57D \uD615\uC2DD: ${f} (${Y})`, "- \uADDC\uCE591: \uC694\uC57D\uBB38\uC5D0 \uC5C6\uB294 \uC815\uBCF4\uB85C \uBB38\uC81C \uB9CC\uB4E4\uC9C0 \uB9D0 \uAC83(\uD560\uB8E8\uC2DC\uB124\uC774\uC158 \uAE08\uC9C0).", "- \uADDC\uCE592: \uAC01 \uBB38\uD56D\uC740 \uBC18\uB4DC\uC2DC evidence\uB97C \uD3EC\uD568: sid + quote(\uC694\uC57D \uBB38\uC7A5 \uC77C\uBD80 8~25\uC790).", "- \uADDC\uCE593: quote\uB294 \uBC18\uB4DC\uC2DC \uD574\uB2F9 sid \uBB38\uC7A5\uC5D0 \uC2E4\uC81C\uB85C \uD3EC\uD568\uB418\uC5B4\uC57C \uD55C\uB2E4.", "- \uADDC\uCE594: \uC815\uB2F5/\uD574\uC124\uC740 \uAC04\uACB0\uD558\uAC8C. \uD574\uC124\uC740 evidence\uC640 \uC5F0\uACB0\uB418\uAC8C.", "", "[OUTPUT JSON ONLY]", `{
  "items":[
    {
      "id":"Q1",
...
`);
  ...
  __name(b, "b");
  function O(v, g) {
    const f = g && g.anchors ? g.anchors : [], x = [], w = [];
    for (const p of f) {
  ...
  __name(O, "O");
  function _(v, g) {
    const f = g && Array.isArray(g.items) ? g.items : [], x = [], w = [];
    for (const p of f) {
  ...
  __name(_, "_");
  function T({ summaryText: v, sentTable: g, anchors: f, badItems: x, mode: w, purpose: p, format: N }) {
    return ["[TASK] \uC544\uB798\uB294 \uAC80\uC99D\uC5D0\uC11C \uD0C8\uB77D\uD55C \uBB38\uD56D\uB4E4\uC774\uB2E4. \uC694\uC57D\uBB38 \uADFC\uAC70(sid+quote)\uB97C \uB9CC\uC871\uD558\uB3C4\uB85D \uBB38\uD56D\uC744 \uB2E4\uC2DC \uC0DD\uC131\uD558\uB77C.", `- \uC7AC\uC0DD\uC131 \uBB38\uD56D \uC218: ${x.length}`, `- \uBAA8\uB4DC: ${w}, \uBAA9\uC801: ${p}, \uD615\uC2DD: ${N}`, "- \uADDC\uCE59: \uC694\uC57D\uBB38 \uBC16 \uC815\uBCF4 \uAE08\uC9C0. \uBC18\uB4DC\uC2DC sid+quote\uAC00 \uC2E4\uC81C\uB85C \uD574\uB2F9 \uBB38\uC7A5\uC5D0 \uD3EC\uD568\uB418\uC5B4\uC57C \uD55C\uB2E4.", "- \uCD9C\uB825: JSON\uB9CC. items \uAE38\uC774\uB294 \uC815\uD655\uD788 \uC7AC\uC0DD\uC131 \uBB38\uD56D \uC218\uC640 \uAC19\uC544\uC57C \uD55C\uB2E4.", "", "[OUTPUT JSON ONLY]", '{"items":[{ "id":"Qx","type":"blank|match|order|label|short|mcq","question":"...","choices":[],"answer":"...","explanation":"...","evidence":{"sid":"S1","quote":"..." },"anchorIds":["A1"] }]}', "", "[SUMMARY SENTENCES WITH ID]", JSON.stringify(g, null, 2), "", "[ANCHORS]", JSON.stringify(f, null, 2), "", "[BAD ITEMS]", JSON.stringify(x, null, 2), "", "[SUMMARY]", v].join(`
`);
  }
  __name(T, "T");
  async function M({ llmCall: v, originalText: g, mode: f, format: x }) {
    if (!v)
      throw new Error("llmCall is required");
    e[f] || (f = "standard"), n.includes(x) || (x = "narrative");
    const w = h({ originalText: g, mode: f, format: x }), p = (await v({ system: u(), user: w, json: false }) || "").trim() || "", N = l(p), q = m({ summaryText: p, format: x });
    let Y = await v({ system: u(), user: q, json: true }), V;
    try {
      V = JSON.parse(Y);
    } catch {
      V = { anchors: [] };
    }
    const { ok: P } = O(N, V), De = P.length >= 4 ? P : C(N);
  ...
  function C(v) {
    ...
    for (let f = 0; f < Math.min(8, v.length); f++) {
      const x = v[f], w = (x.text || "").slice(0, 18);
      g.push({ id: `A${f + 1}`, label: `\uBB38\uC7A5 \uD575\uC2EC${f + 1}`, type: "claim", sid: x.sid, quote: w, note: "\uC694\uC57D \uBB38\uC7A5 \uAE30\uBC18 \uC548\uC804 \uC575\uCEE4" });
    }
    return g;
  }
  __name(C, "C");
  async function k({ llmCall: v, mode: g, purpose: f, format: x, summaryText: w, sentTable: p, anchors: N }) {
    e[g] || (g = "standard"), s.includes(f) || (f = "preview"), n.includes(x) || (x = "narrative");
    const q = b({ mode: g, purpose: f, format: x, summaryText: w, sentTable: p, anchors: N });
    let Y = await v({ system: u(), user: q, json: true }), V;
    try {
      V = JSON.parse(Y);
    } catch {
    ...
    let { ok: P, bad: De } = _(p, V);
    if (De.length > 0) {
      const Ce = T({ summaryText: w, sentTable: p, anchors: N, badItems: De.map((Qt) => Qt.q), mode: g, purpose: f, format: x });
      let Vt = await v({ system: u(), user: Ce, json: true }), Ve;
      try {
        Ve = JSON.parse(Vt);
      } catch {
        Ve = { items: [] };
    ...
    const Ye = r[g] || 10;
    if (P.length < Ye) {
      const Ce = F({ sentTable: p, anchors: N, count: Ye - P.length, format: x, purpose: f });
      P = P.concat(Ce).slice(0, Ye);
    }
    return { items: P };
  }
  __name(k, "k");
  function F({ sentTable: v, anchors: g, count: f, format: x, purpose: w }) {
    const p = [], N = g.slice(0, Math.max(f, 1));
    for (let q = 0; q < f; q++) {
      const Y = N[q % N.length], V = Y.sid, P = Y.quote;
      p.push({ id: `QF${q + 1}`, type: "short", question: w === "preview" ? `\uC694\uC57D\uC5D0\uC11C '${P}'\uAC00 \uC758\uBBF8\uD558\uB294 \uD575\uC2EC \uAC1C\uB150\uC744 \uD55C \uBB38\uC7A5\uC73C\uB85C \uB9D0\uD574\uBCF4\uC138\uC694.` : `\uC694\uC57D\uC5D0\uC11C '${P}'\uAC00 \uD3EC\uD568\uB41C \uBB38\uC7A5\uC758 \uD575\uC2EC \uC778\uACFC/\uAD00\uACC4\uB97C \uD55C \uBB38\uC7A5\uC73C\uB85C \uC778\uCD9C\uD574\uBCF4\uC138\uC694.`, choices: [], answer: "(\uC11C\uC220\uD615 \uC815\uB2F5: \uC0AC\uC6A9\uC790 \uC785\uB825 \uBE44\uAD50\uB294 \uD574\uC124 \uAE30\uBC18 \uCC44\uC810 \uB610\uB294 \uD0A4\uC6CC\uB4DC \uCC44\uC810\uC73C\uB85C \uCC98\uB9AC)", explanation: "\uADFC\uAC70 \uBB38\uC7A5\uC744 \uB2E4\uC2DC \uC77D\uACE0 \uD575\uC2EC\uC744 1\uBB38\uC7A5\uC73C\uB85C \uC7AC\uAD6C\uC131\uD558\uBA74 \uB429\uB2C8\uB2E4.", evidence: { sid: V, quote: P }, anchorIds: [Y.id] });
    }
    return p;
  }
  __name(F, "F");
  class y {
    ...
    gradeAnswer(g, f) {
      ...
      if (x === "mcq" || x === "blank" || x === "match" || x === "order" || x === "label" || x === "short") {
        ...
        const w = (g.answer || "").trim(), p = (f || "").trim();
  ...
  __name(y, "y");
  async function j({ llmCall: v, originalText: g, mode: f, format: x, purpose: w }) {
    const p = await M({ llmCall: v, originalText: g, mode: f, format: x }), N = await k({ llmCall: v, mode: f, purpose: w, format: x, summaryText: p.summaryText, sentTable: p.sentTable, anchors: p.anchors });
    return { summary: { mode: f, format: x, text: p.summaryText, sentences: p.sentTable, anchors: p.anchors }, selfTest: { purpose: w, passScore: 90, items: N.items } };
  }
  __name(j, "j");
  return { computeCharTargets: a, splitSentencesKR: o, makeSentenceTable: l, generateBundle: M, generateSelfTest: k, runPipeline: j, MasteryRunner: y };
})();
...
\uCD9C\uB825\uC740 \uBC18\uB4DC\uC2DC JSON\uB9CC \uCD9C\uB825\uD558\uB77C. \uB2E4\uB978 \uD14D\uC2A4\uD2B8 \uAE08\uC9C0.`;
      return await Jt(t.env, b);
    } else
      return (await hn(t.env, u, h) || "").toString();
  }, "c");
  try {
    const u = await fn.runPipeline({ llmCall: c, originalText: n, mode: s, format: i, purpose: a === "exam" ? "exam" : "preview" });
...
J.post("/api/engine", async (t) => {
  ...
  const s = Wr(n == null ? void 0 : n.kind), i = H((n == null ? void 0 : n.text) || ""), a = Ft((n == null ? void 0 : n.mode) || (n == null ? void 0 : n.level)), o = Kt((n == null ? void 0 : n.viewType) || (n == null ? void 0 : n.displayMode)), l = H(((T = n == null ? void 0 : n.options) == null ? void 0 : T.userId) || (n == null ? void 0 : n.userId) || "anon");
  if (!i.trim() || i.trim().length < 5)
    return t.json({ ok: false, error: { code: "NO_TEXT", message: "\uC785\uB825 \uD14D\uC2A4\uD2B8\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4." } }, 200);
  const c = ln(s, a, o, i, l || null), u = await pt(r, c);
  if (u.hit)
  ...
  if (m.hit && ((M = m.data) != null && M.narrative)) {
    ...
    let k;
    return o === "narrative" ? k = { kind: s, mode: a, viewType: o, narrative: C } : o === "structured" ? k = { kind: s, mode: a, ...ft(C) } : o === "mindmap" ? k = { kind: s, mode: a, ...mt(C) } : k = { kind: s, mode: a, ...gt(C) }, await Re(r, c, l || "anon", k), t.json({ ok: true, data: k, meta: { cached: true, cacheStore: "derived", cacheType: "converted", engine: "local-convert", elapsedMs: Date.now() - e } }, 200);
  }
  const b = !!H(t.env.GEMINI_API_KEY).trim(), O = H(t.env.USE_MOCK).trim().toLowerCase() === "true";
  if (s === "summary" && b && !O)
    try {
      const C = await pn(t.env, i);
      let k;
      a === "brief" ? k = C.brief : a === "standard" ? k = C.standard : k = `**\uAC1C\uB150**
${C.detail.\uAC1C\uB150}
...
**\uAD50\uC721\uC801 \uAC00\uCE58**
${C.detail["\uAD50\uC721\uC801 \uAC00\uCE58"]}`;
      const F = { kind: s, mode: a, viewType: "narrative", narrative: k, allSummaries: { brief: C.brief, standard: C.standard, detail: C.detail }, meta: C.meta };
      await Re(r, h, l || "anon", F);
      let y;
      return o === "narrative" ? y = F : o === "structured" ? y = { kind: s, mode: a, ...ft(k) } : o === "mindmap" ? y = { kind: s, mode: a, ...mt(k) } : y = { kind: s, mode: a, ...gt(k) }, await Re(r, c, l || "anon", y), t.json({ ok: true, data: y, meta: { cached: false, engine: "gemini-json-v3", elapsedMs: Date.now() - e } }, 200);
    } catch (C) {
      console.error("[Gemini JSON Error]", C);
    }
  const _ = on(i, a, o);
  if (await Re(r, c, l || "anon", _), _.narrative) {
    const C = { kind: "summary", mode: a, viewType: "narrative", narrative: _.narrative };
    await Re(r, h, l || "anon", C);
  }
  return t.json({ ok: true, data: _, meta: { cached: false, engine: "local", elapsedMs: Date.now() - e } }, 200);
});
...
// ../.wrangler/tmp/bundle-DjBHyP/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-DjBHyP/middleware-loader.entry.ts
...
//# sourceMappingURL=bundledWorker-0.6226467272247749.mjs.map
