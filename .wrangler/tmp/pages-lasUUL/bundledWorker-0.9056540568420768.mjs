...
// ../.wrangler/tmp/bundle-aFrkVI/checked-fetch.js
...
// ../.wrangler/tmp/bundle-aFrkVI/strip-cf-connecting-ip-header.js
...
var b = /* @__PURE__ */ __name((e, t, r) => jr(e, typeof t != "symbol" ? t + "" : t, r), "b");
var pt = /* @__PURE__ */ __name((e, t, r) => t.has(e) || Rt("Cannot " + r), "pt");
var h = /* @__PURE__ */ __name((e, t, r) => (pt(e, t, "read from private field"), r ? r.call(e) : t.get(e)), "h");
var T = /* @__PURE__ */ __name((e, t, r) => t.has(e) ? Rt("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), "T");
var w = /* @__PURE__ */ __name((e, t, r, n) => (pt(e, t, "write to private field"), n ? n.call(e, r) : t.set(e, r), r), "w");
var O = /* @__PURE__ */ __name((e, t, r) => (pt(e, t, "access private method"), r), "O");
...
}, "zt"), Pe = /* @__PURE__ */ new WeakMap(), W = /* @__PURE__ */ new WeakMap(), le = /* @__PURE__ */ new WeakSet(), ar = /* @__PURE__ */ __name(function(e) {
...
var Me;
var Xt;
var Kr = (Xt = /* @__PURE__ */ __name(class {
  constructor(e, t) {
    T(this, he);
    T(this, Qe);
    T(this, Ze);
    ...
    b(this, "html", (e2, t2, r) => {
      const n = /* @__PURE__ */ __name((s) => O(this, he, Me).call(this, s, t2, gt("text/html; charset=UTF-8", r)), "n");
...
}, "Xt"), Qe = /* @__PURE__ */ new WeakMap(), Ze = /* @__PURE__ */ new WeakMap(), ie = /* @__PURE__ */ new WeakMap(), De = /* @__PURE__ */ new WeakMap(), ae = /* @__PURE__ */ new WeakMap(), J = /* @__PURE__ */ new WeakMap(), et = /* @__PURE__ */ new WeakMap(), Le = /* @__PURE__ */ new WeakMap(), He = /* @__PURE__ */ new WeakMap(), Ee = /* @__PURE__ */ new WeakMap(), tt = /* @__PURE__ */ new WeakMap(), rt = /* @__PURE__ */ new WeakMap(), he = /* @__PURE__ */ new WeakSet(), Me = /* @__PURE__ */ __name(function(e, t, r) {
...
var at;
var qe;
var Yr = (qe = /* @__PURE__ */ __name(class {
  constructor(t = {}) {
    T(this, H);
    b(this, "get");
    b(this, "post");
  ...
  route(t, r) {
    ...
    return r.routes.map((s) => {
      var a;
      let i;
      r.errorHandler === Dt ? i = s.handler : (i = /* @__PURE__ */ __name(async (l, c) => (await It([], r.errorHandler)(l, () => s.handler(l, c))).res, "i"), i[zr] = s.handler), O(a = n, H, we).call(a, s.method, s.path, i);
    }), this;
  }
  basePath(t) {
...
}, "qe"), Z = /* @__PURE__ */ new WeakMap(), H = /* @__PURE__ */ new WeakSet(), dr = /* @__PURE__ */ __name(function() {
...
}, "dr"), ee = /* @__PURE__ */ new WeakMap(), we = /* @__PURE__ */ __name(function(t, r, n) {
...
var nt;
var Yt;
var tn = (Yt = /* @__PURE__ */ __name(class {
  constructor() {
...
var pr;
var Wt;
var an = (Wt = /* @__PURE__ */ __name(class {
  constructor() {
    T(this, dt);
...
}, "Wt"), fe = /* @__PURE__ */ new WeakMap(), pe = /* @__PURE__ */ new WeakMap(), dt = /* @__PURE__ */ new WeakSet(), pr = /* @__PURE__ */ __name(function(e) {
  const t = [];
  let r = e === L;
...
}, "Be"), ge = /* @__PURE__ */ new WeakMap(), U = /* @__PURE__ */ new WeakMap(), $e = /* @__PURE__ */ new WeakMap(), Fe = /* @__PURE__ */ new WeakMap(), F = /* @__PURE__ */ new WeakMap(), ce = /* @__PURE__ */ new WeakSet(), be = /* @__PURE__ */ __name(function(t, r, n, s) {
  const i = [];
...
var mr = /* @__PURE__ */ __name(class extends Yr {
  constructor(e = {}) {
...
function Vn(e) {
  ...
  const i = /* @__PURE__ */ __name((S) => S.split(new RegExp("(?<=[.!?])\\s+")).filter(Boolean).length, "i"), a = i(e.brief.narrative.text), l = i(e.standard.narrative.text), c = i(e.detail.narrative.text);
...
function Jn(e) {
  e.post("/api/matrix", async (t) => {
    ...
    __name(c, "c");
    try {
      let x = /* @__PURE__ */ __name(function(N) {
      ...
      }, "x"), v = /* @__PURE__ */ __name(function(N) {
        const j = x(N);
        if (!j)
          return j;
      ...
      }, "v"), S = /* @__PURE__ */ __name(function(N) {
        let j = x(N);
      ...
      }, "S"), m = /* @__PURE__ */ __name(function(N) {
        return x(N).split(new RegExp("(?<=[.!?])\\s+")).map((j) => j.trim()).filter(Boolean).length;
      }, "m"), _ = /* @__PURE__ */ __name(function(N, j, z, Q, B) {
        let Y = N;
        ...
        return Y;
      }, "_"), k = /* @__PURE__ */ __name(function(N, j, z, Q) {
        let B = S(v(x(z)));
...
`);
      ...
      if (a === "phase2")
        try {
          const N = /* @__PURE__ */ __name(async (z) => await St(t, z), "N"), j = await Bn({ originalText: C, model: t.env.GEMINI_MODEL || "gemini", callLLM: N, db: t.env.DB, narrative: se, structured: { brief: G.structured, standard: K.structured, detail: p.structured }, mindmap: { brief: G.mindmap, standard: K.mindmap, detail: p.mindmap } });
...
// ../.wrangler/tmp/bundle-aFrkVI/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-aFrkVI/middleware-loader.entry.ts
...
//# sourceMappingURL=bundledWorker-0.9056540568420768.mjs.map
