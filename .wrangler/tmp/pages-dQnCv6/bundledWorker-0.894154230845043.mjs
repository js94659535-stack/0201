...
// ../.wrangler/tmp/bundle-DOnYsZ/checked-fetch.js
...
// ../.wrangler/tmp/bundle-DOnYsZ/strip-cf-connecting-ip-header.js
...
var ln = /* @__PURE__ */ __name((t, e, n) => e in t ? cn(t, e, { enumerable: true, configurable: true, writable: true, value: n }) : t[e] = n, "ln");
var w = /* @__PURE__ */ __name((t, e, n) => ln(t, typeof e != "symbol" ? e + "" : e, n), "w");
var Ze = /* @__PURE__ */ __name((t, e, n) => e.has(t) || ot("Cannot " + n), "Ze");
var d = /* @__PURE__ */ __name((t, e, n) => (Ze(t, e, "read from private field"), n ? n.call(t) : e.get(t)), "d");
var T = /* @__PURE__ */ __name((t, e, n) => e.has(t) ? ot("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, n), "T");
var y = /* @__PURE__ */ __name((t, e, n, r) => (Ze(t, e, "write to private field"), r ? r.call(t, n) : e.set(t, n), n), "y");
var O = /* @__PURE__ */ __name((t, e, n) => (Ze(t, e, "access private method"), n), "O");
var ct = /* @__PURE__ */ __name((t, e, n, r) => ({ set _(s) {
  y(t, e, s, n);
}, get _() {
  return d(t, e, r);
} }), "ct");
var lt = /* @__PURE__ */ __name((t, e, n) => (r, s) => {
  let i = -1;
  return a(0);
  async function a(o) {
    if (o <= i)
    ...
    if (t[o] ? (u = t[o][0][0], r.req.routeIndex = o) : u = o === t.length && s || void 0, u)
      try {
        ...
        if (f instanceof Error && e)
          r.error = f, c = await e(f, r), l = true;
        else
          throw f;
      }
    else
...
var dn = Symbol();
var un = /* @__PURE__ */ __name(async (t, e = /* @__PURE__ */ Object.create(null)) => {
...
var qe = {};
var vn = /* @__PURE__ */ __name((t, e) => {
  if (t === "*")
    return "*";
  const n = t.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);
  if (n) {
    const r = `${t}#${e}`;
    return qe[r] || (n[2] ? qe[r] = e && e[0] !== ":" && e[0] !== "*" ? [r, n[1], new RegExp(`^${n[2]}(?=/${e})`)] : [t, n[1], new RegExp(`^${n[2]}$`)] : qe[r] = [t, n[1], true]), qe[r];
  }
  return null;
}, "vn");
var it = /* @__PURE__ */ __name((t, e) => {
  try {
    return e(t);
  } catch {
...
var yn = /* @__PURE__ */ __name((t) => it(t, decodeURI), "yn");
var Mt = /* @__PURE__ */ __name((t) => {
  ...
  for (; r < e.length; r++) {
    ...
    if (s === 37) {
      ...
      return yn(a.includes("%25") ? a.replace(/%25/g, "%2525") : a);
    } else if (s === 63)
      break;
  }
  return e.slice(n, r);
}, "Mt");
var wn = /* @__PURE__ */ __name((t) => {
  const e = Mt(t);
  return e.length > 1 && e.at(-1) === "/" ? e.slice(0, -1) : e;
}, "wn");
var ve = /* @__PURE__ */ __name((t, e, ...n) => (n.length && (e = ve(e, ...n)), `${(t == null ? void 0 : t[0]) === "/" ? "" : "/"}${t}${e === "/" ? "" : `${(t == null ? void 0 : t.at(-1)) === "/" ? "" : "/"}${(e == null ? void 0 : e[0]) === "/" ? e.slice(1) : e}`}`), "ve");
...
var et = /* @__PURE__ */ __name((t) => /[%+]/.test(t) ? (t.indexOf("+") !== -1 && (t = t.replace(/\+/g, " ")), t.indexOf("%") !== -1 ? it(t, $t) : t) : t, "et");
var jt = /* @__PURE__ */ __name((t, e, n) => {
  let r;
  if (!n && e && !/[%+]/.test(e)) {
    let a = t.indexOf("?", 8);
    if (a === -1)
...
var En = jt;
var Sn = /* @__PURE__ */ __name((t, e) => jt(t, e, true), "Sn");
var $t = decodeURIComponent;
var dt = /* @__PURE__ */ __name((t) => it(t, $t), "dt");
var Ee;
var F;
var ee;
var Dt;
...
var te;
var At;
var Pt = (At = /* @__PURE__ */ __name(class {
  constructor(t, e = "/", n = [[]]) {
    T(this, ee);
    w(this, "raw");
    T(this, Ee);
    ...
    this.raw = t, this.path = e, y(this, F, n), y(this, Ee, {});
  }
  param(t) {
    return t ? O(this, ee, Dt).call(this, t) : O(this, ee, Bt).call(this);
  }
  query(t) {
...
}, "At"), Ee = /* @__PURE__ */ new WeakMap(), F = /* @__PURE__ */ new WeakMap(), ee = /* @__PURE__ */ new WeakSet(), Dt = /* @__PURE__ */ __name(function(t) {
  const e = d(this, F)[0][this.routeIndex][1][t], n = O(this, ee, st).call(this, e);
  return n && /\%/.test(n) ? dt(n) : n;
}, "Dt"), Bt = /* @__PURE__ */ __name(function() {
  const t = {}, e = Object.keys(d(this, F)[0][this.routeIndex][1]);
  for (const n of e) {
    const r = O(this, ee, st).call(this, d(this, F)[0][this.routeIndex][1][n]);
    r !== void 0 && (t[n] = /\%/.test(r) ? dt(r) : r);
  }
  return t;
}, "Bt"), st = /* @__PURE__ */ __name(function(t) {
  return d(this, F)[1] ? d(this, F)[1][t] : t;
}, "st"), te = /* @__PURE__ */ new WeakMap(), At);
var Tn = { Stringify: 1 };
var Lt = /* @__PURE__ */ __name(async (t, e, n, r, s) => {
...
var ye;
var Ct;
var Cn = (Ct = /* @__PURE__ */ __name(class {
  constructor(t, e) {
    T(this, ne);
    T(this, je);
    T(this, $e);
    ...
    T(this, De);
    T(this, Be);
    w(this, "render", (...t2) => (d(this, Te) ?? y(this, Te, (e2) => this.html(e2)), d(this, Te).call(this, ...t2)));
    w(this, "setLayout", (t2) => y(this, Pe, t2));
    w(this, "getLayout", () => d(this, Pe));
    w(this, "setRenderer", (t2) => {
      y(this, Te, t2);
    });
    w(this, "header", (t2, e2, n) => {
      this.finalized && y(this, z, new Response(d(this, z).body, d(this, z)));
      const r = d(this, z) ? d(this, z).headers : d(this, pe) ?? y(this, pe, new Headers());
    ...
    w(this, "set", (t2, e2) => {
      d(this, X) ?? y(this, X, /* @__PURE__ */ new Map()), d(this, X).set(t2, e2);
    });
    w(this, "get", (t2) => d(this, X) ? d(this, X).get(t2) : void 0);
    w(this, "newResponse", (...t2) => O(this, ne, ye).call(this, ...t2));
    w(this, "body", (t2, e2, n) => O(this, ne, ye).call(this, t2, e2, n));
    w(this, "text", (t2, e2, n) => !d(this, pe) && !d(this, Se) && !e2 && !n && !this.finalized ? new Response(t2) : O(this, ne, ye).call(this, t2, e2, tt(An, n)));
    w(this, "json", (t2, e2, n) => O(this, ne, ye).call(this, JSON.stringify(t2), e2, tt("application/json", n)));
    w(this, "html", (t2, e2, n) => {
      const r = /* @__PURE__ */ __name((s) => O(this, ne, ye).call(this, s, e2, tt("text/html; charset=UTF-8", n)), "r");
    ...
    w(this, "notFound", () => (d(this, Ae) ?? y(this, Ae, () => new Response()), d(this, Ae).call(this, this)));
    y(this, je, t), e && (y(this, W, e.executionCtx), this.env = e.env, y(this, Ae, e.notFoundHandler), y(this, Be, e.path), y(this, De, e.matchResult));
  }
  get req() {
    return d(this, $e) ?? y(this, $e, new Pt(d(this, je), d(this, Be), d(this, De))), d(this, $e);
  }
  get event() {
  ...
  get res() {
    return d(this, z) || y(this, z, new Response(null, { headers: d(this, pe) ?? y(this, pe, new Headers()) }));
  }
  set res(t) {
    if (d(this, z) && t) {
      t = new Response(t.body, t);
      for (const [e, n] of d(this, z).headers.entries())
        if (e !== "content-type")
          if (e === "set-cookie") {
            const r = d(this, z).headers.getSetCookie();
    ...
    y(this, z, t), this.finalized = true;
  }
  get var() {
    return d(this, X) ? Object.fromEntries(d(this, X)) : {};
  }
}, "Ct"), je = /* @__PURE__ */ new WeakMap(), $e = /* @__PURE__ */ new WeakMap(), X = /* @__PURE__ */ new WeakMap(), Se = /* @__PURE__ */ new WeakMap(), W = /* @__PURE__ */ new WeakMap(), z = /* @__PURE__ */ new WeakMap(), Pe = /* @__PURE__ */ new WeakMap(), Te = /* @__PURE__ */ new WeakMap(), Ae = /* @__PURE__ */ new WeakMap(), pe = /* @__PURE__ */ new WeakMap(), De = /* @__PURE__ */ new WeakMap(), Be = /* @__PURE__ */ new WeakMap(), ne = /* @__PURE__ */ new WeakSet(), ye = /* @__PURE__ */ __name(function(t, e, n) {
  const r = d(this, z) ? new Headers(d(this, z).headers) : d(this, pe) ?? new Headers();
  ...
  const s = typeof e == "number" ? e : (e == null ? void 0 : e.status) ?? d(this, Se);
  return new Response(t, { status: s, headers: r });
}, "ye"), Ct);
var I = "ALL";
var _n = "all";
var On = ["get", "post", "put", "delete", "options", "patch"];
...
var kn = /* @__PURE__ */ __name((t) => t.text("404 Not Found", 404), "kn");
...
var Ge;
var Ce;
var Rn = (Ce = /* @__PURE__ */ __name(class {
  constructor(e = {}) {
    T(this, j);
    w(this, "get");
    w(this, "post");
    ...
    w(this, "notFound", (e2) => (y(this, U, e2), this));
    w(this, "fetch", (e2, ...n) => O(this, j, Ge).call(this, e2, n[1], n[0], e2.method));
    w(this, "request", (e2, n, r2, s2) => e2 instanceof Request ? this.fetch(n ? new Request(e2, n) : e2, r2, s2) : (e2 = e2.toString(), this.fetch(new Request(/^https?:\/\//.test(e2) ? e2 : `http://localhost${ve("/", e2)}`, n), r2, s2)));
    w(this, "fire", () => {
      addEventListener("fetch", (e2) => {
        e2.respondWith(O(this, j, Ge).call(this, e2.request, e2, void 0, e2.request.method));
      });
    });
    [...On, _n].forEach((i) => {
      this[i] = (a, ...o) => (typeof a == "string" ? y(this, G, a) : O(this, j, de).call(this, i, d(this, G), a), o.forEach((c) => {
        O(this, j, de).call(this, i, d(this, G), c);
      }), this);
    }), this.on = (i, a, ...o) => {
      for (const c of [a].flat()) {
        ...
        for (const l of [i].flat())
          o.map((u) => {
            O(this, j, de).call(this, l.toUpperCase(), d(this, G), u);
          });
      }
      return this;
    }, this.use = (i, ...a) => (typeof i == "string" ? y(this, G, i) : (y(this, G, "*"), a.unshift(i)), a.forEach((o) => {
      O(this, j, de).call(this, I, d(this, G), o);
    }), this);
    const { strict: r, ...s } = e;
  ...
  route(e, n) {
    ...
    return n.routes.map((s) => {
      var a;
      let i;
      n.errorHandler === ut ? i = s.handler : (i = /* @__PURE__ */ __name(async (o, c) => (await lt([], n.errorHandler)(o, () => s.handler(o, c))).res, "i"), i[Nn] = s.handler), O(a = r, j, de).call(a, s.method, s.path, i);
    }), this;
  }
  basePath(e) {
    const n = O(this, j, zt).call(this);
  ...
  mount(e, n, r) {
    ...
    return O(this, j, de).call(this, I, ve(e, "*"), o), this;
  }
}, "Ce"), G = /* @__PURE__ */ new WeakMap(), j = /* @__PURE__ */ new WeakSet(), zt = /* @__PURE__ */ __name(function() {
  const e = new Ce({ router: this.router, getPath: this.getPath });
  return e.errorHandler = this.errorHandler, y(e, U, d(this, U)), e.routes = this.routes, e;
}, "zt"), U = /* @__PURE__ */ new WeakMap(), de = /* @__PURE__ */ __name(function(e, n, r) {
...
}, "de"), Fe = /* @__PURE__ */ __name(function(e, n) {
  if (e instanceof Error)
    return this.errorHandler(e, n);
  throw e;
}, "Fe"), Ge = /* @__PURE__ */ __name(function(e, n, r, s) {
  if (s === "HEAD")
    return (async () => new Response(null, await O(this, j, Ge).call(this, e, n, r, "GET")))();
  ...
  if (a[0].length === 1) {
    ...
    try {
      ...
      return O(this, j, Fe).call(this, u, o);
    }
    return l instanceof Promise ? l.then((u) => u || (o.finalized ? o.res : d(this, U).call(this, o))).catch((u) => O(this, j, Fe).call(this, u, o)) : l ?? d(this, U).call(this, o);
  }
  const c = lt(a[0], this.errorHandler, d(this, U));
  return (async () => {
    try {
      const l = await c(o);
      if (!l.finalized)
      ...
      return O(this, j, Fe).call(this, l, o);
    }
  })();
}, "Ge"), Ce);
var Ft = [];
...
var In = new Set(".\\+*[^]$()");
function jn(t, e) {
  return t.length === 1 ? e.length === 1 ? t < e ? -1 : 1 : -1 : e.length === 1 || t === Me || t === Ie ? 1 : e === Me || e === Ie ? -1 : t === Je ? 1 : e === Je ? -1 : t.length === e.length ? t < e ? -1 : 1 : e.length - t.length;
}
__name(jn, "jn");
var he;
var fe;
var K;
var xe;
var $n = (xe = /* @__PURE__ */ __name(class {
  constructor() {
    T(this, he);
    T(this, fe);
    T(this, K, /* @__PURE__ */ Object.create(null));
  }
  insert(e, n, r, s, i) {
    if (e.length === 0) {
      if (d(this, he) !== void 0)
    ...
    const [a, ...o] = e, c = a === "*" ? o.length === 0 ? ["", "", Me] : ["", "", Je] : a === "/*" ? ["", "", Ie] : a.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);
    let l;
    if (c) {
      const u = c[1];
      let f = c[2] || Je;
      if (u && c[2] && (f === ".*" || (f = f.replace(/^\((?!\?:)(?=[^)]+\)$)/, "(?:"), /\((?!\?:)/.test(f))))
        throw we;
      if (l = d(this, K)[f], !l) {
        if (Object.keys(d(this, K)).some((x) => x !== Me && x !== Ie))
          throw we;
        if (i)
          return;
        l = d(this, K)[f] = new xe(), u !== "" && y(l, fe, s.varIndex++);
      }
      !i && u !== "" && r.push([u, d(l, fe)]);
    } else if (l = d(this, K)[a], !l) {
      if (Object.keys(d(this, K)).some((u) => u.length > 1 && u !== Me && u !== Ie))
        throw we;
      if (i)
        return;
      l = d(this, K)[a] = new xe();
  ...
  buildRegExpStr() {
    const n = Object.keys(d(this, K)).sort(jn).map((r) => {
      const s = d(this, K)[r];
      return (typeof d(s, fe) == "number" ? `(${r})@${d(s, fe)}` : In.has(r) ? `\\${r}` : r) + s.buildRegExpStr();
    });
    return typeof d(this, he) == "number" && n.unshift(`#${d(this, he)}`), n.length === 0 ? "" : n.length === 1 ? n[0] : "(?:" + n.join("|") + ")";
  }
}, "xe"), he = /* @__PURE__ */ new WeakMap(), fe = /* @__PURE__ */ new WeakMap(), K = /* @__PURE__ */ new WeakMap(), xe);
var Ve;
var Le;
var _t;
var Pn = (_t = /* @__PURE__ */ __name(class {
  constructor() {
    T(this, Ve, { varIndex: 0 });
    T(this, Le, new $n());
  }
  insert(t, e, n) {
    const r = [], s = [];
    ...
    return d(this, Le).insert(i, e, r, d(this, Ve), n), r;
  }
  buildRegExp() {
...
}, "_t"), Ve = /* @__PURE__ */ new WeakMap(), Le = /* @__PURE__ */ new WeakMap(), _t);
...
function Ln(t) {
  ...
  if (t.length === 0)
    return Dn;
  const r = t.map((u) => [!/\*|\/:/.test(u[0]), ...u]).sort(([u, f], [x, v]) => u ? 1 : x ? -1 : f.length - v.length), s = /* @__PURE__ */ Object.create(null);
  for (let u = 0, f = -1, x = r.length; u < x; u++) {
    const [v, A, C] = r[u];
    v ? s[A] = [C.map(([N]) => [N, /* @__PURE__ */ Object.create(null)]), Ft] : f++;
    let S;
    try {
      S = e.insert(A, f, v);
    } catch (N) {
      throw N === we ? new qt(A) : N;
    }
    v || (n[f] = C.map(([N, H]) => {
...
var Ut;
var Ot;
var Hn = (Ot = /* @__PURE__ */ __name(class {
  constructor() {
    T(this, Ye);
    ...
    T(this, se);
    w(this, "match", Mn);
    y(this, re, { [I]: /* @__PURE__ */ Object.create(null) }), y(this, se, { [I]: /* @__PURE__ */ Object.create(null) });
  }
  add(t, e, n) {
    var o;
    ...
    if (/\*$/.test(e)) {
      ...
      t === I ? Object.keys(r).forEach((l) => {
        var u;
        (u = r[l])[e] || (u[e] = be(r[l], e) || be(r[I], e) || []);
      }) : (o = r[t])[e] || (o[e] = be(r[t], e) || be(r[I], e) || []), Object.keys(r).forEach((l) => {
    ...
    for (let c = 0, l = a.length; c < l; c++) {
      ...
      Object.keys(s).forEach((f) => {
        var x;
        (t === I || t === f) && ((x = s[f])[u] || (x[u] = [...be(r[f], u) || be(r[I], u) || []]), s[f][u].push([n, i - l + c + 1]));
      });
    }
  }
  buildAllMatchers() {
    ...
    return Object.keys(d(this, se)).concat(Object.keys(d(this, re))).forEach((e) => {
      t[e] || (t[e] = O(this, Ye, Ut).call(this, e));
    }), y(this, re, y(this, se, void 0)), Bn(), t;
  }
}, "Ot"), re = /* @__PURE__ */ new WeakMap(), se = /* @__PURE__ */ new WeakMap(), Ye = /* @__PURE__ */ new WeakSet(), Ut = /* @__PURE__ */ __name(function(t) {
  const e = [];
  let n = t === I;
...
var Q;
var Nt;
var qn = (Nt = /* @__PURE__ */ __name(class {
  constructor(t) {
  ...
  match(t, e) {
    ...
    for (; i < s; i++) {
      ...
      this.match = o.match.bind(o), y(this, ie, [o]), y(this, Q, void 0);
      break;
    }
    if (i === s)
      throw new Error("Fatal error");
...
}, "Nt"), ie = /* @__PURE__ */ new WeakMap(), Q = /* @__PURE__ */ new WeakMap(), Nt);
...
var ue;
var Oe;
var zn = (Oe = /* @__PURE__ */ __name(class {
  constructor(e, n, r) {
    T(this, Z);
    T(this, ae);
    T(this, L);
    ...
    T(this, _e, 0);
    T(this, D, ke);
    if (y(this, L, r || /* @__PURE__ */ Object.create(null)), y(this, ae, []), e && n) {
      const s = /* @__PURE__ */ Object.create(null);
      s[e] = { handler: n, possibleKeys: [], score: 0 }, y(this, ae, [s]);
    }
    y(this, me, []);
  }
  insert(e, n, r) {
    y(this, _e, ++ct(this, _e)._);
    let s = this;
    const i = gn(n), a = [];
    for (let o = 0, c = i.length; o < c; o++) {
      const l = i[o], u = i[o + 1], f = vn(l, u), x = Array.isArray(f) ? f[0] : l;
      if (x in d(s, L)) {
        s = d(s, L)[x], f && a.push(f[1]);
        continue;
      }
      d(s, L)[x] = new Oe(), f && (d(s, me).push(f), a.push(f[1])), s = d(s, L)[x];
    }
    return d(s, ae).push({ [e]: { handler: r, possibleKeys: a.filter((o, c, l) => l.indexOf(o) === c), score: d(this, _e) } }), s;
  }
  search(e, n) {
    var c;
    const r = [];
    ...
    for (let l = 0, u = a.length; l < u; l++) {
      const f = a[l], x = l === u - 1, v = [];
      for (let A = 0, C = i.length; A < C; A++) {
        const S = i[A], N = d(S, L)[f];
        N && (y(N, D, d(S, D)), x ? (d(N, L)["*"] && r.push(...O(this, Z, ue).call(this, d(N, L)["*"], e, d(S, D))), r.push(...O(this, Z, ue).call(this, N, e, d(S, D)))) : v.push(N));
        for (let H = 0, B = d(S, me).length; H < B; H++) {
          const q = d(S, me)[H], k = d(S, D) === ke ? {} : { ...d(S, D) };
          if (q === "*") {
            const b = d(S, L)["*"];
            b && (r.push(...O(this, Z, ue).call(this, b, e, d(S, D))), y(b, D, k), v.push(b));
            continue;
          }
          const [R, E, h] = q;
          if (!f && !(h instanceof RegExp))
            continue;
          const p = d(S, L)[R], g = a.slice(l).join("/");
          if (h instanceof RegExp) {
            const b = h.exec(g);
            if (b) {
              if (k[E] = b[0], r.push(...O(this, Z, ue).call(this, p, e, d(S, D), k)), Object.keys(d(p, L)).length) {
                y(p, D, k);
                const m = ((c = b[0].match(/\//)) == null ? void 0 : c.length) ?? 0;
                (o[m] || (o[m] = [])).push(p);
              }
              continue;
            }
          }
          (h === true || h.test(f)) && (k[E] = f, x ? (r.push(...O(this, Z, ue).call(this, p, e, k, d(S, D))), d(p, L)["*"] && r.push(...O(this, Z, ue).call(this, d(p, L)["*"], e, k, d(S, D)))) : (y(p, D, k), v.push(p)));
        }
      }
      i = v.concat(o.shift() ?? []);
    }
...
}, "Oe"), ae = /* @__PURE__ */ new WeakMap(), L = /* @__PURE__ */ new WeakMap(), me = /* @__PURE__ */ new WeakMap(), _e = /* @__PURE__ */ new WeakMap(), D = /* @__PURE__ */ new WeakMap(), Z = /* @__PURE__ */ new WeakSet(), ue = /* @__PURE__ */ __name(function(e, n, r, s) {
  const i = [];
  for (let a = 0, o = d(e, ae).length; a < o; a++) {
    const c = d(e, ae)[a], l = c[n] || c[I], u = {};
    if (l !== void 0 && (l.params = /* @__PURE__ */ Object.create(null), i.push(l), r !== ke || s && s !== ke))
      for (let f = 0, x = l.possibleKeys.length; f < x; f++) {
        const v = l.possibleKeys[f], A = u[l.score];
...
var ge;
var kt;
var Fn = (kt = /* @__PURE__ */ __name(class {
  constructor() {
  ...
  add(t, e, n) {
    ...
    if (r) {
      for (let s = 0, i = r.length; s < i; s++)
        d(this, ge).insert(t, r[s], n);
      return;
    }
    d(this, ge).insert(t, e, n);
  }
  match(t, e) {
    return d(this, ge).search(t, e);
  }
}, "kt"), ge = /* @__PURE__ */ new WeakMap(), kt);
var Kt = /* @__PURE__ */ __name(class extends Rn {
  constructor(t = {}) {
...
var Gn = /* @__PURE__ */ __name((t) => {
  ...
  return async function(a, o) {
    ...
    if (l && c("Access-Control-Allow-Origin", l), n.credentials && c("Access-Control-Allow-Credentials", "true"), (u = n.exposeHeaders) != null && u.length && c("Access-Control-Expose-Headers", n.exposeHeaders.join(",")), a.req.method === "OPTIONS") {
      ...
      const f = await s(a.req.header("origin") || "", a);
...
var Wn = /* @__PURE__ */ __name((t) => {
  ...
  return async (s, i) => {
    ...
    if (l) {
      const A = t.mimes && pt(o, t.mimes) || pt(o);
      if (s.header("Content-Type", A || "application/octet-stream"), t.precompressed && (!A || Un.test(A))) {
        const C = new Set((f = s.req.header("Accept-Encoding")) == null ? void 0 : f.split(",").map((S) => S.trim()));
        for (const S of Yn) {
          if (!C.has(S))
            continue;
...
var er = /* @__PURE__ */ __name((t) => Zn(t), "er");
var J = new Kt();
...
__name(lr, "lr");
var Xe = { narrative: { brief: 4, standard: 6, detail: 9 }, structured: { brief: 3, standard: 5, detail: 8 }, mindmap: { brief: 4, standard: 6, detail: 10 }, selftest: { brief: 3, standard: 5, detail: 8 } };
function dr(t) {
...
__name(gr, "gr");
function mt(t, e) {
  const n = Xe.structured[e], r = (t.sections || []).slice(0, n).map((c) => ({ ...c, keywords: (c.keywords || []).slice(0, e === "brief" ? 4 : 6), lvl25: (c.lvl25 || []).slice(0, e === "brief" ? 2 : 3), explain: String(c.explain || "").trim() })), s = e === "brief" ? 8 : e === "standard" ? 14 : 20, i = (t.glossary || []).slice(0, s), a = new Set(r.map((c) => c.id)), o = (t.links || []).filter((c) => c.from === "A0" && a.has(c.to));
  return { ...t, sections: r, glossary: i, links: o };
}
__name(mt, "mt");
function gt(t, e) {
  const n = Xe.mindmap[e], r = (t.nodes || []).slice(0, Math.max(0, n - 1)), s = /* @__PURE__ */ new Set(["C0", ...r.map((a) => a.id)]), i = (t.edges || []).filter((a) => s.has(a.from) && s.has(a.to));
  return { ...t, nodes: r, edges: i };
}
__name(gt, "gt");
function xt(t, e) {
  const n = Xe.selftest[e];
  return { questions: (t.questions || []).slice(0, n) };
}
__name(xt, "xt");
function bt(t, e) {
  const n = Xe.narrative[e], i = lr(t.summary || "").slice(0, n).join(" "), a = (t.keyPoints || []).slice(0, e === "brief" ? 3 : 4), o = (t.examHints || []).slice(0, e === "brief" ? 2 : 3);
  return { ...t, summary: i, keyPoints: a, examHints: o };
}
__name(bt, "bt");
async function ze(t, e) {
  const n = /* @__PURE__ */ __name(async () => {
...
async function xr(t, e) {
  ...
  const r = await ze(t, fr(e, n));
  if (!(r != null && r.summary))
    throw new Error("NARRATIVE_SCHEMA_INVALID");
  const s = await ze(t, mr(n));
  ...
  const i = await ze(t, gr(n));
  if (!Array.isArray(i.questions))
    throw new Error("SELFTEST_SCHEMA_INVALID");
  const a = { detail: n, standard: mt(n, "standard"), brief: mt(n, "brief") }, o = { detail: r, standard: bt(r, "standard"), brief: bt(r, "brief") }, c = { detail: s, standard: gt(s, "standard"), brief: gt(s, "brief") }, l = { detail: i, standard: xt(i, "standard"), brief: xt(i, "brief") };
...
async function vt(t, e) {
  ...
  try {
    ...
    return Ke.set(e, { data: i, createdAt: n }), { hit: true, data: i, store: "d1" };
  } catch {
    return { hit: false };
  }
}
...
async function Re(t, e, n, r) {
  const s = Date.now();
  Ke.set(e, { data: r, createdAt: s }), t && await t.prepare(`INSERT OR REPLACE INTO summary_cache(cache_key, user_id, response_json, created_at)
...
async function Tr(t, e) {
  ...
  for (; a < 3; ) {
    ...
    if (v.ok) {
      ...
      return { ok: true, text: ((x = (f = (u = (l = (c = C == null ? void 0 : C.candidates) == null ? void 0 : c[0]) == null ? void 0 : l.content) == null ? void 0 : u.parts) == null ? void 0 : f[0]) == null ? void 0 : x.text) ?? "", raw: C };
    }
    if (v.status === 429 || v.status === 503) {
      await new Promise((C) => setTimeout(C, o)), o *= 2;
      continue;
    }
...
async function Ar(t, e, n) {
  ...
  for (; o < 3; ) {
    ...
    if (A.ok) {
      ...
      return ((v = (x = (f = (u = (l = S == null ? void 0 : S.candidates) == null ? void 0 : l[0]) == null ? void 0 : u.content) == null ? void 0 : f.parts) == null ? void 0 : x[0]) == null ? void 0 : v.text) ?? "";
    }
    ...
    throw new Error(`Gemini error ${A.status}: ${C.slice(0, 200)}`);
  }
  throw new Error("Gemini retry exceeded");
}
__name(Ar, "Ar");
...
var Cr = (() => {
  ...
  __name(i, "i");
  function a(E, h) {
    const g = Math.max(200, i(E || "").length), b = e[h] || e.standard, m = Math.floor(g * b.min), _ = Math.ceil(g * b.max);
    return { base: g, min: Math.max(80, m), max: Math.max(120, _) };
  }
  __name(a, "a");
  function o(E) {
    const h = (E || "").trim();
    return h ? h.replace(/\r/g, "").split(new RegExp("(?<=[\\.\\?\\!])\\s+|\\n+")).map((g) => g.trim()).filter(Boolean) : [];
  }
  __name(o, "o");
  function c(E) {
    return o(E).map((p, g) => ({ sid: `S${g + 1}`, text: p }));
  }
  __name(c, "c");
  function l(E, h, p) {
    const g = E.find((b) => b.sid === h);
...
`);
  ...
  function v({ mode: E, purpose: h, format: p, summaryText: g, sentTable: b, anchors: m }) {
    ...
    return ["[TASK] \uC544\uB798 \uC694\uC57D\uBB38\uACFC \uC575\uCEE4\uB9CC\uC744 \uADFC\uAC70\uB85C \uC140\uD504\uD14C\uC2A4\uD2B8 \uBB38\uD56D\uC744 \uC0DD\uC131\uD558\uB77C.", `- \uBAA8\uB4DC: ${E} (\uBB38\uD56D\uC218 ${_})`, `- \uBAA9\uC801: ${h} (${M})`, `- \uC694\uC57D \uD615\uC2DD: ${p} (${V})`, "- \uADDC\uCE591: \uC694\uC57D\uBB38\uC5D0 \uC5C6\uB294 \uC815\uBCF4\uB85C \uBB38\uC81C \uB9CC\uB4E4\uC9C0 \uB9D0 \uAC83(\uD560\uB8E8\uC2DC\uB124\uC774\uC158 \uAE08\uC9C0).", "- \uADDC\uCE592: \uAC01 \uBB38\uD56D\uC740 \uBC18\uB4DC\uC2DC evidence\uB97C \uD3EC\uD568: sid + quote(\uC694\uC57D \uBB38\uC7A5 \uC77C\uBD80 8~25\uC790).", "- \uADDC\uCE593: quote\uB294 \uBC18\uB4DC\uC2DC \uD574\uB2F9 sid \uBB38\uC7A5\uC5D0 \uC2E4\uC81C\uB85C \uD3EC\uD568\uB418\uC5B4\uC57C \uD55C\uB2E4.", "- \uADDC\uCE594: \uC815\uB2F5/\uD574\uC124\uC740 \uAC04\uACB0\uD558\uAC8C. \uD574\uC124\uC740 evidence\uC640 \uC5F0\uACB0\uB418\uAC8C.", "", "[OUTPUT JSON ONLY]", `{
  "items":[
    {
      "id":"Q1",
...
`);
  ...
  __name(v, "v");
  function A(E, h) {
    const p = h && h.anchors ? h.anchors : [], g = [], b = [];
    for (const m of p) {
      const _ = m == null ? void 0 : m.sid, M = m == null ? void 0 : m.quote;
      if (typeof (m == null ? void 0 : m.label) != "string" || !m.label.trim()) {
        b.push({ a: m, reason: "label missing" });
        continue;
      }
      if (!l(E, _, M)) {
        b.push({ a: m, reason: "evidence not in sentence" });
        continue;
      }
      g.push(m);
    }
  ...
  __name(A, "A");
  function C(E, h) {
    const p = h && Array.isArray(h.items) ? h.items : [], g = [], b = [];
    for (const m of p) {
      const _ = m == null ? void 0 : m.evidence;
      if (!(m != null && m.id) || !(m != null && m.question) || !(m != null && m.answer) || !(_ != null && _.sid) || !(_ != null && _.quote)) {
        b.push({ q: m, reason: "missing fields" });
        continue;
      }
      if (!l(E, _.sid, _.quote)) {
        b.push({ q: m, reason: "evidence not in sentence" });
        continue;
      }
      if (Array.isArray(m.choices) && m.choices.length > 0 && !m.choices.includes(m.answer)) {
        b.push({ q: m, reason: "answer not in choices" });
        continue;
      }
      g.push(m);
    }
  ...
  __name(C, "C");
  function S({ summaryText: E, sentTable: h, anchors: p, badItems: g, mode: b, purpose: m, format: _ }) {
    return ["[TASK] \uC544\uB798\uB294 \uAC80\uC99D\uC5D0\uC11C \uD0C8\uB77D\uD55C \uBB38\uD56D\uB4E4\uC774\uB2E4. \uC694\uC57D\uBB38 \uADFC\uAC70(sid+quote)\uB97C \uB9CC\uC871\uD558\uB3C4\uB85D \uBB38\uD56D\uC744 \uB2E4\uC2DC \uC0DD\uC131\uD558\uB77C.", `- \uC7AC\uC0DD\uC131 \uBB38\uD56D \uC218: ${g.length}`, `- \uBAA8\uB4DC: ${b}, \uBAA9\uC801: ${m}, \uD615\uC2DD: ${_}`, "- \uADDC\uCE59: \uC694\uC57D\uBB38 \uBC16 \uC815\uBCF4 \uAE08\uC9C0. \uBC18\uB4DC\uC2DC sid+quote\uAC00 \uC2E4\uC81C\uB85C \uD574\uB2F9 \uBB38\uC7A5\uC5D0 \uD3EC\uD568\uB418\uC5B4\uC57C \uD55C\uB2E4.", "- \uCD9C\uB825: JSON\uB9CC. items \uAE38\uC774\uB294 \uC815\uD655\uD788 \uC7AC\uC0DD\uC131 \uBB38\uD56D \uC218\uC640 \uAC19\uC544\uC57C \uD55C\uB2E4.", "", "[OUTPUT JSON ONLY]", '{"items":[{ "id":"Qx","type":"blank|match|order|label|short|mcq","question":"...","choices":[],"answer":"...","explanation":"...","evidence":{"sid":"S1","quote":"..." },"anchorIds":["A1"] }]}', "", "[SUMMARY SENTENCES WITH ID]", JSON.stringify(h, null, 2), "", "[ANCHORS]", JSON.stringify(p, null, 2), "", "[BAD ITEMS]", JSON.stringify(g, null, 2), "", "[SUMMARY]", E].join(`
`);
  }
  __name(S, "S");
  async function N({ llmCall: E, originalText: h, mode: p, format: g }) {
    if (!E)
      throw new Error("llmCall is required");
    e[p] || (p = "standard"), r.includes(g) || (g = "narrative");
    const b = f({ originalText: h, mode: p, format: g }), m = (await E({ system: u(), user: b, json: false }) || "").trim() || "", _ = c(m), M = x({ summaryText: m, format: g });
    let V = await E({ system: u(), user: M, json: true }), Y;
    try {
      Y = JSON.parse(V);
    } catch {
      Y = { anchors: [] };
    }
    const { ok: $ } = A(_, Y), He = $.length >= 4 ? $ : H(_);
    return { summaryText: m, sentTable: _, anchors: He };
  }
  __name(N, "N");
  function H(E) {
    const h = [];
    for (let p = 0; p < Math.min(8, E.length); p++) {
      const g = E[p], b = (g.text || "").slice(0, 18);
      h.push({ id: `A${p + 1}`, label: `\uBB38\uC7A5 \uD575\uC2EC${p + 1}`, type: "claim", sid: g.sid, quote: b, note: "\uC694\uC57D \uBB38\uC7A5 \uAE30\uBC18 \uC548\uC804 \uC575\uCEE4" });
    }
    return h;
  }
  __name(H, "H");
  async function B({ llmCall: E, mode: h, purpose: p, format: g, summaryText: b, sentTable: m, anchors: _ }) {
    e[h] || (h = "standard"), s.includes(p) || (p = "preview"), r.includes(g) || (g = "narrative");
    const M = v({ mode: h, purpose: p, format: g, summaryText: b, sentTable: m, anchors: _ });
    let V = await E({ system: u(), user: M, json: true }), Y;
    try {
      Y = JSON.parse(V);
    } catch {
    ...
    let { ok: $, bad: He } = C(m, Y);
    if (He.length > 0) {
      const Ne = S({ summaryText: b, sentTable: m, anchors: _, badItems: He.map((on) => on.q), mode: h, purpose: p, format: g });
      let rn = await E({ system: u(), user: Ne, json: true }), Qe;
      try {
        Qe = JSON.parse(rn);
      } catch {
        Qe = { items: [] };
    ...
    const We = n[h] || 10;
    if ($.length < We) {
      const Ne = q({ sentTable: m, anchors: _, count: We - $.length, format: g, purpose: p });
      $ = $.concat(Ne).slice(0, We);
    }
    return { items: $ };
  }
  __name(B, "B");
  function q({ sentTable: E, anchors: h, count: p, format: g, purpose: b }) {
    const m = [], _ = h.slice(0, Math.max(p, 1));
    for (let M = 0; M < p; M++) {
      const V = _[M % _.length], Y = V.sid, $ = V.quote;
      m.push({ id: `QF${M + 1}`, type: "short", question: b === "preview" ? `\uC694\uC57D\uC5D0\uC11C '${$}'\uAC00 \uC758\uBBF8\uD558\uB294 \uD575\uC2EC \uAC1C\uB150\uC744 \uD55C \uBB38\uC7A5\uC73C\uB85C \uB9D0\uD574\uBCF4\uC138\uC694.` : `\uC694\uC57D\uC5D0\uC11C '${$}'\uAC00 \uD3EC\uD568\uB41C \uBB38\uC7A5\uC758 \uD575\uC2EC \uC778\uACFC/\uAD00\uACC4\uB97C \uD55C \uBB38\uC7A5\uC73C\uB85C \uC778\uCD9C\uD574\uBCF4\uC138\uC694.`, choices: [], answer: "(\uC11C\uC220\uD615 \uC815\uB2F5: \uC0AC\uC6A9\uC790 \uC785\uB825 \uBE44\uAD50\uB294 \uD574\uC124 \uAE30\uBC18 \uCC44\uC810 \uB610\uB294 \uD0A4\uC6CC\uB4DC \uCC44\uC810\uC73C\uB85C \uCC98\uB9AC)", explanation: "\uADFC\uAC70 \uBB38\uC7A5\uC744 \uB2E4\uC2DC \uC77D\uACE0 \uD575\uC2EC\uC744 1\uBB38\uC7A5\uC73C\uB85C \uC7AC\uAD6C\uC131\uD558\uBA74 \uB429\uB2C8\uB2E4.", evidence: { sid: Y, quote: $ }, anchorIds: [V.id] });
    }
    return m;
  }
  __name(q, "q");
  class k {
    constructor(h, { passScore: p = 90 } = {}) {
      this.items = Array.isArray(h) ? h : [], this.passScore = p, this.state = { idx: 0, attempts: 1, correct: 0, wrongIds: /* @__PURE__ */ new Set(), finished: false };
    }
    gradeAnswer(h, p) {
      if (!h)
      ...
      if (g === "mcq" || g === "blank" || g === "match" || g === "order" || g === "label" || g === "short") {
        ...
        const b = (h.answer || "").trim(), m = (p || "").trim();
        return { ok: m === b, reason: m === b ? "match" : "mismatch" };
      }
    ...
    submit(h) {
      ...
      {
        const b = p.explanation || "\uD574\uC124 \uC5C6\uC74C";
        return this.next(), { ok: false, stage: 3, explanation: b, score: this.getScore() };
      }
    }
    next() {
  ...
  __name(k, "k");
  async function R({ llmCall: E, originalText: h, mode: p, format: g, purpose: b }) {
    const m = await N({ llmCall: E, originalText: h, mode: p, format: g }), _ = await B({ llmCall: E, mode: p, purpose: b, format: g, summaryText: m.summaryText, sentTable: m.sentTable, anchors: m.anchors });
    return { summary: { mode: p, format: g, text: m.summaryText, sentences: m.sentTable, anchors: m.anchors }, selfTest: { purpose: b, passScore: 90, items: _.items } };
  }
  __name(R, "R");
  return { computeCharTargets: a, splitSentencesKR: o, makeSentenceTable: c, generateBundle: N, generateSelfTest: B, runPipeline: R, MasteryRunner: k };
})();
var _r = `/* MindStory Engine Bundle (compat) */
(function(){
...
J.get("/ms-engine-bundle.js", (t) => t.text(_r, 200, { "content-type": "application/javascript; charset=utf-8", "cache-control": "no-store" }));
J.use("/api/*", Gn());
...
J.post("/api/gens/run", async (t) => {
  ...
  const r = P((n == null ? void 0 : n.text) || (n == null ? void 0 : n.originalText) || ""), s = Xt((n == null ? void 0 : n.mode) || "standard"), i = Wt((n == null ? void 0 : n.format) || (n == null ? void 0 : n.viewType) || "narrative"), a = P((n == null ? void 0 : n.purpose) || "preview").trim().toLowerCase();
  if (!r)
  ...
  const l = /* @__PURE__ */ __name(async ({ system: u, user: f, json: x }) => {
    if (x) {
      const v = `${u}
...
\uCD9C\uB825\uC740 \uBC18\uB4DC\uC2DC JSON\uB9CC \uCD9C\uB825\uD558\uB77C. \uB2E4\uB978 \uD14D\uC2A4\uD2B8 \uAE08\uC9C0.`;
      ...
      return (await Ar(t.env, u, f) || "").toString();
  }, "l");
  try {
...
J.post("/api/engine", async (t) => {
  ...
  const s = cr(r == null ? void 0 : r.kind), i = P((r == null ? void 0 : r.text) || ""), a = Xt((r == null ? void 0 : r.mode) || (r == null ? void 0 : r.level)), o = Wt((r == null ? void 0 : r.viewType) || (r == null ? void 0 : r.displayMode)), c = P(((E = r == null ? void 0 : r.options) == null ? void 0 : E.userId) || (r == null ? void 0 : r.userId) || "anon");
  if (!i.trim() || i.trim().length < 5)
    return t.json({ ok: false, error: { code: "NO_TEXT", message: "\uC785\uB825 \uD14D\uC2A4\uD2B8\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4." } }, 200);
  const l = or(i), u = l.text, f = l.sentences;
  console.log("[Sanitize] Original length:", i.length, "\u2192 Cleaned:", u.length), console.log("[Sanitize] Sentences extracted:", f.length);
  ...
  const A = br(s, a, u, c || null), C = await vt(n, A);
  if (C.hit && C.data) {
    let h;
    if (C.data.allSummaries && C.data.allSummaries[a] ? h = C.data.allSummaries[a] : C.data.narrative ? h = C.data.narrative : console.warn("[Cache] Base cache has no narrative, skipping"), h) {
      let p;
      return o === "narrative" ? p = { kind: s, mode: a, viewType: o, narrative: h } : o === "structured" ? p = { kind: s, mode: a, ...wr(h) } : o === "mindmap" ? p = { kind: s, mode: a, ...Er(h) } : p = { kind: s, mode: a, ...Sr(h) }, await Re(n, x, c || "anon", p), t.json({ ok: true, data: p, meta: { cached: true, cacheStore: "derived", cacheType: "converted", engine: "local-convert", elapsedMs: Date.now() - e } }, 200);
    }
  }
  const S = !!P(t.env.GEMINI_API_KEY).trim(), N = P(t.env.USE_MOCK).trim().toLowerCase() === "true";
  if (s === "summary" && S && !N)
    try {
      const h = await xr(t.env, u), p = dr(a), g = ur(o);
      let b;
      if (g === "structured")
        b = { kind: s, mode: a, viewType: o, ...h.structured[p] };
      else if (g === "mindmap")
        b = { kind: s, mode: a, viewType: o, ...h.mindmap[p] };
      else if (g === "selftest")
        b = { kind: s, mode: a, viewType: o, ...h.selftest[p] };
      else {
        const M = h.narrative[p];
        b = { kind: s, mode: a, viewType: o, title: M.title, narrative: M.summary, keyPoints: M.keyPoints, examHints: M.examHints };
      }
      const m = h.narrative[p], _ = { kind: s, mode: a, viewType: "narrative", narrative: m.summary, allSummaries: { brief: h.narrative.brief.summary, standard: h.narrative.standard.summary, detail: h.narrative.detail.summary }, meta: { engine: "v4", hierarchy: "brief \u2282 standard \u2282 detail (server-downsample)", structuredFirst: true } };
      return await Re(n, A, c || "anon", _), await Re(n, x, c || "anon", b), t.json({ ok: true, data: b, meta: { cached: false, engine: "gemini-v4-structured-first", elapsedMs: Date.now() - e, hierarchy: "brief \u2282 standard \u2282 detail (guaranteed)" } }, 200);
    } catch (h) {
      console.error("[Gemini V4 Error]", h);
    }
  const { buildAllSummariesV4_Quality: H } = await Promise.resolve().then(() => Lr), B = H(u), q = B[a] || B.standard;
  let k;
  o === "narrative" ? k = { kind: s, mode: a, viewType: o, narrative: q.narrative } : o === "structured" ? k = { kind: s, mode: a, viewType: o, structured: q.structured } : o === "mindmap" ? k = { kind: s, mode: a, viewType: o, mindmap: q.mindmap } : o === "selftest" && (k = { kind: s, mode: a, viewType: o, selftest: q.selftest }), await Re(n, x, c || "anon", k);
  const R = { kind: "summary", mode: a, viewType: "narrative", narrative: q.narrative, allSummaries: { brief: B.brief.narrative, standard: B.standard.narrative, detail: B.detail.narrative } };
  return await Re(n, A, c || "anon", R), t.json({ ok: true, data: k, meta: { cached: false, engine: "quality-v4.2", elapsedMs: Date.now() - e, features: ["\uC555\uCD95\uB960 \uAC15\uC81C (\uC911\uAC04 \uC808\uB2E8 \uAE08\uC9C0)", "\uAD6C\uC870\uD654: \uB17C\uC9C0/\uB300\uB9BD/\uD604\uD669/\uAD34\uB9AC/\uBCC0\uCC9C/\uC2DC\uC0AC\uC810", "\uB9C8\uC778\uB4DC\uB9F5: \uB178\uB4DC \uB2E8\uC704 \uCD95\uC57D", "brief \u2282 standard \u2282 detail \uAC15\uC81C"] } }, 200);
});
...
for (const [, t] of Object.entries(Or))
  t && (yt.route("/", t), yt.notFound(t.notFoundHandler), en = true);
if (!en)
...
function Rr(t) {
  ...
  let r;
  for (; (r = e.exec(t)) !== null; )
    n.push({ idx: r.index, key: r[2], title: oe(r[3]) });
  if (n.length === 0)
...
function nn(t) {
  let e = oe(t);
  return e = e.replace(/\([^)]*\d{4}[^)]*\)/g, "").trim(), e = e.replace(/"([^"]{60,})"/g, '"(\uC778\uC6A9\uBB38 \uC694\uC9C0)"'), e = e.replace(/본수업/g, "\uBCF8 \uC218\uC5C5"), e = e.replace(/국력신장/g, "\uAD6D\uB825 \uC2E0\uC7A5"), e = e.replace(/내신대비/g, "\uB0B4\uC2E0 \uB300\uBE44"), e = e.replace(/지원현황/g, "\uC9C0\uC6D0 \uD604\uD669"), e = e.replace(/또한출판/g, "\uB610\uD55C \uCD9C\uD310"), e = e.replace(/그리고입과/g, "\uADF8\uB9AC\uACE0 \uACE0\uC785\uACFC"), e = e.replace(/통한대비/g, "\uD1B5\uD55C \uB300\uBE44"), /[.?!]$/.test(e) || (e += "."), oe(e);
}
__name(nn, "nn");
function ce(t, e, n) {
  return t.map((s, i) => ({ id: Nr(n, i), text: s, score: Mr(s) })).sort((s, i) => i.score - s.score).slice(0, e).map((s) => ({ id: s.id, text: nn(s.text), score: s.score }));
}
__name(ce, "ce");
function Ir(t) {
  var H, B, q, k;
...
__name(jr, "jr");
function rt(t, e, n) {
  const { min: r, max: s } = jr(n, e), i = [], a = /* @__PURE__ */ __name((l) => l.forEach((u) => i.push(u.text)), "a");
  a(t.core.bullets), a(t.perspectives.ministry.bullets), a(t.perspectives.privateEdu.bullets), a(t.gap.bullets), a(t.policy.bullets), a(t.reality.bullets), a(t.takeaway.bullets);
  const o = [];
  let c = 0;
  for (const l of i) {
    const u = at(l);
...
function Dr(t, e) {
  var r, s, i, a;
  const n = [];
  return n.push({ q: "\uAD50\uC721\uBD80\uB294 \uC120\uD589\uD559\uC2B5\uC744 \uC65C \uBB38\uC81C\uB85C \uBCF4\uB294\uAC00?", a: ((r = t.perspectives.ministry.bullets[0]) == null ? void 0 : r.text) || "\uACF5\uAD50\uC721 \uC815\uC0C1\uD654 \uC800\uD574 \uBC0F \uACA9\uCC28/\uD0DC\uB3C4 \uC545\uD654 \uC6B0\uB824.", hint: "\uACF5\uAD50\uC721\xB7\uACA9\uCC28\xB7\uCC38\uC5EC\uB3C4" }), n.push({ q: "\uC0AC\uAD50\uC721\uC774 \uB9D0\uD558\uB294 \uC608\uC2B5\uACFC \uC120\uD589\uD559\uC2B5\uC758 \uCC28\uC774\uB294 \uBB34\uC5C7\uC778\uAC00?", a: ((s = t.perspectives.privateEdu.bullets[0]) == null ? void 0 : s.text) || "\uC608\uC2B5\uC740 \uC218\uC5C5 \uB300\uBE44, \uC120\uD589\uC740 \uB2E4\uC74C \uD559\uB144 \uACFC\uC815\uC758 \uC120\uD559\uC2B5.", hint: "\uC218\uC5C5 \uB300\uBE44 vs \uB2E4\uC74C \uD559\uB144" }), e !== "brief" && n.push({ q: "\uC120\uD589\uD559\uC2B5\uC774 \uAC15\uD654\uB418\uB294 \uC81C\uB3C4\uC801 \uBC30\uACBD\uC740 \uBB34\uC5C7\uC778\uAC00?", a: ((i = t.policy.bullets[0]) == null ? void 0 : i.text) || "\uB0B4\uC2E0 \uBC18\uC601\uBE44\uC728/\uC804\uD615/\uAC00\uC0B0\uC810 \uB4F1 \uAD6C\uC870 \uBCC0\uD654\uAC00 \uC601\uD5A5\uC744 \uC900\uB2E4.", hint: "\uB0B4\uC2E0\xB7\uC804\uD615\xB7\uBE44\uC728" }), e === "detail" && n.push({ q: "\uC120\uD589\uD559\uC2B5\uC758 \uD604\uD669(\uBC29\uBC95)\uC5D0\uC11C \uD575\uC2EC \uD2B9\uC9D5 1\uAC00\uC9C0\uB294?", a: ((a = t.reality.bullets[0]) == null ? void 0 : a.text) || "\uC2DC\uD5D8 \uB300\uBE44 \uC911\uC2EC \uD504\uB85C\uADF8\uB7A8\uACFC \uD2B9\uAC15/\uD3C9\uAC00 \uCCB4\uACC4\uAC00 \uC6B4\uC601\uB41C\uB2E4.", hint: "\uD504\uB85C\uADF8\uB7A8\xB7\uD2B9\uAC15\xB7\uD3C9\uAC00" }), n;
}
__name(Dr, "Dr");
function Br(t) {
  const e = tn(t), n = Ir(e), r = Tt(n, "standard"), s = Tt(n, "brief"), i = rt(n, "detail", e), a = rt(r, "standard", e), o = rt(s, "brief", e), c = /* @__PURE__ */ __name((l, u, f) => ({ mode: l, narrative: f, structured: u, mindmap: Pr(u), selftest: Dr(u, l) }), "c");
  return { brief: c("brief", s, o), standard: c("standard", r, a), detail: c("detail", n, i) };
}
__name(Br, "Br");
var Lr = Object.freeze(Object.defineProperty({ __proto__: null, buildAllSummariesV4_Quality: Br, sanitizeKoreanAcademicText: tn }, Symbol.toStringTag, { value: "Module" }));
...
// ../.wrangler/tmp/bundle-DOnYsZ/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-DOnYsZ/middleware-loader.entry.ts
...
//# sourceMappingURL=bundledWorker-0.894154230845043.mjs.map
