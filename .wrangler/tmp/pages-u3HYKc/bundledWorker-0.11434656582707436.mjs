...
// ../.wrangler/tmp/bundle-DI9wMD/checked-fetch.js
...
// ../.wrangler/tmp/bundle-DI9wMD/strip-cf-connecting-ip-header.js
...
var en = /* @__PURE__ */ __name((t, e, n) => e in t ? Zt(t, e, { enumerable: true, configurable: true, writable: true, value: n }) : t[e] = n, "en");
var S = /* @__PURE__ */ __name((t, e, n) => en(t, typeof e != "symbol" ? e + "" : e, n), "S");
var We = /* @__PURE__ */ __name((t, e, n) => e.has(t) || it("Cannot " + n), "We");
var d = /* @__PURE__ */ __name((t, e, n) => (We(t, e, "read from private field"), n ? n.call(t) : e.get(t)), "d");
var C = /* @__PURE__ */ __name((t, e, n) => e.has(t) ? it("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, n), "C");
var E = /* @__PURE__ */ __name((t, e, n, r) => (We(t, e, "write to private field"), r ? r.call(t, n) : e.set(t, n), n), "E");
var k = /* @__PURE__ */ __name((t, e, n) => (We(t, e, "access private method"), n), "k");
var at = /* @__PURE__ */ __name((t, e, n, r) => ({ set _(s) {
  E(t, e, s, n);
}, get _() {
  return d(t, e, r);
} }), "at");
var ot = /* @__PURE__ */ __name((t, e, n) => (r, s) => {
  let i = -1;
  return a(0);
  async function a(o) {
    if (o <= i)
...
var tn = Symbol();
var nn = /* @__PURE__ */ __name(async (t, e = /* @__PURE__ */ Object.create(null)) => {
  const { all: n = false, dot: r = false } = e, i = (t instanceof kt ? t.raw.headers : t.headers).get("Content-Type");
  return i != null && i.startsWith("multipart/form-data") || i != null && i.startsWith("application/x-www-form-urlencoded") ? rn(t, { all: n, dot: r }) : {};
}, "nn");
...
function sn(t, e) {
  ...
  return t.forEach((r, s) => {
    e.all || s.endsWith("[]") ? an(n, s, r) : n[s] = r;
  }), e.dot && Object.entries(n).forEach(([r, s]) => {
    r.includes(".") && (on(n, r, s), delete n[r]);
  }), n;
}
__name(sn, "sn");
...
var cn = /* @__PURE__ */ __name((t) => {
  const { groups: e, path: n } = ln(t), r = At(n);
  return dn(r, e);
}, "cn");
...
var hn = /* @__PURE__ */ __name((t) => rt(t, decodeURI), "hn");
var Ct = /* @__PURE__ */ __name((t) => {
  ...
  for (; r < e.length; r++) {
    ...
    if (s === 37) {
      ...
      return hn(a.includes("%25") ? a.replace(/%25/g, "%2525") : a);
    } else if (s === 63)
      break;
  }
  return e.slice(n, r);
...
var ge = /* @__PURE__ */ __name((t, e, ...n) => (n.length && (e = ge(e, ...n)), `${(t == null ? void 0 : t[0]) === "/" ? "" : "/"}${t}${e === "/" ? "" : `${(t == null ? void 0 : t.at(-1)) === "/" ? "" : "/"}${(e == null ? void 0 : e[0]) === "/" ? e.slice(1) : e}`}`), "ge");
...
var Qe = /* @__PURE__ */ __name((t) => /[%+]/.test(t) ? (t.indexOf("+") !== -1 && (t = t.replace(/\+/g, " ")), t.indexOf("%") !== -1 ? rt(t, _t) : t) : t, "Qe");
...
var fn = Nt;
var mn = /* @__PURE__ */ __name((t, e) => Nt(t, e, true), "mn");
var _t = decodeURIComponent;
var ct = /* @__PURE__ */ __name((t) => rt(t, _t), "ct");
var be;
var G;
var ee;
var Rt;
...
var te;
var bt;
var kt = (bt = /* @__PURE__ */ __name(class {
  constructor(t, e = "/", n = [[]]) {
    C(this, ee);
    S(this, "raw");
    C(this, be);
  ...
  param(t) {
    return t ? k(this, ee, Rt).call(this, t) : k(this, ee, Mt).call(this);
  }
  query(t) {
  ...
  async parseBody(t) {
    var e;
    return (e = this.bodyCache).parsedBody ?? (e.parsedBody = await nn(this, t));
  }
  json() {
...
}, "bt"), be = /* @__PURE__ */ new WeakMap(), G = /* @__PURE__ */ new WeakMap(), ee = /* @__PURE__ */ new WeakSet(), Rt = /* @__PURE__ */ __name(function(t) {
  const e = d(this, G)[0][this.routeIndex][1][t], n = k(this, ee, nt).call(this, e);
  return n && /\%/.test(n) ? ct(n) : n;
}, "Rt"), Mt = /* @__PURE__ */ __name(function() {
  const t = {}, e = Object.keys(d(this, G)[0][this.routeIndex][1]);
  for (const n of e) {
    const r = k(this, ee, nt).call(this, d(this, G)[0][this.routeIndex][1][n]);
    r !== void 0 && (t[n] = /\%/.test(r) ? ct(r) : r);
  }
  return t;
}, "Mt"), nt = /* @__PURE__ */ __name(function(t) {
  return d(this, G)[1] ? d(this, G)[1][t] : t;
}, "nt"), te = /* @__PURE__ */ new WeakMap(), bt);
var gn = { Stringify: 1 };
var It = /* @__PURE__ */ __name(async (t, e, n, r, s) => {
...
var xn = "text/plain; charset=UTF-8";
...
var xe;
var yt;
var vn = (yt = /* @__PURE__ */ __name(class {
  constructor(t, e) {
    C(this, ne);
    C(this, Re);
    C(this, Me);
    ...
    S(this, "text", (t2, e2, n) => !d(this, le) && !d(this, ye) && !e2 && !n && !this.finalized ? new Response(t2) : k(this, ne, xe).call(this, t2, e2, Ze(xn, n)));
    S(this, "json", (t2, e2, n) => k(this, ne, xe).call(this, JSON.stringify(t2), e2, Ze("application/json", n)));
    S(this, "html", (t2, e2, n) => {
      const r = /* @__PURE__ */ __name((s) => k(this, ne, xe).call(this, s, e2, Ze("text/html; charset=UTF-8", n)), "r");
      return typeof t2 == "object" ? It(t2, gn.Stringify, false, {}).then(r) : r(t2);
    });
  ...
  get req() {
    return d(this, Me) ?? E(this, Me, new kt(d(this, Re), d(this, $e), d(this, je))), d(this, Me);
  }
  get event() {
...
var I = "ALL";
var bn = "all";
var yn = ["get", "post", "put", "delete", "options", "patch"];
var jt = "Can not add a route since the matcher is already built.";
var $t = /* @__PURE__ */ __name(class extends Error {
}, "$t");
var wn = "__COMPOSED_HANDLER";
var En = /* @__PURE__ */ __name((t) => t.text("404 Not Found", 404), "En");
...
var qe;
var Se;
var Sn = (Se = /* @__PURE__ */ __name(class {
  constructor(e = {}) {
    C(this, j);
    S(this, "get");
    S(this, "post");
    ...
    S(this, "routes", []);
    C(this, K, En);
    S(this, "errorHandler", lt);
    S(this, "onError", (e2) => (this.errorHandler = e2, this));
    S(this, "notFound", (e2) => (E(this, K, e2), this));
    S(this, "fetch", (e2, ...n) => k(this, j, qe).call(this, e2, n[1], n[0], e2.method));
    ...
    S(this, "fire", () => {
      addEventListener("fetch", (e2) => {
        e2.respondWith(k(this, j, qe).call(this, e2.request, e2, void 0, e2.request.method));
      });
    });
    [...yn, bn].forEach((i) => {
      this[i] = (a, ...o) => (typeof a == "string" ? E(this, U, a) : k(this, j, oe).call(this, i, d(this, U), a), o.forEach((c) => {
        k(this, j, oe).call(this, i, d(this, U), c);
      }), this);
    }), this.on = (i, a, ...o) => {
      for (const c of [a].flat()) {
        ...
        for (const l of [i].flat())
          o.map((u) => {
            k(this, j, oe).call(this, l.toUpperCase(), d(this, U), u);
          });
      }
      return this;
    }, this.use = (i, ...a) => (typeof i == "string" ? E(this, U, i) : (E(this, U, "*"), a.unshift(i)), a.forEach((o) => {
      k(this, j, oe).call(this, I, d(this, U), o);
    }), this);
    const { strict: r, ...s } = e;
    Object.assign(this, s), this.getPath = r ?? true ? e.getPath ?? Ct : pn;
  }
  route(e, n) {
    ...
    return n.routes.map((s) => {
      var a;
      let i;
      n.errorHandler === lt ? i = s.handler : (i = /* @__PURE__ */ __name(async (o, c) => (await ot([], n.errorHandler)(o, () => s.handler(o, c))).res, "i"), i[wn] = s.handler), k(a = r, j, oe).call(a, s.method, s.path, i);
    }), this;
  }
  basePath(e) {
    const n = k(this, j, Pt).call(this);
  ...
  mount(e, n, r) {
    ...
    return k(this, j, oe).call(this, I, ge(e, "*"), o), this;
  }
}, "Se"), U = /* @__PURE__ */ new WeakMap(), j = /* @__PURE__ */ new WeakSet(), Pt = /* @__PURE__ */ __name(function() {
...
}, "Pt"), K = /* @__PURE__ */ new WeakMap(), oe = /* @__PURE__ */ __name(function(e, n, r) {
...
}, "oe"), He = /* @__PURE__ */ __name(function(e, n) {
  if (e instanceof Error)
    return this.errorHandler(e, n);
  throw e;
}, "He"), qe = /* @__PURE__ */ __name(function(e, n, r, s) {
  if (s === "HEAD")
    return (async () => new Response(null, await k(this, j, qe).call(this, e, n, r, "GET")))();
  const i = this.getPath(e, { env: r }), a = this.router.match(s, i), o = new vn(e, { path: i, matchResult: a, env: r, executionCtx: n, notFoundHandler: d(this, K) });
  if (a[0].length === 1) {
    let l;
    try {
      l = a[0][0][0][0](o, async () => {
      ...
      return k(this, j, He).call(this, u, o);
    }
    return l instanceof Promise ? l.then((u) => u || (o.finalized ? o.res : d(this, K).call(this, o))).catch((u) => k(this, j, He).call(this, u, o)) : l ?? d(this, K).call(this, o);
  }
  const c = ot(a[0], this.errorHandler, d(this, K));
  return (async () => {
    try {
      const l = await c(o);
      if (!l.finalized)
      ...
      return k(this, j, He).call(this, l, o);
    }
  })();
}, "qe"), Se);
var Dt = [];
...
var F;
var fe;
var On = (fe = /* @__PURE__ */ __name(class {
  constructor() {
    C(this, de);
    C(this, ue);
  ...
  insert(e, n, r, s, i) {
    ...
    if (c) {
      ...
      if (u && c[2] && (h === ".*" || (h = h.replace(/^\((?!\?:)(?=[^)]+\)$)/, "(?:"), /\((?!\?:)/.test(h))))
        throw ve;
      if (l = d(this, F)[h], !l) {
        if (Object.keys(d(this, F)).some((f) => f !== _e && f !== ke))
          throw ve;
        if (i)
          return;
  ...
  buildRegExpStr() {
    const n = Object.keys(d(this, F)).sort(Cn).map((r) => {
      const s = d(this, F)[r];
      return (typeof d(s, ue) == "number" ? `(${r})@${d(s, ue)}` : An.has(r) ? `\\${r}` : r) + s.buildRegExpStr();
    });
...
}, "wt"), Fe = /* @__PURE__ */ new WeakMap(), Pe = /* @__PURE__ */ new WeakMap(), wt);
...
function Rn(t) {
  ...
  if (t.length === 0)
    return _n;
  const r = t.map((u) => [!/\*|\/:/.test(u[0]), ...u]).sort(([u, h], [f, y]) => u ? 1 : f ? -1 : h.length - y.length), s = /* @__PURE__ */ Object.create(null);
  for (let u = 0, h = -1, f = r.length; u < f; u++) {
    const [y, T, O] = r[u];
    y ? s[T] = [O.map(([M]) => [M, /* @__PURE__ */ Object.create(null)]), Dt] : h++;
    let A;
    try {
      A = e.insert(T, h, y);
    } catch (M) {
      throw M === ve ? new $t(T) : M;
    }
    y || (n[h] = O.map(([M, $]) => {
  ...
  for (let u = 0, h = n.length; u < h; u++)
    for (let f = 0, y = n[u].length; f < y; f++) {
      const T = (l = n[u][f]) == null ? void 0 : l[1];
      if (!T)
        continue;
...
var Bt;
var Et;
var Mn = (Et = /* @__PURE__ */ __name(class {
  constructor() {
    C(this, Je);
    ...
    C(this, se);
    S(this, "match", Tn);
    E(this, re, { [I]: /* @__PURE__ */ Object.create(null) }), E(this, se, { [I]: /* @__PURE__ */ Object.create(null) });
  }
  add(t, e, n) {
    var o;
    ...
    if (/\*$/.test(e)) {
      ...
      t === I ? Object.keys(r).forEach((l) => {
        var u;
        (u = r[l])[e] || (u[e] = me(r[l], e) || me(r[I], e) || []);
      }) : (o = r[t])[e] || (o[e] = me(r[t], e) || me(r[I], e) || []), Object.keys(r).forEach((l) => {
    ...
    for (let c = 0, l = a.length; c < l; c++) {
      ...
      Object.keys(s).forEach((h) => {
        var f;
        (t === I || t === h) && ((f = s[h])[u] || (f[u] = [...me(r[h], u) || me(r[I], u) || []]), s[h][u].push([n, i - l + c + 1]));
      });
    }
  }
  buildAllMatchers() {
    ...
    return Object.keys(d(this, se)).concat(Object.keys(d(this, re))).forEach((e) => {
      t[e] || (t[e] = k(this, Je, Bt).call(this, e));
    }), E(this, re, E(this, se, void 0)), kn(), t;
  }
}, "Et"), re = /* @__PURE__ */ new WeakMap(), se = /* @__PURE__ */ new WeakMap(), Je = /* @__PURE__ */ new WeakSet(), Bt = /* @__PURE__ */ __name(function(t) {
  const e = [];
  let n = t === I;
...
var Q;
var St;
var In = (St = /* @__PURE__ */ __name(class {
  constructor(t) {
...
var ce;
var Ae;
var jn = (Ae = /* @__PURE__ */ __name(class {
  constructor(e, n, r) {
    C(this, Z);
    C(this, ae);
    C(this, B);
  ...
  insert(e, n, r) {
    E(this, Te, ++at(this, Te)._);
    let s = this;
    const i = cn(n), a = [];
    for (let o = 0, c = i.length; o < c; o++) {
      const l = i[o], u = i[o + 1], h = un(l, u), f = Array.isArray(h) ? h[0] : l;
      if (f in d(s, B)) {
        s = d(s, B)[f], h && a.push(h[1]);
        continue;
      }
      d(s, B)[f] = new Ae(), h && (d(s, he).push(h), a.push(h[1])), s = d(s, B)[f];
    }
  ...
  search(e, n) {
    ...
    for (let l = 0, u = a.length; l < u; l++) {
      const h = a[l], f = l === u - 1, y = [];
      for (let T = 0, O = i.length; T < O; T++) {
        const A = i[T], M = d(A, B)[h];
        M && (E(M, L, d(A, L)), f ? (d(M, B)["*"] && r.push(...k(this, Z, ce).call(this, d(M, B)["*"], e, d(A, L))), r.push(...k(this, Z, ce).call(this, M, e, d(A, L)))) : y.push(M));
        for (let $ = 0, z = d(A, he).length; $ < z; $++) {
          const R = d(A, he)[$], b = d(A, L) === Oe ? {} : { ...d(A, L) };
          if (R === "*") {
            const w = d(A, B)["*"];
            w && (r.push(...k(this, Z, ce).call(this, w, e, d(A, L))), E(w, L, b), y.push(w));
            continue;
          }
          const [N, g, x] = R;
          if (!h && !(x instanceof RegExp))
            continue;
          const m = d(A, B)[N], v = a.slice(l).join("/");
          if (x instanceof RegExp) {
            const w = x.exec(v);
            if (w) {
              if (b[g] = w[0], r.push(...k(this, Z, ce).call(this, m, e, d(A, L), b)), Object.keys(d(m, B)).length) {
                E(m, L, b);
                const p = ((c = w[0].match(/\//)) == null ? void 0 : c.length) ?? 0;
                (o[p] || (o[p] = [])).push(m);
              }
              continue;
            }
          }
          (x === true || x.test(h)) && (b[g] = h, f ? (r.push(...k(this, Z, ce).call(this, m, e, b, d(A, L))), d(m, B)["*"] && r.push(...k(this, Z, ce).call(this, d(m, B)["*"], e, b, d(A, L)))) : (E(m, L, b), y.push(m)));
        }
      }
      i = y.concat(o.shift() ?? []);
    }
...
}, "Ae"), ae = /* @__PURE__ */ new WeakMap(), B = /* @__PURE__ */ new WeakMap(), he = /* @__PURE__ */ new WeakMap(), Te = /* @__PURE__ */ new WeakMap(), L = /* @__PURE__ */ new WeakMap(), Z = /* @__PURE__ */ new WeakSet(), ce = /* @__PURE__ */ __name(function(e, n, r, s) {
  const i = [];
  for (let a = 0, o = d(e, ae).length; a < o; a++) {
    ...
    if (l !== void 0 && (l.params = /* @__PURE__ */ Object.create(null), i.push(l), r !== Oe || s && s !== Oe))
      for (let h = 0, f = l.possibleKeys.length; h < f; h++) {
        const y = l.possibleKeys[h], T = u[l.score];
        l.params[y] = s != null && s[y] && !T ? s[y] : r[y] ?? (s == null ? void 0 : s[y]), u[l.score] = true;
      }
  }
  return i;
}, "ce"), Ae);
var pe;
var Tt;
var $n = (Tt = /* @__PURE__ */ __name(class {
  constructor() {
...
}, "Tt"), pe = /* @__PURE__ */ new WeakMap(), Tt);
var Ht = /* @__PURE__ */ __name(class extends Sn {
  constructor(t = {}) {
    super(t), this.router = t.router ?? new In({ routers: [new Mn(), new $n()] });
  }
}, "Ht");
var Pn = /* @__PURE__ */ __name((t) => {
...
var qn = Object.keys(qt);
var zn = "index.html";
var Gn = /* @__PURE__ */ __name((t) => {
  const e = t.root ?? "./", n = t.path, r = t.join ?? Hn;
  return async (s, i) => {
    var u, h, f, y;
    if (s.finalized)
      return i();
    ...
    if (l) {
      const T = t.mimes && dt(o, t.mimes) || dt(o);
      if (s.header("Content-Type", T || "application/octet-stream"), t.precompressed && (!T || Dn.test(T))) {
        const O = new Set((h = s.req.header("Accept-Encoding")) == null ? void 0 : h.split(",").map((A) => A.trim()));
        for (const A of qn) {
          if (!O.has(A))
            continue;
          const M = await c(o + qt[A], s);
          if (M) {
      ...
      return await ((f = t.onFound) == null ? void 0 : f.call(t, o, s)), s.body(l);
    }
    await ((y = t.onNotFound) == null ? void 0 : y.call(t, o, s)), await i();
  };
}, "Gn");
var Un = /* @__PURE__ */ __name(async (t, e) => {
  let n;
...
var Kn = /* @__PURE__ */ __name((t) => async function(n, r) {
  return Gn({ ...t, getContent: async (i) => Un(i, { manifest: t.manifest, namespace: t.namespace ? t.namespace : n.env ? n.env.__STATIC_CONTENT : void 0 }) })(n, r);
}, "Kn");
var Fn = /* @__PURE__ */ __name((t) => Kn(t), "Fn");
var J = new Ht();
var Ge = /* @__PURE__ */ new Map();
var Jn = 1e3 * 60 * 60 * 24 * 7;
var et = false;
function zt() {
...
function Kt(t) {
  ...
  for (let o = 0; o < e.length; o++) {
    ...
    if (s === null && i === 0 && l === " ") {
      const f = r.trimEnd().slice(-1), y = /[가-힣A-Za-z0-9"'(\[]/.test(u);
      (f === "\uB2E4" || f === "\uC694" || f === "\uC8E0") && y && (a(), o++);
    }
  }
...
__name(ft, "ft");
function mt(t, e) {
  const n = Ve.narrative[e], i = Kt(t.summary || "").slice(0, n).join(" "), a = (t.keyPoints || []).slice(0, e === "brief" ? 3 : 4), o = (t.examHints || []).slice(0, e === "brief" ? 2 : 3);
  return { ...t, summary: i, keyPoints: a, examHints: o };
}
__name(mt, "mt");
async function Be(t, e) {
  const n = /* @__PURE__ */ __name(async () => {
    const o = await Jt(t, e);
    return String(o || "");
  }, "n"), r = await n(), s = ut(r);
  if (s)
    return s;
  const i = await n(), a = ut(i);
  if (a)
    return a;
...
async function sr(t, e) {
  ...
  const r = await Be(t, tr(e, n));
  if (!(r != null && r.summary))
    throw new Error("NARRATIVE_SCHEMA_INVALID");
  const s = await Be(t, nr(n));
  ...
  const i = await Be(t, rr(n));
  if (!Array.isArray(i.questions))
    throw new Error("SELFTEST_SCHEMA_INVALID");
  const a = { detail: n, standard: ht(n, "standard"), brief: ht(n, "brief") }, o = { detail: r, standard: mt(r, "standard"), brief: mt(r, "brief") }, c = { detail: s, standard: pt(s, "standard"), brief: pt(s, "brief") }, l = { detail: i, standard: ft(i, "standard"), brief: ft(i, "brief") };
...
function lr(t, e) {
  if (t.length === 0)
    return [];
  const n = cr(t), r = n[0], s = n.slice(1), i = s.slice().sort((o, c) => c.score - o.score).slice(0, Ue(e - 1, 0, Math.max(0, s.length)));
...
function ur(t, e, n) {
  ...
  const r = Math.max(1, Number(n) || 1), s = e === "brief" ? { min: 10, max: 15 } : e === "detail" ? { min: 45, max: 55 } : { min: 25, max: 30 }, i = ["\uB610\uD55C", "\uC544\uC6B8\uB7EC", "\uB354\uBD88\uC5B4"], a = ["\uD55C\uD3B8", "\uC774\uC640 \uD568\uAED8", "\uC774\uC640 \uB354\uBD88\uC5B4", "\uB610 \uB2E4\uB978 \uCE21\uBA74\uC5D0\uC11C"], o = /* @__PURE__ */ __name((b) => {
    const N = String(b || "").trim().slice(0, 24);
    if (/^(또한|아울러|더불어|한편|이와\s|그리고|그러나|하지만)\b/.test(N))
      return null;
    const g = N.match(/^(.{1,20}?(은|는|이|가))\s+/);
    return g ? g[1] : null;
  }, "o"), c = /* @__PURE__ */ __name((b) => {
    const N = String(b || "").trim();
    return N && (/[.!?…]$/.test(N) ? N : N + ".");
  }, "c"), l = /* @__PURE__ */ __name((b) => {
    let N = String(b || "").trim(), g = "";
    const x = N.match(/([.!?…])$/);
    return x && (g = x[1], N = N.slice(0, -1).trim()), N = N.replace(/합니다$/, "\uD55C\uB2E4").replace(/되었습니다$/, "\uB418\uC5C8\uB2E4").replace(/입니다$/, "\uC774\uB2E4").replace(/습니다$/, "\uB2E4"), (N + (g || ".")).trim();
  }, "l"), u = /* @__PURE__ */ __name((b) => /^(그러므로|따라서|하지만|그러나|또한|더불어|한편|이와|나아가|아울러|즉|특히)\s/.test(b.trim()), "u"), h = /* @__PURE__ */ __name((b) => b.replace(/^(또한|더불어|한편|이와|나아가|아울러)\s+/, "").trim(), "h");
  let f = t.map((b, N) => {
    const g = String(b || "").trim();
    if (!g)
      return "";
    if (N === 0) {
      const p = h(g);
    ...
    if (u(g))
      return l(c(g));
    const x = String(t[N - 1] || "").trim(), m = o(x), v = o(g), w = /* @__PURE__ */ __name((p) => p[N % p.length], "w");
    if (v && m && v === m) {
      const p = g.replace(/^(.{1,40}?(은|는|이|가))\s+/, "");
      return l(c(`${w(i)} ${p}`.trim()));
    } else
      return g.length > 15 ? l(c(`${w(a)} ${g}`.trim())) : l(c(g));
  }).filter(Boolean);
  const y = /* @__PURE__ */ __name((b) => String(b || "").replace(/\s+/g, "").length, "y");
  let T = f.join(" ");
  T = T.replace(/\s*(또한|더불어|한편|이와|나아가|아울러)\s+(또한|더불어|한편|이와|나아가|아울러)\s+/g, " $2 ").replace(/\s{2,}/g, " ").trim();
  let O = y(T) / r * 100;
  for (; O > s.max && f.length > 1; )
    f.pop(), T = f.join(" "), O = y(T) / r * 100;
  O < s.min && console.warn(`[\uC820\uC2A4] \uC694\uC57D\uC728 ${O.toFixed(1)}%\uAC00 \uBAA9\uD45C \uCD5C\uC18C\uCE58 ${s.min}% \uBBF8\uB9CC\uC785\uB2C8\uB2E4.`);
  const M = f.join(" ").replace(/[0-9]/g, " ").replace(/[^\uAC00-\uD7A3a-zA-Z\s]/g, " ").split(/\s+/).map((b) => b.trim()).filter((b) => b.length >= 2 && b.length <= 6), $ = /* @__PURE__ */ new Map();
  for (const b of M)
    $.set(b, ($.get(b) || 0) + 1);
  const z = [...$.entries()].sort((b, N) => N[1] - b[1]).slice(0, 12).map(([b]) => b), R = { keywords: z, nodes: z.map((b, N) => ({ id: `k${N}`, label: b })), edges: [] };
  return { summary: T, mindmap: R, meta: { ratio: O, target: s } };
}
__name(ur, "ur");
function tt(t, e, n) {
  const r = ir(t);
  ...
  let a = lr(s, i);
  if (e === "detail") {
    const l = ["\uC131\uBCC4", "\uD559\uB144", "\uB0A8\uD559\uC0DD", "\uC5EC\uD559\uC0DD", "\uCD08\uB4F1", "\uC911\uD559", "\uACE0\uD559\uB144", "\uC800\uD559\uB144", "\uBCC0\uC778", "\uCC28\uC774", "\uBE44\uAD50"], u = s.filter((h) => l.some((f) => h.includes(f)) && !a.includes(h)).slice(0, 5);
    u.length > 0 && (a = [...a, ...u]);
  }
  const o = st(r);
  if (n === "narrative") {
    ...
    {
      const f = ur(a, e, o);
      l = f.summary, u = f.mindmap, h = f.meta;
    }
    return l = dr(l), { kind: "summary", mode: e, viewType: n, narrative: l, ...u && { mindmapKeywords: u }, ...h && { meta: { ...h, inputNormalized: true, originalLen: o } } };
  }
  if (n === "structured")
  ...
  if (n === "mindmap") {
    ...
    return a.slice(1).forEach((f, y) => {
      const T = `n${y + 1}`;
      u.push({ id: T, label: f.slice(0, 60), level: 1 }), h.push({ from: "c", to: T });
...
async function vr(t, e) {
  ...
  for (; a < 3; ) {
    ...
    if (y.ok) {
      ...
      return { ok: true, text: ((f = (h = (u = (l = (c = O == null ? void 0 : O.candidates) == null ? void 0 : c[0]) == null ? void 0 : l.content) == null ? void 0 : u.parts) == null ? void 0 : h[0]) == null ? void 0 : f.text) ?? "", raw: O };
    }
    if (y.status === 429 || y.status === 503) {
      await new Promise((O) => setTimeout(O, o)), o *= 2;
      continue;
    }
    const T = await y.text().catch(() => "");
    throw new Error(`Gemini error ${y.status}: ${T.slice(0, 200)}`);
  }
...
async function br(t, e, n) {
  ...
  for (; o < 3; ) {
    ...
    if (T.ok) {
      ...
      return ((y = (f = (h = (u = (l = A == null ? void 0 : A.candidates) == null ? void 0 : l[0]) == null ? void 0 : u.content) == null ? void 0 : h.parts) == null ? void 0 : f[0]) == null ? void 0 : y.text) ?? "";
    }
...
var yr = (() => {
  ...
  __name(i, "i");
  function a(g, x) {
    const v = Math.max(200, i(g || "").length), w = e[x] || e.standard, p = Math.floor(v * w.min), _ = Math.ceil(v * w.max);
  ...
  __name(o, "o");
  function c(g) {
    return o(g).map((m, v) => ({ sid: `S${v + 1}`, text: m }));
  }
  __name(c, "c");
  function l(g, x, m) {
    const v = g.find((w) => w.sid === x);
    return !v || !m || typeof m != "string" ? false : v.text.includes(m.trim());
  }
  __name(l, "l");
  function u() {
...
`);
  ...
  __name(f, "f");
  function y({ mode: g, purpose: x, format: m, summaryText: v, sentTable: w, anchors: p }) {
    const _ = n[g] || 10, q = x === "preview" ? "\uC608\uC2B5\uC6A9 \uC140\uD504\uD14C\uC2A4\uD2B8: \uC694\uC57D\uBB38 \uC548\uC5D0\uC11C \uBC14\uB85C \uD655\uC778 \uAC00\uB2A5\uD55C \uC7AC\uC778 \uC911\uC2EC(\uC2A4\uD0A4\uB9C8 \uD615\uC131). \uACFC\uB3C4\uD55C \uCD94\uB860 \uAE08\uC9C0." : "\uC2DC\uD5D8\uB300\uBE44 \uC140\uD504\uD14C\uC2A4\uD2B8: \uC694\uC57D\uBB38\uC5D0 \uC788\uB294 \uADFC\uAC70\uB97C \uBC14\uD0D5\uC73C\uB85C \uC778\uACFC/\uAD00\uACC4/\uBD84\uB958\uB97C \uC778\uCD9C\uD558\uB294 \uD68C\uC0C1 \uC911\uC2EC. \uC694\uC57D\uC5D0 \uC5C6\uB294 \uC815\uBCF4 \uAE08\uC9C0.", V = m === "narrative" ? "\uBB38\uD56D \uC2A4\uD0C0\uC77C: \uBB38\uC7A5 \uBE48\uCE78, \uBB38\uC7A5 \uC21C\uC11C \uBC30\uC5F4, \uC778\uACFC\uAD00\uACC4 \uB2E8\uB2F5/\uC11C\uC220(\uC694\uC57D \uADFC\uAC70 \uD544\uC218)" : m === "structured" ? "\uBB38\uD56D \uC2A4\uD0C0\uC77C: \uD56D\uBAA9-\uC815\uC758 \uB9E4\uCE6D, \uBD84\uB958 \uCC44\uC6B0\uAE30, \uC0C1\uD558\uC704 \uCCB4\uACC4, \uC0AC\uB840-\uBC94\uC8FC \uB9E4\uCE6D(\uC694\uC57D \uADFC\uAC70 \uD544\uC218)" : "\uBB38\uD56D \uC2A4\uD0C0\uC77C: \uB178\uB4DC \uB77C\uBCA8 \uB9DE\uCD94\uAE30, \uC5F0\uACB0 \uB77C\uBCA8\uB9C1, \uB204\uB77D \uB178\uB4DC/\uC5F0\uACB0 \uBCF5\uC6D0, \uAD00\uACC4 \uC774\uC720 \uB2E8\uB2F5(\uC694\uC57D \uADFC\uAC70 \uD544\uC218)";
    return ["[TASK] \uC544\uB798 \uC694\uC57D\uBB38\uACFC \uC575\uCEE4\uB9CC\uC744 \uADFC\uAC70\uB85C \uC140\uD504\uD14C\uC2A4\uD2B8 \uBB38\uD56D\uC744 \uC0DD\uC131\uD558\uB77C.", `- \uBAA8\uB4DC: ${g} (\uBB38\uD56D\uC218 ${_})`, `- \uBAA9\uC801: ${x} (${q})`, `- \uC694\uC57D \uD615\uC2DD: ${m} (${V})`, "- \uADDC\uCE591: \uC694\uC57D\uBB38\uC5D0 \uC5C6\uB294 \uC815\uBCF4\uB85C \uBB38\uC81C \uB9CC\uB4E4\uC9C0 \uB9D0 \uAC83(\uD560\uB8E8\uC2DC\uB124\uC774\uC158 \uAE08\uC9C0).", "- \uADDC\uCE592: \uAC01 \uBB38\uD56D\uC740 \uBC18\uB4DC\uC2DC evidence\uB97C \uD3EC\uD568: sid + quote(\uC694\uC57D \uBB38\uC7A5 \uC77C\uBD80 8~25\uC790).", "- \uADDC\uCE593: quote\uB294 \uBC18\uB4DC\uC2DC \uD574\uB2F9 sid \uBB38\uC7A5\uC5D0 \uC2E4\uC81C\uB85C \uD3EC\uD568\uB418\uC5B4\uC57C \uD55C\uB2E4.", "- \uADDC\uCE594: \uC815\uB2F5/\uD574\uC124\uC740 \uAC04\uACB0\uD558\uAC8C. \uD574\uC124\uC740 evidence\uC640 \uC5F0\uACB0\uB418\uAC8C.", "", "[OUTPUT JSON ONLY]", `{
  "items":[
    {
      "id":"Q1",
...
`);
  ...
  __name(y, "y");
  function T(g, x) {
    const m = x && x.anchors ? x.anchors : [], v = [], w = [];
    for (const p of m) {
  ...
  __name(T, "T");
  function O(g, x) {
    const m = x && Array.isArray(x.items) ? x.items : [], v = [], w = [];
    for (const p of m) {
  ...
  __name(O, "O");
  function A({ summaryText: g, sentTable: x, anchors: m, badItems: v, mode: w, purpose: p, format: _ }) {
    return ["[TASK] \uC544\uB798\uB294 \uAC80\uC99D\uC5D0\uC11C \uD0C8\uB77D\uD55C \uBB38\uD56D\uB4E4\uC774\uB2E4. \uC694\uC57D\uBB38 \uADFC\uAC70(sid+quote)\uB97C \uB9CC\uC871\uD558\uB3C4\uB85D \uBB38\uD56D\uC744 \uB2E4\uC2DC \uC0DD\uC131\uD558\uB77C.", `- \uC7AC\uC0DD\uC131 \uBB38\uD56D \uC218: ${v.length}`, `- \uBAA8\uB4DC: ${w}, \uBAA9\uC801: ${p}, \uD615\uC2DD: ${_}`, "- \uADDC\uCE59: \uC694\uC57D\uBB38 \uBC16 \uC815\uBCF4 \uAE08\uC9C0. \uBC18\uB4DC\uC2DC sid+quote\uAC00 \uC2E4\uC81C\uB85C \uD574\uB2F9 \uBB38\uC7A5\uC5D0 \uD3EC\uD568\uB418\uC5B4\uC57C \uD55C\uB2E4.", "- \uCD9C\uB825: JSON\uB9CC. items \uAE38\uC774\uB294 \uC815\uD655\uD788 \uC7AC\uC0DD\uC131 \uBB38\uD56D \uC218\uC640 \uAC19\uC544\uC57C \uD55C\uB2E4.", "", "[OUTPUT JSON ONLY]", '{"items":[{ "id":"Qx","type":"blank|match|order|label|short|mcq","question":"...","choices":[],"answer":"...","explanation":"...","evidence":{"sid":"S1","quote":"..." },"anchorIds":["A1"] }]}', "", "[SUMMARY SENTENCES WITH ID]", JSON.stringify(x, null, 2), "", "[ANCHORS]", JSON.stringify(m, null, 2), "", "[BAD ITEMS]", JSON.stringify(v, null, 2), "", "[SUMMARY]", g].join(`
`);
  }
  __name(A, "A");
  async function M({ llmCall: g, originalText: x, mode: m, format: v }) {
    if (!g)
      throw new Error("llmCall is required");
    e[m] || (m = "standard"), r.includes(v) || (v = "narrative");
    const w = h({ originalText: x, mode: m, format: v }), p = (await g({ system: u(), user: w, json: false }) || "").trim() || "", _ = c(p), q = f({ summaryText: p, format: v });
    let V = await g({ system: u(), user: q, json: true }), Y;
    try {
      Y = JSON.parse(V);
    } catch {
      Y = { anchors: [] };
    }
    const { ok: P } = T(_, Y), De = P.length >= 4 ? P : $(_);
    return { summaryText: p, sentTable: _, anchors: De };
  }
  __name(M, "M");
  function $(g) {
    const x = [];
    for (let m = 0; m < Math.min(8, g.length); m++) {
      const v = g[m], w = (v.text || "").slice(0, 18);
      x.push({ id: `A${m + 1}`, label: `\uBB38\uC7A5 \uD575\uC2EC${m + 1}`, type: "claim", sid: v.sid, quote: w, note: "\uC694\uC57D \uBB38\uC7A5 \uAE30\uBC18 \uC548\uC804 \uC575\uCEE4" });
    }
    return x;
  }
  __name($, "$");
  async function z({ llmCall: g, mode: x, purpose: m, format: v, summaryText: w, sentTable: p, anchors: _ }) {
    e[x] || (x = "standard"), s.includes(m) || (m = "preview"), r.includes(v) || (v = "narrative");
    const q = y({ mode: x, purpose: m, format: v, summaryText: w, sentTable: p, anchors: _ });
    let V = await g({ system: u(), user: q, json: true }), Y;
    try {
      Y = JSON.parse(V);
    } catch {
    ...
    if (De.length > 0) {
      const Ce = A({ summaryText: w, sentTable: p, anchors: _, badItems: De.map((Qt) => Qt.q), mode: x, purpose: m, format: v });
      let Yt = await g({ system: u(), user: Ce, json: true }), Xe;
      try {
        Xe = JSON.parse(Yt);
      } catch {
        Xe = { items: [] };
    ...
    const Ye = n[x] || 10;
    if (P.length < Ye) {
      const Ce = R({ sentTable: p, anchors: _, count: Ye - P.length, format: v, purpose: m });
      P = P.concat(Ce).slice(0, Ye);
    }
    return { items: P };
  }
  __name(z, "z");
  function R({ sentTable: g, anchors: x, count: m, format: v, purpose: w }) {
    const p = [], _ = x.slice(0, Math.max(m, 1));
    for (let q = 0; q < m; q++) {
      const V = _[q % _.length], Y = V.sid, P = V.quote;
      p.push({ id: `QF${q + 1}`, type: "short", question: w === "preview" ? `\uC694\uC57D\uC5D0\uC11C '${P}'\uAC00 \uC758\uBBF8\uD558\uB294 \uD575\uC2EC \uAC1C\uB150\uC744 \uD55C \uBB38\uC7A5\uC73C\uB85C \uB9D0\uD574\uBCF4\uC138\uC694.` : `\uC694\uC57D\uC5D0\uC11C '${P}'\uAC00 \uD3EC\uD568\uB41C \uBB38\uC7A5\uC758 \uD575\uC2EC \uC778\uACFC/\uAD00\uACC4\uB97C \uD55C \uBB38\uC7A5\uC73C\uB85C \uC778\uCD9C\uD574\uBCF4\uC138\uC694.`, choices: [], answer: "(\uC11C\uC220\uD615 \uC815\uB2F5: \uC0AC\uC6A9\uC790 \uC785\uB825 \uBE44\uAD50\uB294 \uD574\uC124 \uAE30\uBC18 \uCC44\uC810 \uB610\uB294 \uD0A4\uC6CC\uB4DC \uCC44\uC810\uC73C\uB85C \uCC98\uB9AC)", explanation: "\uADFC\uAC70 \uBB38\uC7A5\uC744 \uB2E4\uC2DC \uC77D\uACE0 \uD575\uC2EC\uC744 1\uBB38\uC7A5\uC73C\uB85C \uC7AC\uAD6C\uC131\uD558\uBA74 \uB429\uB2C8\uB2E4.", evidence: { sid: Y, quote: P }, anchorIds: [V.id] });
    }
    return p;
  }
  __name(R, "R");
  class b {
    constructor(x, { passScore: m = 90 } = {}) {
      this.items = Array.isArray(x) ? x : [], this.passScore = m, this.state = { idx: 0, attempts: 1, correct: 0, wrongIds: /* @__PURE__ */ new Set(), finished: false };
    }
    gradeAnswer(x, m) {
      if (!x)
      ...
      if (v === "mcq" || v === "blank" || v === "match" || v === "order" || v === "label" || v === "short") {
        ...
        const w = (x.answer || "").trim(), p = (m || "").trim();
    ...
    next() {
      if (this.state.idx += 1, this.state.attempts = 1, this.state.idx >= this.items.length)
        if (this.getScore() >= this.passScore)
          ...
          const m = this.items.filter((v) => this.state.wrongIds.has(v.id));
  ...
  __name(b, "b");
  async function N({ llmCall: g, originalText: x, mode: m, format: v, purpose: w }) {
    const p = await M({ llmCall: g, originalText: x, mode: m, format: v }), _ = await z({ llmCall: g, mode: m, purpose: w, format: v, summaryText: p.summaryText, sentTable: p.sentTable, anchors: p.anchors });
    return { summary: { mode: m, format: v, text: p.summaryText, sentences: p.sentTable, anchors: p.anchors }, selfTest: { purpose: w, passScore: 90, items: _.items } };
  }
  __name(N, "N");
  return { computeCharTargets: a, splitSentencesKR: o, makeSentenceTable: c, generateBundle: M, generateSelfTest: z, runPipeline: N, MasteryRunner: b };
})();
...
J.post("/api/gens/run", async (t) => {
  ...
  const r = D((n == null ? void 0 : n.text) || (n == null ? void 0 : n.originalText) || ""), s = Gt((n == null ? void 0 : n.mode) || "standard"), i = Ut((n == null ? void 0 : n.format) || (n == null ? void 0 : n.viewType) || "narrative"), a = D((n == null ? void 0 : n.purpose) || "preview").trim().toLowerCase();
  if (!r)
  ...
  const l = /* @__PURE__ */ __name(async ({ system: u, user: h, json: f }) => {
    if (f) {
      const y = `${u}
...
J.post("/api/engine", async (t) => {
  ...
  const s = Xn(r == null ? void 0 : r.kind), i = D((r == null ? void 0 : r.text) || ""), a = Gt((r == null ? void 0 : r.mode) || (r == null ? void 0 : r.level)), o = Ut((r == null ? void 0 : r.viewType) || (r == null ? void 0 : r.displayMode)), c = D(((z = r == null ? void 0 : r.options) == null ? void 0 : z.userId) || (r == null ? void 0 : r.userId) || "anon");
  if (!i.trim() || i.trim().length < 5)
    return t.json({ ok: false, error: { code: "NO_TEXT", message: "\uC785\uB825 \uD14D\uC2A4\uD2B8\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4." } }, 200);
  const l = pr(s, a, o, i, c || null), u = await xt(n, l);
  if (u.hit)
  ...
  const h = hr(s, a, i, c || null), f = await xt(n, h);
  if (f.hit && f.data) {
    let R;
    if (f.data.allSummaries && f.data.allSummaries[a] ? R = f.data.allSummaries[a] : f.data.narrative ? R = f.data.narrative : console.warn("[Cache] Base cache has no narrative, skipping"), R) {
      let b;
      return o === "narrative" ? b = { kind: s, mode: a, viewType: o, narrative: R } : o === "structured" ? b = { kind: s, mode: a, ...mr(R) } : o === "mindmap" ? b = { kind: s, mode: a, ...gr(R) } : b = { kind: s, mode: a, ...xr(R) }, await Ne(n, l, c || "anon", b), t.json({ ok: true, data: b, meta: { cached: true, cacheStore: "derived", cacheType: "converted", engine: "local-convert", elapsedMs: Date.now() - e } }, 200);
    }
  }
  const y = !!D(t.env.GEMINI_API_KEY).trim(), T = D(t.env.USE_MOCK).trim().toLowerCase() === "true";
  if (s === "summary" && y && !T)
    try {
      const R = await sr(t.env, i), b = Wn(a), N = Qn(o);
      let g;
      if (N === "structured")
        g = { kind: s, mode: a, viewType: o, ...R.structured[b] };
      else if (N === "mindmap")
        g = { kind: s, mode: a, viewType: o, ...R.mindmap[b] };
      else if (N === "selftest")
        g = { kind: s, mode: a, viewType: o, ...R.selftest[b] };
      else {
        const v = R.narrative[b];
        g = { kind: s, mode: a, viewType: o, title: v.title, narrative: v.summary, keyPoints: v.keyPoints, examHints: v.examHints };
      }
      const x = R.narrative[b], m = { kind: s, mode: a, viewType: "narrative", narrative: x.summary, allSummaries: { brief: R.narrative.brief.summary, standard: R.narrative.standard.summary, detail: R.narrative.detail.summary }, meta: { engine: "v4", hierarchy: "brief \u2282 standard \u2282 detail (server-downsample)", structuredFirst: true } };
      return await Ne(n, h, c || "anon", m), await Ne(n, l, c || "anon", g), t.json({ ok: true, data: g, meta: { cached: false, engine: "gemini-v4-structured-first", elapsedMs: Date.now() - e, hierarchy: "brief \u2282 standard \u2282 detail (guaranteed)" } }, 200);
    } catch (R) {
      console.error("[Gemini V4 Error]", R);
    }
  const O = tt(i, "brief", o), A = tt(i, "standard", o), M = tt(i, "detail", o), $ = a === "brief" ? O : a === "standard" ? A : M;
  if (await Ne(n, l, c || "anon", $), O.narrative && A.narrative && M.narrative) {
    const R = { kind: "summary", mode: a, viewType: "narrative", narrative: $.narrative, allSummaries: { brief: O.narrative, standard: A.narrative, detail: M.narrative } };
    await Ne(n, h, c || "anon", R);
  }
  return t.json({ ok: true, data: $, meta: { cached: false, engine: "local", elapsedMs: Date.now() - e } }, 200);
});
...
for (const [, t] of Object.entries(Er))
  t && (vt.route("/", t), vt.notFound(t.notFoundHandler), Vt = true);
if (!Vt)
...
// ../.wrangler/tmp/bundle-DI9wMD/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-DI9wMD/middleware-loader.entry.ts
...
//# sourceMappingURL=bundledWorker-0.11434656582707436.mjs.map
