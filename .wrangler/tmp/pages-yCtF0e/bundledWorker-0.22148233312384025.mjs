...
// ../.wrangler/tmp/bundle-fS0cEg/checked-fetch.js
...
// ../.wrangler/tmp/bundle-fS0cEg/strip-cf-connecting-ip-header.js
...
var Pt = /* @__PURE__ */ __name((t, e, r) => e in t ? _t(t, e, { enumerable: true, configurable: true, writable: true, value: r }) : t[e] = r, "Pt");
var g = /* @__PURE__ */ __name((t, e, r) => Pt(t, typeof e != "symbol" ? e + "" : e, r), "g");
var qe = /* @__PURE__ */ __name((t, e, r) => e.has(t) || Ge("Cannot " + r), "qe");
var l = /* @__PURE__ */ __name((t, e, r) => (qe(t, e, "read from private field"), r ? r.call(t) : e.get(t)), "l");
var m = /* @__PURE__ */ __name((t, e, r) => e.has(t) ? Ge("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, r), "m");
var p = /* @__PURE__ */ __name((t, e, r, s) => (qe(t, e, "write to private field"), s ? s.call(t, r) : e.set(t, r), r), "p");
var v = /* @__PURE__ */ __name((t, e, r) => (qe(t, e, "access private method"), r), "v");
var Ve = /* @__PURE__ */ __name((t, e, r, s) => ({ set _(n) {
  p(t, e, n, r);
}, get _() {
  return l(t, e, s);
} }), "Ve");
var Xe = /* @__PURE__ */ __name((t, e, r) => (s, n) => {
  let i = -1;
  return a(0);
  async function a(c) {
    if (c <= i)
...
var Ht = Symbol();
var kt = /* @__PURE__ */ __name(async (t, e = /* @__PURE__ */ Object.create(null)) => {
...
var Bt = /* @__PURE__ */ __name((t) => Ke(t, decodeURI), "Bt");
...
var ae = /* @__PURE__ */ __name((t, e, ...r) => (r.length && (e = ae(e, ...r)), `${(t == null ? void 0 : t[0]) === "/" ? "" : "/"}${t}${e === "/" ? "" : `${(t == null ? void 0 : t.at(-1)) === "/" ? "" : "/"}${(e == null ? void 0 : e[0]) === "/" ? e.slice(1) : e}`}`), "ae");
...
var Fe = /* @__PURE__ */ __name((t) => /[%+]/.test(t) ? (t.indexOf("+") !== -1 && (t = t.replace(/\+/g, " ")), t.indexOf("%") !== -1 ? Ke(t, ft) : t) : t, "Fe");
...
var Ut = ut;
var Kt = /* @__PURE__ */ __name((t, e) => ut(t, e, true), "Kt");
var ft = decodeURIComponent;
var Ye = /* @__PURE__ */ __name((t) => Ke(t, ft), "Ye");
var he;
var _;
var q;
var pt;
...
var B;
var rt;
var dt = (rt = /* @__PURE__ */ __name(class {
  constructor(t, e = "/", r = [[]]) {
    m(this, q);
    g(this, "raw");
    m(this, he);
...
}, "rt"), he = /* @__PURE__ */ new WeakMap(), _ = /* @__PURE__ */ new WeakMap(), q = /* @__PURE__ */ new WeakSet(), pt = /* @__PURE__ */ __name(function(t) {
  const e = l(this, _)[0][this.routeIndex][1][t], r = v(this, q, ze).call(this, e);
  return r && /\%/.test(r) ? Ye(r) : r;
}, "pt"), gt = /* @__PURE__ */ __name(function() {
  ...
  return t;
}, "gt"), ze = /* @__PURE__ */ __name(function(t) {
  return l(this, _)[1] ? l(this, _)[1][t] : t;
}, "ze"), B = /* @__PURE__ */ new WeakMap(), rt);
var Jt = { Stringify: 1 };
var mt = /* @__PURE__ */ __name(async (t, e, r, s, n) => {
...
var Le = /* @__PURE__ */ __name((t, e) => ({ "Content-Type": t, ...e }), "Le");
var be;
var je;
var I;
var ue;
...
var Gt = (st = /* @__PURE__ */ __name(class {
  constructor(t, e) {
    ...
    g(this, "html", (t2, e2, r) => {
      const s = /* @__PURE__ */ __name((n) => v(this, z, oe).call(this, n, e2, Le("text/html; charset=UTF-8", r)), "s");
...
var Pe;
var pe;
var Qt = (pe = /* @__PURE__ */ __name(class {
  constructor(e = {}) {
    m(this, j);
    g(this, "get");
    g(this, "post");
  ...
  route(e, r) {
    ...
    return r.routes.map((n) => {
      var a;
      let i;
      r.errorHandler === Ze ? i = n.handler : (i = /* @__PURE__ */ __name(async (c, h) => (await Xe([], r.errorHandler)(c, () => n.handler(c, h))).res, "i"), i[Yt] = n.handler), v(a = s, j, V).call(a, n.method, n.path, i);
    }), this;
  }
  basePath(e) {
  ...
  mount(e, r, s) {
    let n, i;
    s && (typeof s == "function" ? i = s : (i = s.optionHandler, s.replaceRequest === false ? n = /* @__PURE__ */ __name((h) => h, "n") : n = s.replaceRequest));
    const a = i ? (h) => {
      const o = i(h);
    ...
    const c = /* @__PURE__ */ __name(async (h, o) => {
...
}, "pe"), P = /* @__PURE__ */ new WeakMap(), j = /* @__PURE__ */ new WeakSet(), wt = /* @__PURE__ */ __name(function() {
...
}, "wt"), H = /* @__PURE__ */ new WeakMap(), V = /* @__PURE__ */ __name(function(e, r, s) {
...
}, "V"), _e = /* @__PURE__ */ __name(function(e, r) {
  if (e instanceof Error)
    return this.errorHandler(e, r);
  throw e;
}, "_e"), Pe = /* @__PURE__ */ __name(function(e, r, s, n) {
  if (n === "HEAD")
...
var k;
var re;
var sr = (re = /* @__PURE__ */ __name(class {
  constructor() {
    m(this, Z);
    m(this, Q);
...
var Oe;
var nt;
var nr = (nt = /* @__PURE__ */ __name(class {
  constructor() {
...
var St;
var it;
var cr = (it = /* @__PURE__ */ __name(class {
  constructor() {
    m(this, Ie);
...
}, "it"), U = /* @__PURE__ */ new WeakMap(), K = /* @__PURE__ */ new WeakMap(), Ie = /* @__PURE__ */ new WeakSet(), St = /* @__PURE__ */ __name(function(t) {
  const e = [];
  let r = t === b;
...
var D;
var at;
var lr = (at = /* @__PURE__ */ __name(class {
  constructor(t) {
...
var X;
var me;
var hr = (me = /* @__PURE__ */ __name(class {
  constructor(e, r, s) {
    m(this, M);
    m(this, W);
    m(this, A);
...
}, "me"), W = /* @__PURE__ */ new WeakMap(), A = /* @__PURE__ */ new WeakMap(), ee = /* @__PURE__ */ new WeakMap(), ge = /* @__PURE__ */ new WeakMap(), R = /* @__PURE__ */ new WeakMap(), M = /* @__PURE__ */ new WeakSet(), X = /* @__PURE__ */ __name(function(e, r, s, n) {
  const i = [];
...
var te;
var ot;
var ur = (ot = /* @__PURE__ */ __name(class {
  constructor() {
...
var bt = /* @__PURE__ */ __name(class extends Qt {
  constructor(t = {}) {
...
var yr = /* @__PURE__ */ __name(async (t, e) => {
  let r;
...
var Er = /* @__PURE__ */ __name((t) => async function(r, s) {
...
var Sr = /* @__PURE__ */ __name((t) => Er(t), "Sr");
var F = new bt();
F.use("/api/*", fr());
...
__name(Ar, "Ar");
function At(t, e) {
  const r = JSON.parse(JSON.stringify(t)), s = /* @__PURE__ */ __name((n) => {
...
// ../.wrangler/tmp/bundle-fS0cEg/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-fS0cEg/middleware-loader.entry.ts
...
//# sourceMappingURL=bundledWorker-0.22148233312384025.mjs.map
