...
// .wrangler/tmp/bundle-WFFQtg/checked-fetch.js
...
// .wrangler/tmp/bundle-WFFQtg/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/pages-Aqh7GN/bundledWorker-0.02518281944118672.mjs
...
var zt = /* @__PURE__ */ __name2((e, t, r) => t in e ? Gt(e, t, { enumerable: true, configurable: true, writable: true, value: r }) : e[t] = r, "zt");
var v = /* @__PURE__ */ __name2((e, t, r) => zt(e, typeof t != "symbol" ? t + "" : t, r), "v");
var Ye = /* @__PURE__ */ __name2((e, t, r) => t.has(e) || at("Cannot " + r), "Ye");
var d = /* @__PURE__ */ __name2((e, t, r) => (Ye(e, t, "read from private field"), r ? r.call(e) : t.get(e)), "d");
var S = /* @__PURE__ */ __name2((e, t, r) => t.has(e) ? at("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), "S");
...
var er = /* @__PURE__ */ __name2((e) => {
  const { groups: t, path: r } = tr(e), n = At(r);
  return rr(n, t);
}, "er");
...
var sr = /* @__PURE__ */ __name2((e) => rt(e, decodeURI), "sr");
...
var Xe = /* @__PURE__ */ __name2((e) => /[%+]/.test(e) ? (e.indexOf("+") !== -1 && (e = e.replace(/\+/g, " ")), e.indexOf("%") !== -1 ? rt(e, Tt) : e) : e, "Xe");
...
var ar = Ot;
var or = /* @__PURE__ */ __name2((e, t) => Ot(e, t, true), "or");
var Tt = decodeURIComponent;
var lt = /* @__PURE__ */ __name2((e) => rt(e, Tt), "lt");
var ge;
var _;
var G;
var Rt;
...
var z;
var vt;
var Ct = (vt = /* @__PURE__ */ __name2(class {
  constructor(e, t = "/", r = [[]]) {
    S(this, G);
    v(this, "raw");
    S(this, ge);
    ...
    this.raw = e, this.path = t, y(this, _, r), y(this, ge, {});
  }
  param(e) {
    return e ? E(this, G, Rt).call(this, e) : E(this, G, Mt).call(this);
  }
  query(e) {
  ...
  json() {
    return d(this, z).call(this, "text").then((e) => JSON.parse(e));
  }
  text() {
    return d(this, z).call(this, "text");
  }
  arrayBuffer() {
    return d(this, z).call(this, "arrayBuffer");
  }
  blob() {
    return d(this, z).call(this, "blob");
  }
  formData() {
    return d(this, z).call(this, "formData");
  }
  ...
  get matchedRoutes() {
    return d(this, _)[0].map(([[, e]]) => e);
  }
  get routePath() {
    return d(this, _)[0].map(([[, e]]) => e)[this.routeIndex].path;
  }
}, "vt"), ge = /* @__PURE__ */ new WeakMap(), _ = /* @__PURE__ */ new WeakMap(), G = /* @__PURE__ */ new WeakSet(), Rt = /* @__PURE__ */ __name2(function(e) {
  const t = d(this, _)[0][this.routeIndex][1][e], r = E(this, G, et).call(this, t);
  return r && /\%/.test(r) ? lt(r) : r;
}, "Rt"), Mt = /* @__PURE__ */ __name2(function() {
  const e = {}, t = Object.keys(d(this, _)[0][this.routeIndex][1]);
  for (const r of t) {
    const n = E(this, G, et).call(this, d(this, _)[0][this.routeIndex][1][r]);
    n !== void 0 && (e[r] = /\%/.test(n) ? lt(n) : n);
  }
  return e;
}, "Mt"), et = /* @__PURE__ */ __name2(function(e) {
  return d(this, _)[1] ? d(this, _)[1][e] : e;
...
var he;
var wt;
var ur = (wt = /* @__PURE__ */ __name2(class {
  constructor(e, t) {
    S(this, U);
    S(this, Re);
    S(this, Me);
    ...
    v(this, "newResponse", (...e2) => E(this, U, he).call(this, ...e2));
    v(this, "body", (e2, t2, r) => E(this, U, he).call(this, e2, t2, r));
    v(this, "text", (e2, t2, r) => !d(this, ne) && !d(this, xe) && !t2 && !r && !this.finalized ? new Response(e2) : E(this, U, he).call(this, e2, t2, Qe(lr, r)));
    v(this, "json", (e2, t2, r) => E(this, U, he).call(this, JSON.stringify(e2), t2, Qe("application/json", r)));
    v(this, "html", (e2, t2, r) => {
      const n = /* @__PURE__ */ __name2((s) => E(this, U, he).call(this, s, t2, Qe("text/html; charset=UTF-8", r)), "n");
    ...
    y(this, Re, e), t && (y(this, V, t.executionCtx), this.env = t.env, y(this, ve, t.notFoundHandler), y(this, _e, t.path), y(this, Pe, t.matchResult));
  }
  get req() {
    return d(this, Me) ?? y(this, Me, new Ct(d(this, Re), d(this, _e), d(this, Pe))), d(this, Me);
  }
  get event() {
...
}, "wt"), Re = /* @__PURE__ */ new WeakMap(), Me = /* @__PURE__ */ new WeakMap(), K = /* @__PURE__ */ new WeakMap(), xe = /* @__PURE__ */ new WeakMap(), V = /* @__PURE__ */ new WeakMap(), R = /* @__PURE__ */ new WeakMap(), Ie = /* @__PURE__ */ new WeakMap(), ye = /* @__PURE__ */ new WeakMap(), ve = /* @__PURE__ */ new WeakMap(), ne = /* @__PURE__ */ new WeakMap(), Pe = /* @__PURE__ */ new WeakMap(), _e = /* @__PURE__ */ new WeakMap(), U = /* @__PURE__ */ new WeakSet(), he = /* @__PURE__ */ __name2(function(e, t, r) {
...
var _t = /* @__PURE__ */ __name2(class extends Error {
}, "_t");
...
var qe;
var we;
var mr = (we = /* @__PURE__ */ __name2(class {
  constructor(t = {}) {
    S(this, $);
    v(this, "get");
    v(this, "post");
    ...
    const { strict: n, ...s } = t;
    Object.assign(this, s), this.getPath = n ?? true ? t.getPath ?? $t : ir;
  }
  route(t, r) {
    ...
    return r.routes.map((s) => {
      var a;
      let i;
      r.errorHandler === ut ? i = s.handler : (i = /* @__PURE__ */ __name2(async (c, l) => (await ct([], r.errorHandler)(c, () => s.handler(c, l))).res, "i"), i[fr] = s.handler), E(a = n, $, te).call(a, s.method, s.path, i);
    }), this;
  }
  basePath(t) {
    const r = E(this, $, Nt).call(this);
...
}, "we"), N = /* @__PURE__ */ new WeakMap(), $ = /* @__PURE__ */ new WeakSet(), Nt = /* @__PURE__ */ __name2(function() {
...
}, "Nt"), D = /* @__PURE__ */ new WeakMap(), te = /* @__PURE__ */ __name2(function(t, r, n) {
  ...
  const i = this.getPath(t, { env: n }), a = this.router.match(s, i), c = new ur(t, { path: i, matchResult: a, env: n, executionCtx: r, notFoundHandler: d(this, D) });
  if (a[0].length === 1) {
    let o;
    try {
      o = a[0][0][0][0](c, async () => {
  ...
  const l = ct(a[0], this.errorHandler, d(this, D));
  return (async () => {
    try {
      const o = await l(c);
      if (!o.finalized)
...
var xr = new Set(".\\+*[^]$()");
function yr(e, t) {
  return e.length === 1 ? t.length === 1 ? e < t ? -1 : 1 : -1 : t.length === 1 || e === $e || e === ke ? 1 : t === $e || t === ke ? -1 : e === Ge ? 1 : t === Ge ? -1 : e.length === t.length ? e < t ? -1 : 1 : t.length - e.length;
}
__name(yr, "yr");
__name2(yr, "yr");
var se;
...
var H;
var ce;
var vr = (ce = /* @__PURE__ */ __name2(class {
  constructor() {
    S(this, se);
    S(this, ie);
  ...
  insert(t, r, n, s, i) {
    ...
    const [a, ...c] = t, l = a === "*" ? c.length === 0 ? ["", "", $e] : ["", "", Ge] : a === "/*" ? ["", "", ke] : a.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);
    let o;
    if (l) {
      const u = l[1];
      let h = l[2] || Ge;
      if (u && l[2] && (h === ".*" || (h = h.replace(/^\((?!\?:)(?=[^)]+\)$)/, "(?:"), /\((?!\?:)/.test(h))))
        throw fe;
      if (o = d(this, H)[h], !o) {
        if (Object.keys(d(this, H)).some((f) => f !== $e && f !== ke))
          throw fe;
        if (i)
          return;
      ...
      if (Object.keys(d(this, H)).some((u) => u.length > 1 && u !== $e && u !== ke))
        throw fe;
      if (i)
        return;
      o = d(this, H)[a] = new ce();
  ...
  buildRegExpStr() {
    const r = Object.keys(d(this, H)).sort(yr).map((n) => {
      const s = d(this, H)[n];
      return (typeof d(s, ie) == "number" ? `(${n})@${d(s, ie)}` : xr.has(n) ? `\\${n}` : n) + s.buildRegExpStr();
    });
...
var Ne;
var bt;
var wr = (bt = /* @__PURE__ */ __name2(class {
  constructor() {
  ...
  insert(e, t, r) {
    ...
    return d(this, Ne).insert(i, t, n, d(this, ze), r), n;
  }
  buildRegExp() {
...
function Er(e) {
  ...
  if (e.length === 0)
    return br;
  const n = e.map((u) => [!/\*|\/:/.test(u[0]), ...u]).sort(([u, h], [f, m]) => u ? 1 : f ? -1 : h.length - m.length), s = /* @__PURE__ */ Object.create(null);
  for (let u = 0, h = -1, f = n.length; u < f; u++) {
    const [m, p, b] = n[u];
    m ? s[p] = [b.map(([w]) => [w, /* @__PURE__ */ Object.create(null)]), Dt] : h++;
    let g;
    try {
      g = t.insert(p, h, m);
    } catch (w) {
      throw w === fe ? new _t(p) : w;
    }
    m || (r[h] = b.map(([w, x]) => {
...
var Lt;
var St;
var jr = (St = /* @__PURE__ */ __name2(class {
  constructor() {
    S(this, Ue);
  ...
  buildAllMatchers() {
    ...
    }), y(this, W, y(this, Y, void 0)), Sr(), e;
  }
}, "St"), W = /* @__PURE__ */ new WeakMap(), Y = /* @__PURE__ */ new WeakMap(), Ue = /* @__PURE__ */ new WeakSet(), Lt = /* @__PURE__ */ __name2(function(e) {
  const t = [];
  let r = e === A;
...
var Ar = (Et = /* @__PURE__ */ __name2(class {
  ...
  match(e, t) {
    ...
    const r = d(this, X), n = d(this, J), s = r.length;
    let i = 0, a;
    for (; i < s; i++) {
      const c = r[i];
      try {
      ...
      this.match = c.match.bind(c), y(this, X, [c]), y(this, J, void 0);
      break;
    }
    if (i === s)
      throw new Error("Fatal error");
  ...
  get activeRouter() {
    if (d(this, J) || d(this, X).length !== 1)
      throw new Error("No active router has been determined yet.");
    return d(this, X)[0];
  }
}, "Et"), X = /* @__PURE__ */ new WeakMap(), J = /* @__PURE__ */ new WeakMap(), Et);
...
var re;
var Se;
var $r = (Se = /* @__PURE__ */ __name2(class {
  constructor(t, r, n) {
    S(this, B);
    S(this, Q);
    S(this, T);
  ...
  insert(t, r, n) {
    y(this, be, ++ot(this, be)._);
    let s = this;
    const i = er(r), a = [];
    for (let c = 0, l = i.length; c < l; c++) {
      const o = i[c], u = i[c + 1], h = nr(o, u), f = Array.isArray(h) ? h[0] : o;
      if (f in d(s, T)) {
  ...
  search(t, r) {
    ...
    for (let o = 0, u = a.length; o < u; o++) {
      const h = a[o], f = o === u - 1, m = [];
      for (let p = 0, b = i.length; p < b; p++) {
        const g = i[p], w = d(g, T)[h];
        w && (y(w, O, d(g, O)), f ? (d(w, T)["*"] && n.push(...E(this, B, re).call(this, d(w, T)["*"], t, d(g, O))), n.push(...E(this, B, re).call(this, w, t, d(g, O)))) : m.push(w));
        for (let x = 0, k = d(g, ae).length; x < k; x++) {
          const P = d(g, ae)[x], j = d(g, O) === je ? {} : { ...d(g, O) };
          if (P === "*") {
            const L = d(g, T)["*"];
            L && (n.push(...E(this, B, re).call(this, L, t, d(g, O))), y(L, O, j), m.push(L));
            continue;
          }
          const [F, M, I] = P;
          if (!h && !(I instanceof RegExp))
            continue;
          const C = d(g, T)[F], Z = a.slice(o).join("/");
          if (I instanceof RegExp) {
            const L = I.exec(Z);
            if (L) {
              if (j[M] = L[0], n.push(...E(this, B, re).call(this, C, t, d(g, O), j)), Object.keys(d(C, T)).length) {
                y(C, O, j);
          ...
          (I === true || I.test(h)) && (j[M] = h, f ? (n.push(...E(this, B, re).call(this, C, t, j, d(g, O))), d(C, T)["*"] && n.push(...E(this, B, re).call(this, d(C, T)["*"], t, j, d(g, O)))) : (y(C, O, j), m.push(C)));
        }
      }
      i = m.concat(c.shift() ?? []);
    }
...
}, "Se"), Q = /* @__PURE__ */ new WeakMap(), T = /* @__PURE__ */ new WeakMap(), ae = /* @__PURE__ */ new WeakMap(), be = /* @__PURE__ */ new WeakMap(), O = /* @__PURE__ */ new WeakMap(), B = /* @__PURE__ */ new WeakSet(), re = /* @__PURE__ */ __name2(function(t, r, n, s) {
  const i = [];
  for (let a = 0, c = d(t, Q).length; a < c; a++) {
    ...
    if (o !== void 0 && (o.params = /* @__PURE__ */ Object.create(null), i.push(o), n !== je || s && s !== je))
      for (let h = 0, f = o.possibleKeys.length; h < f; h++) {
        const m = o.possibleKeys[h], p = u[o.score];
...
var qt = /* @__PURE__ */ __name2(class extends mr {
  constructor(e = {}) {
    super(e), this.router = e.router ?? new Ar({ routers: [new jr(), new kr()] });
  }
}, "qt");
...
var dt = /* @__PURE__ */ __name2((e, t = Rr) => {
...
var _r = /* @__PURE__ */ __name2((e) => {
  ...
  return async (s, i) => {
    ...
    if (o) {
      const p = e.mimes && dt(c, e.mimes) || dt(c);
      if (s.header("Content-Type", p || "application/octet-stream"), e.precompressed && (!p || Tr.test(p))) {
        const b = new Set((h = s.req.header("Accept-Encoding")) == null ? void 0 : h.split(",").map((g) => g.trim()));
        for (const g of Ir) {
          if (!b.has(g))
            continue;
          const w = await l(c + Ft[g], s);
          if (w) {
...
var Nr = /* @__PURE__ */ __name2(async (e, t) => {
  let r;
...
var Dr = /* @__PURE__ */ __name2((e) => async function(r, n) {
...
var Hr = /* @__PURE__ */ __name2((e) => Dr(e), "Hr");
...
__name2(Ee, "Ee");
function Ke(e, t) {
  const r = De(e), n = Kt(e), s = Ee(e), i = Ae(e), { min: a, max: c } = Lr[t], l = Math.floor(i * a), o = Math.floor(i * c), u = r[0] ? `${r[0].split("\uBA70")[0]}\uBA70, \uC774\uB294 \uD575\uC2EC \uD2B9\uC9D5\uC774\uB2E4` : "\uD575\uC2EC \uC8FC\uC7A5\uC744 \uC0DD\uC131\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4", h = [];
  for (n.length >= 2 && h.push(`\uC8FC\uC694 \uC218\uCE58\uB85C ${n[0]}\uC640 ${n[1]}\uC774 \uC911\uC694\uD55C \uAE30\uC900\uC810\uC774 \uB41C\uB2E4`), n.length >= 3 && h.push(`\uB610\uD55C ${n[2]}\uB3C4 \uD568\uAED8 \uACE0\uB824\uD574\uC57C \uD558\uBA70, \uC774\uB294 \uC804\uCCB4 \uB9E5\uB77D\uC744 \uC774\uD574\uD558\uB294 \uB370 \uD544\uC218\uC801\uC774\uB2E4`), r.length >= 2 && h.length < 2 && h.push(r[1].slice(0, 80) + "\uB294 \uC810\uC5D0\uC11C \uC911\uC694\uD55C \uADFC\uAC70\uAC00 \uB41C\uB2E4"); h.length < 3; )
    h.push(`${h.length + 1}\uCC28 \uBD84\uC11D\uC73C\uB85C \uAD00\uB828 \uB9E5\uB77D\uACFC \uBC30\uACBD\uC744 \uC885\uD569\uD558\uBA74 \uCD94\uAC00 \uADFC\uAC70\uAC00 \uD655\uC778\uB41C\uB2E4`);
  const f = n.length >= 4 ? `\uAD6C\uCCB4\uC801\uC73C\uB85C ${n[0]}\uC640 ${n[2]}\uB97C \uBE44\uAD50\uD558\uBA74 \uC57D ${Math.abs(parseFloat(n[0]) - parseFloat(n[2])).toFixed(1)}\uBC30 \uC218\uC900\uC774 \uCC28\uC774\uAC00 \uB098\uD0C0\uB098\uBA70, \uC774\uB294 \uB450 \uB300\uC0C1 \uAC04 \uAD6C\uC870\uC801 \uACA9\uCC28\uB97C \uBCF4\uC5EC\uC900\uB2E4` : "\uBE44\uAD50 \uB300\uC0C1 \uAC04 \uAD6C\uC870\uC801 \uCC28\uC774\uAC00 \uC5EC\uB7EC \uCE21\uBA74\uC5D0\uC11C \uD655\uC778\uB418\uBA70, \uD2B9\uD788 \uC811\uADFC \uBC29\uC2DD\uACFC \uC2E4\uD589 \uC804\uB7B5\uC5D0\uC11C \uB300\uC870\uB97C \uC774\uB8EC\uB2E4", m = s.some((g) => g.includes("\uAD50\uC721")) && s.some((g) => g.includes("\uBD80\uB2F4")) ? "\uC774\uB7EC\uD55C \uBD84\uC11D \uACB0\uACFC\uB294 \uAD50\uC721 \uC7AC\uC815 \uAD6C\uC870\uC640 \uC815\uCC45 \uBC29\uD5A5\uC774 \uBCF8\uC9C8\uC801 \uCC28\uC774\uB97C \uC2DC\uC0AC\uD558\uBA70, \uD5A5\uD6C4 \uAC1C\uC120 \uBC29\uD5A5\uC744 \uBAA8\uC0C9\uD558\uB294 \uB370 \uC911\uC694\uD55C \uC2DC\uC0AC\uC810\uC744 \uC81C\uACF5\uD55C\uB2E4" : "\uC774\uC0C1 \uB0B4\uC6A9\uC744 \uC885\uD569\uD558\uBA74 \uAD6D\uAC00\uBCC4 \uC815\uCC45\uACFC \uC81C\uB3C4\uAC00 \uCC28\uC774\uB97C \uACB0\uACFC\uC5D0 \uBC18\uC601\uB41C \uAC83\uC73C\uB85C \uD574\uC11D\uB418\uBA70, \uC774\uB294 \uD5A5\uD6C4 \uC815\uCC45 \uC218\uB9BD \uC2DC \uCC38\uACE0\uD560 \uB9CC\uD55C \uC911\uC694\uD55C \uC0AC\uB840\uAC00 \uB41C\uB2E4";
  let p = "";
  t === "brief" ? p = `${u}. ${f}.` : t === "standard" ? p = `${u}. ${h[0] || ""}. ${f}.` : p = `${u}. ${h.join(". ")}. ${f}. ${m}.`;
  let b = Ae(p);
  if (b > o) {
    const g = p.split(/\n\n/).filter(Boolean);
    let w = "";
...
` : "") + x;
    ...
    p = w || p.slice(0, o) + "...", b = Ae(p);
  }
  if (b < l && t !== "brief") {
    const g = `\uC6D0\uBB38\uC5D0\uC11C\uB294 ${s.slice(0, 3).join(", ")} \uAC19\uC740 \uC8FC\uC694 \uAC1C\uB150\uC744 \uB2E4\uB8E8\uACE0 \uC788\uB2E4.`;
    p += " " + g, b = Ae(p);
  }
  return { type: "narrative", level: t, text: p, charCount: b, ratio: b / i, targetRange: { min: l, max: o }, note: "Matrix V4 \uD638\uD658", coreClaim: u, grounds: h, comparisons: [f], implications: [m] };
}
__name(Ke, "Ke");
__name2(Ke, "Ke");
function Ve(e, t) {
...
function Kr(e, t) {
  ...
  for (let c = 0; c < s && c < a.length; c++) {
    const l = a[c], o = Vr(l), u = n.find((h) => h.includes(l)) || `${l}\uC5D0 \uB300\uD55C \uC124\uBA85`;
...
__name2(ht, "ht");
function Jr(e) {
  const t = Ke(e, "detail"), r = Be(e, "detail"), n = Ve(e, "detail"), s = Je(t.text, "detail", "exam"), i = e.length, a = Vt(e), c = t.coreClaim, l = t.grounds, o = t.comparisons || [], u = t.implications || [];
  let h = t.text;
  if (!h.includes(`

`)) {
    const w = h.split(". ").filter(Boolean), x = Math.ceil(w.length / 2);
    h = w.slice(0, x).join(". ") + `.

` + w.slice(x).join(". ") + ".";
  }
  const f = r.toc, m = r.hierarchy, p = r.glossary, b = { title: n.title, children: n.children.map((w) => ({ title: w.title, children: (w.children || []).map((x) => ({ title: x.title, pack: Array.isArray(x.pack) && x.pack.length >= 2 ? x.pack : [x.title, `${x.title} \uAD00\uB828 \uB0B4\uC6A9`], explain: x.explain && x.explain.length >= 30 ? x.explain : `${x.title}\uB294 \uBCF8\uBB38\uC758 \uD575\uC2EC \uAC1C\uB150\uC73C\uB85C, \uC804\uCCB4 \uB9E5\uB77D\uC744 \uC774\uD574\uD558\uB294 \uB370 \uC911\uC694\uD55C \uC5ED\uD560\uC744 \uD558\uBA70, \uAD00\uB828\uB41C \uC138\uBD80 \uC0AC\uD56D\uACFC \uBE44\uAD50 \uB300\uC870\uB97C \uD1B5\uD574 \uC758\uBBF8\uB97C \uD30C\uC545\uD560 \uC218 \uC788\uB2E4.`, children: [] })) })) };
  ...
  return { schemaVersion: "ms-v4", lang: "ko", source: { charCount: i, checksum: a }, narrative: { coreClaim: c, grounds: l, comparisons: o, implications: u, summaryDetail: h }, structured: { toc: f, hierarchy: m, glossary: p }, mindmap: b, selftest: g };
}
__name(Jr, "Jr");
__name2(Jr, "Jr");
function ft(e) {
...
function Gr(e) {
  ...
  const i = /* @__PURE__ */ __name2((m) => {
    let p = 0;
    for (const b of (m == null ? void 0 : m.children) || [])
      p += ((b == null ? void 0 : b.children) || []).length;
    return p;
...
function zr(e) {
  e.post("/api/matrix", async (t) => {
    ...
    try {
      ...
      let l = null;
      if (c)
        console.log("[Matrix V4] Phase 1: \uB85C\uCEEC Fallback \uBAA8\uB4DC \uC0AC\uC6A9"), l = Jr(i);
      else {
        const L = ft(i);
        let ee = await pt(t, L);
        if (l = ht(ee), !l) {
...
`);
      ...
      const u = Ke(i, "brief"), h = Ke(i, "standard"), f = Ke(i, "detail"), m = Be(i, "brief"), p = Be(i, "standard"), b = Be(i, "detail"), g = Ve(i, "brief"), w = Ve(i, "standard"), x = Ve(i, "detail"), k = Je(i, "brief", "preview"), P = Je(i, "standard", "preview"), j = Je(i, "detail", "preview"), F = { narrative: { text: u.text, coreClaim: u.coreClaim, grounds: u.grounds, comparisons: u.comparisons, implications: u.implications }, structured: m, mindmap: g, selftest: k }, M = { narrative: { text: h.text, coreClaim: h.coreClaim, grounds: h.grounds, comparisons: h.comparisons, implications: h.implications }, structured: p, mindmap: w, selftest: P }, I = { narrative: { text: f.text, coreClaim: f.coreClaim, grounds: f.grounds, comparisons: f.comparisons, implications: f.implications }, structured: b, mindmap: x, selftest: j }, C = Gr({ brief: F, standard: M, detail: I });
      if (C.length && c === false)
        return t.json({ ok: false, error: { code: "LEVEL_SEPARATION_FAIL", message: C.join(" | ") }, meta: { reqId: n, elapsedMs: Date.now() - r } }, 422);
      const Z = { ok: true, data: { schemaVersion: "ms-v4", levels: { brief: F, standard: M, detail: I }, views: { narrative: { brief: F.narrative, standard: M.narrative, detail: I.narrative }, structured: { brief: F.structured, standard: M.structured, detail: I.structured }, mindmap: { brief: F.mindmap, standard: M.mindmap, detail: I.mindmap }, selftest: { brief: F.selftest, standard: M.selftest, detail: I.selftest } } }, meta: { requestId: n, elapsedMs: Date.now() - r, promptVersion: "matrix-v4-detail+downsample", checksum: a } };
      return t.json(Z, 200);
    } catch (s) {
...
__name2(Xr, "Xr");
function Qr(e) {
  const t = String((e == null ? void 0 : e.text) || "").trim(), r = Yr((e == null ? void 0 : e.viewType) || "narrative"), n = Wr(e == null ? void 0 : e.level), s = "detail", { base: i, min: a, max: c } = Xr(t), l = String((e == null ? void 0 : e.grade) || "general").toLowerCase(), o = String((e == null ? void 0 : e.subject) || "general").toLowerCase(), h = ["\uB2F9\uC2E0\uC740 \uD559\uC2B5 \uCF58\uD150\uCE20\uB97C \uCC38\uACE0\uC11C/\uAD50\uACFC\uC11C \uC218\uC900\uC73C\uB85C \uC7AC\uAD6C\uC131\uD558\uB294 \uC9C0\uC2DD \uAD6C\uC870\uD654 \uC5D4\uC9C4\uC785\uB2C8\uB2E4.", `
[\uAD6C\uC870\uD654 \uD575\uC2EC \uC9C0\uCE68(\uAC15\uC81C)]
- \uD559\uC2B5 \uB2E8\uC704(Learning Unit):
...
`.trim();
  let g = f;
  return r === "structured" ? g = m : r === "mindmap" ? g = p : r === "selftest" && (g = b), `${h}
...
function tn(e) {
  ...
  return t.forEach((s, i) => {
    ...
    for (const x of l)
      (x.match(/[가-힣A-Za-z·/()]{2,20}/g) || []).slice(0, 8).forEach((P) => {
        const j = P.replace(/[()]/g, "").trim();
        j.length >= 2 && j.length <= 12 && !/^(그리고|하지만|또한|이와|이에|우선|한편)$/.test(j) && o.push(j);
      });
    const u = /* @__PURE__ */ new Map();
    o.forEach((x) => u.set(x, (u.get(x) || 0) + 1));
    const h = Array.from(u.entries()).sort((x, k) => k[1] - x[1]).map((x) => x[0]).filter((x) => x.length <= 10).slice(0, 3), f = pe(s.body, 3).join(" "), m = pe(s.body, 2).join(" "), p = pe(s.body, 1).join(" "), b = { id: Ze(a + "_kw", 1), title: "\uD575\uC2EC \uAC1C\uB150", type: "keyword", collapsed: false, pack: h, explain: f, explainStandard: m, explainBrief: p, children: [] };
    h.forEach((x) => {
      n.has(x) || n.set(x, `\uBCF8\uBB38 \uB9E5\uB77D\uC5D0\uC11C "${x}"\uC758 \uD575\uC2EC \uC758\uBBF8\uB97C \uC694\uC57D\uD558\uBA74, ${pe(s.body, 1)[0] || "\uAD00\uB828 \uB0B4\uC6A9\uC758 \uD575\uC2EC \uAC1C\uB150\uC774\uB2E4."}`);
    });
    const w = We(s.body).filter((x) => /(\d{4}|%|가산점|전형|평가|프로그램|운영)/.test(x)).slice(0, 2);
...
function rn(e, t, r, n) {
  const s = (t.children || []).map((u) => u.title), a = (Jt(t, n).children || []).map((u) => {
    const h = (u.children || []).find((m) => m.type === "keyword"), f = Array.isArray(h == null ? void 0 : h.pack) ? h.pack : typeof (h == null ? void 0 : h.pack) == "string" ? [h.pack] : [];
    return { title: u.title, key: f.slice(0, 3), summary: (h == null ? void 0 : h.explain) || "" };
  }), c = n === "brief" ? 4 : n === "standard" ? 6 : 10, l = r.slice(0, c).map((u) => ({ term: u.term, def: Te(e, u.def, n) })), o = [];
  return o.push("\u2160. \uBAA9\uCC28"), s.forEach((u, h) => o.push(`  ${h + 1}. ${u}`)), o.push(""), o.push("\u2161. \uD575\uC2EC \uC815\uB9AC(\uC704\uACC4)"), a.forEach((u, h) => {
    var f;
    o.push(`  ${h + 1}. ${u.title}`), (f = u.key) != null && f.length && o.push(`     - \uD575\uC2EC\uD0A4\uC6CC\uB4DC: ${u.key.join(" \xB7 ")}`), u.summary && o.push(`     - \uC694\uC9C0: ${Te(e, u.summary, n)}`), o.push("");
...
function an(e, t) {
  ...
  for (const a of e) {
    ...
    const f = h >= 2 || c.length >= 30, m = f ? 1 : h === 1 ? 0.5 : 0;
    n += m, s.push({ id: a.id, ok: f, score: m, hit: h });
  }
...
__name2(an, "an");
function gt(e) {
  const t = le(e), { tree: r, glossary: n } = tn(t), s = { originalMeta: { textHash: nt(t), chars: t.length, ts: Oe() }, modes: {} };
  return ["detail", "standard", "brief"].forEach((i) => {
    const a = nn(t, i), c = rn(t, r, n, i), l = Jt(r, i), o = sn(t), h = mt(t, a, i).ok ? a : Te(t, a, i), f = c.renderText || "", m = mt(t, f, i);
    c.renderText = m.ok ? f : Te(t, f, i), s.modes[i] = { narrative: h, structured: c, mindmap: { tree: l }, selftest: o };
  }), s;
}
__name(gt, "gt");
__name2(gt, "gt");
q.get("/api/health", async (e) => {
  ...
  return e.json({ ok: true, ts: Oe(), hasDB: t, hasGeminiKey: r, engineMode: r ? "llm" : "local-only" });
});
q.post("/api/engine", async (e) => {
  ...
  if (c && e.env.GEMINI_API_KEY)
    try {
      const P = Qr({ text: l, viewType: s, level: "detail", grade: i, subject: a }), j = e.env.GEMINI_MODEL || "gemini-2.0-flash-exp", M = await (await fetch(`https://generativelanguage.googleapis.com/v1beta/models/${j}:generateContent?key=${e.env.GEMINI_API_KEY}`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ contents: [{ parts: [{ text: P }] }], generationConfig: { temperature: 0.7, maxOutputTokens: 8192 } }) })).json(), C = (((w = (g = (b = (p = (m = M == null ? void 0 : M.candidates) == null ? void 0 : m[0]) == null ? void 0 : p.content) == null ? void 0 : b.parts) == null ? void 0 : g[0]) == null ? void 0 : w.text) || "").match(/\{[\s\S]*\}/);
      if (C) {
        const Z = JSON.parse(C[0]);
        u = { originalMeta: { textHash: nt(l), chars: l.length, ts: Oe() }, modes: { detail: { [s]: Z }, standard: { [s]: Z }, brief: { [s]: Z } } }, o = "gemini-" + j;
      } else
        throw new Error("Gemini \uC751\uB2F5\uC744 JSON\uC73C\uB85C \uD30C\uC2F1\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.");
    } catch (P) {
      console.error("[Gemini Error]", P), u = gt(l), o = "v5-local-fallback";
    }
  else
    u = gt(l);
  const h = (k = (x = u.modes) == null ? void 0 : x[n]) == null ? void 0 : k[s], f = { engine: o, mode: n, viewType: s, ts: Oe(), textHash: u.originalMeta.textHash, grade: i, subject: a };
...
q.post("/api/saveSummary", async (e) => {
  ...
  const a = String((r == null ? void 0 : r.id) || `s_${Date.now()}_${Math.random().toString(36).slice(2, 8)}`), c = Oe(), l = nt(s), o = JSON.stringify(i);
...
for (const [, e] of Object.entries(on))
  e && (xt.route("/", e), xt.notFound(e.notFoundHandler), Bt = true);
if (!Bt)
...
function un(e, t, r) {
  ...
  const n = Ce(t), s = 100;
  if (!n) {
    const x = r === 1 ? e.hint1 || "\uD78C\uD2B8: \uBCF8\uBB38/\uC694\uC57D\uC5D0\uC11C \uAD00\uB828 \uBB38\uC7A5\uC744 \uCC3E\uC544\uBCF4\uC138\uC694." : r === 2 ? e.hint2 || "\uD78C\uD2B8: \uD575\uC2EC \uC218\uCE58/\uB300\uC870 \uD45C\uD604\uC744 \uC911\uC2EC\uC73C\uB85C \uB2E4\uC2DC \uD655\uC778\uD558\uC138\uC694." : void 0, k = r >= 3 ? e.explanation || e.answerKey || "\uD574\uC124: \uC694\uC57D\uC758 \uD575\uC2EC \uADFC\uAC70\uB97C \uCC38\uACE0\uD558\uC138\uC694." : void 0;
    return { id: e.id, score: 0, maxScore: s, correct: false, feedback: "\uBBF8\uC751\uB2F5", nextAction: "retry", hintToShow: x, explanationToShow: k };
  }
  const i = ((p = e.rubric) == null ? void 0 : p.mustIncludeAny) || [], a = ((b = e.rubric) == null ? void 0 : b.mustIncludeAll) || [], c = ((g = e.rubric) == null ? void 0 : g.forbid) || [], l = (w = e.rubric) == null ? void 0 : w.maxChars;
  let o = 100, u = [];
  ...
  const h = o >= 90, f = !h && r === 1 ? e.hint1 || "\uD78C\uD2B8: \uC694\uC57D\uC5D0\uC11C \uD575\uC2EC \uC8FC\uC7A5/\uADFC\uAC70\uB97C \uCC3E\uC544 \uB2E8\uC5B4\uB85C \uBA3C\uC800 \uC801\uC5B4\uBCF4\uC138\uC694." : !h && r === 2 ? e.hint2 || "\uD78C\uD2B8: \uC218\uCE58\xB7\uB300\uC870(\uBC18\uBA74/\uBE44\uD574)\xB7\uACB0\uB860 \uBB38\uC7A5\uC744 \uC911\uC2EC\uC73C\uB85C \uB2E4\uC2DC \uAD6C\uC131\uD558\uC138\uC694." : void 0, m = !h && r >= 3 ? e.explanation || e.answerKey || "\uD574\uC124: \uC694\uC57D\uC758 \uD575\uC2EC \uADFC\uAC70\uC640 \uBE44\uAD50 \uD3EC\uC778\uD2B8\uB97C \uBC18\uC601\uD574\uC57C \uD569\uB2C8\uB2E4." : void 0;
  return { id: e.id, score: o, maxScore: s, correct: h, feedback: u.length ? u.join(" / ") : "\uCDA9\uBD84\uD788 \uC815\uD655\uD569\uB2C8\uB2E4.", nextAction: h ? "pass" : "retry", hintToShow: f, explanationToShow: m };
}
__name(un, "un");
__name2(un, "un");
function dn(e, t) {
...
__name(dn, "dn");
__name2(dn, "dn");
var hn = Object.freeze(Object.defineProperty({ __proto__: null, gradeSelftestAttempt: dn }, Symbol.toStringTag, { value: "Module" }));
...
// .wrangler/tmp/pages-Aqh7GN/hxnbtb0quyb.js
...
// .wrangler/tmp/bundle-WFFQtg/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-WFFQtg/middleware-loader.entry.ts
...
//# sourceMappingURL=hxnbtb0quyb.js.map
