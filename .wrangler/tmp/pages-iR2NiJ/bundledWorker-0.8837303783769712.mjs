...
// ../.wrangler/tmp/bundle-Aw4hkA/checked-fetch.js
...
// ../.wrangler/tmp/bundle-Aw4hkA/strip-cf-connecting-ip-header.js
...
}, "At"), Ce = /* @__PURE__ */ new WeakMap(), K = /* @__PURE__ */ new WeakMap(), te = /* @__PURE__ */ new WeakSet(), Dt = /* @__PURE__ */ __name(function(t) {
...
}, "pe"), Ue = /* @__PURE__ */ __name(function(e, n) {
  if (e instanceof Error)
    return this.errorHandler(e, n);
  throw e;
}, "Ue"), Ke = /* @__PURE__ */ __name(function(e, n, r, s) {
  if (s === "HEAD")
...
}, "_t"), oe = /* @__PURE__ */ new WeakMap(), ce = /* @__PURE__ */ new WeakMap(), We = /* @__PURE__ */ new WeakSet(), Ut = /* @__PURE__ */ __name(function(t) {
  const e = [];
  let n = t === $;
...
var fe;
var Me;
var zn = (Me = /* @__PURE__ */ __name(class {
  constructor(e, n, r) {
    T(this, ee);
    T(this, de);
    T(this, H);
...
}, "Me"), de = /* @__PURE__ */ new WeakMap(), H = /* @__PURE__ */ new WeakMap(), ye = /* @__PURE__ */ new WeakMap(), Re = /* @__PURE__ */ new WeakMap(), B = /* @__PURE__ */ new WeakMap(), ee = /* @__PURE__ */ new WeakSet(), fe = /* @__PURE__ */ __name(function(e, n, r, s) {
  const i = [];
...
X.post("/api/gens/run", async (t) => {
  ...
  const l = /* @__PURE__ */ __name(async ({ system: u, user: m, json: x }) => {
    if (x) {
      const v = `${u}
...
__name(Rr, "Rr");
function rt(t, e, n) {
  const { min: r, max: s } = Rr(n, e), i = [], a = /* @__PURE__ */ __name((l) => {
...
__name(jr, "jr");
function $r(t) {
  const e = tn(t), n = Nr(e), r = Tt(n, "standard"), s = Tt(n, "brief"), i = rt(n, "detail", e), a = rt(r, "standard", e), o = rt(s, "brief", e), c = /* @__PURE__ */ __name((l, u, m) => ({ mode: l, narrative: m, structured: u, mindmap: Ir(u), selftest: jr(u, l) }), "c");
...
// ../.wrangler/tmp/bundle-Aw4hkA/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-Aw4hkA/middleware-loader.entry.ts
...
//# sourceMappingURL=bundledWorker-0.8837303783769712.mjs.map
