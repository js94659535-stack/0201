...
// ../.wrangler/tmp/bundle-w030EW/checked-fetch.js
...
// ../.wrangler/tmp/bundle-w030EW/strip-cf-connecting-ip-header.js
...
var Ee = /* @__PURE__ */ __name((t) => {
  throw TypeError(t);
}, "Ee");
var mr = /* @__PURE__ */ __name((t, e, r) => e in t ? pr(t, e, { enumerable: true, configurable: true, writable: true, value: r }) : t[e] = r, "mr");
var E = /* @__PURE__ */ __name((t, e, r) => mr(t, typeof e != "symbol" ? e + "" : e, r), "E");
var ce = /* @__PURE__ */ __name((t, e, r) => e.has(t) || Ee("Cannot " + r), "ce");
var h = /* @__PURE__ */ __name((t, e, r) => (ce(t, e, "read from private field"), r ? r.call(t) : e.get(t)), "h");
var A = /* @__PURE__ */ __name((t, e, r) => e.has(t) ? Ee("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, r), "A");
var w = /* @__PURE__ */ __name((t, e, r, n) => (ce(t, e, "write to private field"), n ? n.call(t, r) : e.set(t, r), r), "w");
var j = /* @__PURE__ */ __name((t, e, r) => (ce(t, e, "access private method"), r), "j");
var Te = /* @__PURE__ */ __name((t, e, r, n) => ({ set _(s) {
  w(t, e, s, r);
}, get _() {
  return h(t, e, n);
} }), "Te");
var ke = /* @__PURE__ */ __name((t, e, r) => (n, s) => {
  let i = -1;
  return a(0);
  async function a(c) {
    if (c <= i)
...
var gr = Symbol();
var xr = /* @__PURE__ */ __name(async (t, e = /* @__PURE__ */ Object.create(null)) => {
...
var Ar = /* @__PURE__ */ __name((t) => Se(t, decodeURI), "Ar");
...
var bt = /* @__PURE__ */ __name((t, e, ...r) => (r.length && (e = bt(e, ...r)), `${(t == null ? void 0 : t[0]) === "/" ? "" : "/"}${t}${e === "/" ? "" : `${(t == null ? void 0 : t.at(-1)) === "/" ? "" : "/"}${(e == null ? void 0 : e[0]) === "/" ? e.slice(1) : e}`}`), "bt");
var Ge = /* @__PURE__ */ __name((t) => {
...
var le = /* @__PURE__ */ __name((t) => /[%+]/.test(t) ? (t.indexOf("+") !== -1 && (t = t.replace(/\+/g, " ")), t.indexOf("%") !== -1 ? Se(t, Je) : t) : t, "le");
var Ve = /* @__PURE__ */ __name((t, e, r) => {
  let n;
  if (!r && e && !/[%+]/.test(e)) {
    let a = t.indexOf("?", 8);
    if (a === -1)
...
var $r = Ve;
var jr = /* @__PURE__ */ __name((t, e) => Ve(t, e, true), "jr");
var Je = decodeURIComponent;
var Ae = /* @__PURE__ */ __name((t) => Se(t, Je), "Ae");
var Ot;
var V;
var rt;
var Xe;
...
var nt;
var De;
var ze = (De = /* @__PURE__ */ __name(class {
  constructor(t, e = "/", r = [[]]) {
    A(this, rt);
    E(this, "raw");
    A(this, Ot);
...
}, "De"), Ot = /* @__PURE__ */ new WeakMap(), V = /* @__PURE__ */ new WeakMap(), rt = /* @__PURE__ */ new WeakSet(), Xe = /* @__PURE__ */ __name(function(t) {
  const e = h(this, V)[0][this.routeIndex][1][t], r = j(this, rt, xe).call(this, e);
  return r && /\%/.test(r) ? Ae(r) : r;
}, "Xe"), We = /* @__PURE__ */ __name(function() {
  ...
  return t;
}, "We"), xe = /* @__PURE__ */ __name(function(t) {
  return h(this, V)[1] ? h(this, V)[1][t] : t;
}, "xe"), nt = /* @__PURE__ */ new WeakMap(), De);
var Rr = { Stringify: 1 };
var Ye = /* @__PURE__ */ __name(async (t, e, r, n, s) => {
...
var ue = /* @__PURE__ */ __name((t, e) => ({ "Content-Type": t, ...e }), "ue");
var Kt;
var Gt;
var Q;
var $t;
...
var Et;
var Le;
var Mr = (Le = /* @__PURE__ */ __name(class {
  constructor(t, e) {
    A(this, st);
    A(this, Kt);
    A(this, Gt);
    ...
    E(this, "html", (t2, e2, r) => {
      const n = /* @__PURE__ */ __name((s) => j(this, st, Et).call(this, s, e2, ue("text/html; charset=UTF-8", r)), "n");
...
var Ze = /* @__PURE__ */ __name(class extends Error {
}, "Ze");
var Cr = "__COMPOSED_HANDLER";
var Pr = /* @__PURE__ */ __name((t) => t.text("404 Not Found", 404), "Pr");
var Oe = /* @__PURE__ */ __name((t, e) => {
  if ("getResponse" in t) {
...
var Qt;
var _t;
var Dr = (_t = /* @__PURE__ */ __name(class {
  constructor(e = {}) {
    A(this, P);
    E(this, "get");
    E(this, "post");
  ...
  route(e, r) {
    ...
    return r.routes.map((s) => {
      var a;
      let i;
      r.errorHandler === Oe ? i = s.handler : (i = /* @__PURE__ */ __name(async (c, l) => (await ke([], r.errorHandler)(c, () => s.handler(c, l))).res, "i"), i[Cr] = s.handler), j(a = n, P, ut).call(a, s.method, s.path, i);
    }), this;
  }
  basePath(e) {
...
}, "_t"), J = /* @__PURE__ */ new WeakMap(), P = /* @__PURE__ */ new WeakSet(), tr = /* @__PURE__ */ __name(function() {
...
}, "tr"), z = /* @__PURE__ */ new WeakMap(), ut = /* @__PURE__ */ __name(function(e, r, n) {
...
}, "ut"), Yt = /* @__PURE__ */ __name(function(e, r) {
  if (e instanceof Error)
    return this.errorHandler(e, r);
  throw e;
}, "Yt"), Qt = /* @__PURE__ */ __name(function(e, r, n, s) {
  if (s === "HEAD")
...
var X;
var yt;
var qr = (yt = /* @__PURE__ */ __name(class {
  constructor() {
    A(this, mt);
    A(this, gt);
...
var Xt;
var He;
var Br = (He = /* @__PURE__ */ __name(class {
  constructor() {
...
var nr;
var Fe;
var Vr = (Fe = /* @__PURE__ */ __name(class {
  constructor() {
    A(this, ae);
...
}, "Fe"), it = /* @__PURE__ */ new WeakMap(), at = /* @__PURE__ */ new WeakMap(), ae = /* @__PURE__ */ new WeakSet(), nr = /* @__PURE__ */ __name(function(t) {
  const e = [];
  let r = t === C;
...
var tt;
var qe;
var Jr = (qe = /* @__PURE__ */ __name(class {
  constructor(t) {
...
var dt;
var Nt;
var zr = (Nt = /* @__PURE__ */ __name(class {
  constructor(e, r, n) {
    A(this, et);
    A(this, ct);
    A(this, F);
...
}, "Nt"), ct = /* @__PURE__ */ new WeakMap(), F = /* @__PURE__ */ new WeakMap(), xt = /* @__PURE__ */ new WeakMap(), Mt = /* @__PURE__ */ new WeakMap(), L = /* @__PURE__ */ new WeakMap(), et = /* @__PURE__ */ new WeakSet(), dt = /* @__PURE__ */ __name(function(e, r, n, s) {
  const i = [];
...
var sr = /* @__PURE__ */ __name(class extends Dr {
  constructor(t = {}) {
    super(t), this.router = t.router ?? new Jr({ routers: [new Vr(), new Xr()] });
  }
}, "sr");
var Wr = /* @__PURE__ */ __name((t) => {
...
var sn = /* @__PURE__ */ __name(async (t, e) => {
  let r;
...
var an = /* @__PURE__ */ __name((t) => async function(r, n) {
...
var on = /* @__PURE__ */ __name((t) => an(t), "on");
...
`);
      ...
      if (c = null, a === "phase2")
        try {
          const I = /* @__PURE__ */ __name(async (q) => await pe(e, q), "I"), k = await $n({ originalText: p, model: e.env.GEMINI_MODEL || "gemini", callLLM: I, db: e.env.DB, narrative: S, structured: { brief: O.structured, standard: R.structured, detail: b.structured }, mindmap: { brief: O.mindmap, standard: R.mindmap, detail: b.mindmap } });
...
// ../.wrangler/tmp/bundle-w030EW/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-w030EW/middleware-loader.entry.ts
...
//# sourceMappingURL=bundledWorker-0.915241674649907.mjs.map
