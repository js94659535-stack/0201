...
// ../.wrangler/tmp/bundle-J4k7ie/checked-fetch.js
...
// ../.wrangler/tmp/bundle-J4k7ie/strip-cf-connecting-ip-header.js
...
var un = /* @__PURE__ */ __name((t, e, n) => e in t ? dn(t, e, { enumerable: true, configurable: true, writable: true, value: n }) : t[e] = n, "un");
var C = /* @__PURE__ */ __name((t, e, n) => un(t, typeof e != "symbol" ? e + "" : e, n), "C");
var st = /* @__PURE__ */ __name((t, e, n) => e.has(t) || ft("Cannot " + n), "st");
var d = /* @__PURE__ */ __name((t, e, n) => (st(t, e, "read from private field"), n ? n.call(t) : e.get(t)), "d");
var N = /* @__PURE__ */ __name((t, e, n) => e.has(t) ? ft("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, n), "N");
var $ = /* @__PURE__ */ __name((t, e, n, r) => (st(t, e, "write to private field"), r ? r.call(t, n) : e.set(t, n), n), "$");
var I = /* @__PURE__ */ __name((t, e, n) => (st(t, e, "access private method"), n), "I");
var pt = /* @__PURE__ */ __name((t, e, n, r) => ({ set _(s) {
  $(t, e, s, n);
}, get _() {
  return d(t, e, r);
} }), "pt");
var mt = /* @__PURE__ */ __name((t, e, n) => (r, s) => {
  let i = -1;
  return a(0);
  async function a(o) {
    if (o <= i)
...
var hn = Symbol();
var fn = /* @__PURE__ */ __name(async (t, e = /* @__PURE__ */ Object.create(null)) => {
...
var Sn = /* @__PURE__ */ __name((t) => ht(t, decodeURI), "Sn");
...
var En = /* @__PURE__ */ __name((t) => {
  const e = Lt(t);
  return e.length > 1 && e.at(-1) === "/" ? e.slice(0, -1) : e;
}, "En");
var Te = /* @__PURE__ */ __name((t, e, ...n) => (n.length && (e = Te(e, ...n)), `${(t == null ? void 0 : t[0]) === "/" ? "" : "/"}${t}${e === "/" ? "" : `${(t == null ? void 0 : t.at(-1)) === "/" ? "" : "/"}${(e == null ? void 0 : e[0]) === "/" ? e.slice(1) : e}`}`), "Te");
...
var it = /* @__PURE__ */ __name((t) => /[%+]/.test(t) ? (t.indexOf("+") !== -1 && (t = t.replace(/\+/g, " ")), t.indexOf("%") !== -1 ? ht(t, Bt) : t) : t, "it");
var Ht = /* @__PURE__ */ __name((t, e, n) => {
  let r;
  if (!n && e && !/[%+]/.test(e)) {
    let a = t.indexOf("?", 8);
    if (a === -1)
...
var On = Ht;
var $n = /* @__PURE__ */ __name((t, e) => Ht(t, e, true), "$n");
var Bt = decodeURIComponent;
var gt = /* @__PURE__ */ __name((t) => ht(t, Bt), "gt");
var Re;
var X;
var oe;
var Ft;
...
var le;
var Rt;
var qt = (Rt = /* @__PURE__ */ __name(class {
  constructor(t, e = "/", n = [[]]) {
    N(this, oe);
    C(this, "raw");
    N(this, Re);
...
}, "Rt"), Re = /* @__PURE__ */ new WeakMap(), X = /* @__PURE__ */ new WeakMap(), oe = /* @__PURE__ */ new WeakSet(), Ft = /* @__PURE__ */ __name(function(t) {
  const e = d(this, X)[0][this.routeIndex][1][t], n = I(this, oe, dt).call(this, e);
  return n && /\%/.test(n) ? gt(n) : n;
}, "Ft"), Gt = /* @__PURE__ */ __name(function() {
  ...
  return t;
}, "Gt"), dt = /* @__PURE__ */ __name(function(t) {
...
var at = /* @__PURE__ */ __name((t, e) => ({ "Content-Type": t, ...e }), "at");
var qe;
var Fe;
var re;
var je;
...
var Ae;
var jt;
var An = (jt = /* @__PURE__ */ __name(class {
  constructor(t, e) {
    N(this, de);
    N(this, qe);
    N(this, Fe);
    ...
    C(this, "html", (t2, e2, n) => {
      const r = /* @__PURE__ */ __name((s) => I(this, de, Ae).call(this, s, e2, at("text/html; charset=UTF-8", n)), "r");
...
}, "jt"), qe = /* @__PURE__ */ new WeakMap(), Fe = /* @__PURE__ */ new WeakMap(), re = /* @__PURE__ */ new WeakMap(), je = /* @__PURE__ */ new WeakMap(), se = /* @__PURE__ */ new WeakMap(), V = /* @__PURE__ */ new WeakMap(), Ge = /* @__PURE__ */ new WeakMap(), Ne = /* @__PURE__ */ new WeakMap(), Me = /* @__PURE__ */ new WeakMap(), ve = /* @__PURE__ */ new WeakMap(), Ke = /* @__PURE__ */ new WeakMap(), Ue = /* @__PURE__ */ new WeakMap(), de = /* @__PURE__ */ new WeakSet(), Ae = /* @__PURE__ */ __name(function(t, e, n) {
...
var Ve;
var ke;
var Mn = (ke = /* @__PURE__ */ __name(class {
  constructor(e = {}) {
    N(this, U);
    C(this, "get");
    C(this, "post");
  ...
  route(e, n) {
    ...
    return n.routes.map((s) => {
      var a;
      let i;
      n.errorHandler === xt ? i = s.handler : (i = /* @__PURE__ */ __name(async (o, c) => (await mt([], n.errorHandler)(o, () => s.handler(o, c))).res, "i"), i[jn] = s.handler), I(a = r, U, ge).call(a, s.method, s.path, i);
    }), this;
  }
  basePath(e) {
...
}, "ke"), Q = /* @__PURE__ */ new WeakMap(), U = /* @__PURE__ */ new WeakSet(), Jt = /* @__PURE__ */ __name(function() {
...
}, "Jt"), Z = /* @__PURE__ */ new WeakMap(), ge = /* @__PURE__ */ __name(function(e, n, r) {
...
}, "ge"), Ye = /* @__PURE__ */ __name(function(e, n) {
  if (e instanceof Error)
    return this.errorHandler(e, n);
  throw e;
}, "Ye"), Ve = /* @__PURE__ */ __name(function(e, n, r, s) {
  if (s === "HEAD")
...
var In = new Set(".\\+*[^]$()");
function Pn(t, e) {
  return t.length === 1 ? e.length === 1 ? t < e ? -1 : 1 : -1 : e.length === 1 || t === He || t === Be ? 1 : e === He || e === Be ? -1 : t === Ze ? 1 : e === Ze ? -1 : t.length === e.length ? t < e ? -1 : 1 : e.length - t.length;
}
__name(Pn, "Pn");
var be;
var we;
var ee;
var Oe;
var Ln = (Oe = /* @__PURE__ */ __name(class {
  constructor() {
    N(this, be);
    N(this, we);
  ...
  insert(e, n, r, s, i) {
    ...
    const [a, ...o] = e, c = a === "*" ? o.length === 0 ? ["", "", He] : ["", "", Ze] : a === "/*" ? ["", "", Be] : a.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);
    let l;
    if (c) {
      const u = c[1];
      let h = c[2] || Ze;
      if (u && c[2] && (h === ".*" || (h = h.replace(/^\((?!\?:)(?=[^)]+\)$)/, "(?:"), /\((?!\?:)/.test(h))))
        throw _e;
      if (l = d(this, ee)[h], !l) {
        if (Object.keys(d(this, ee)).some((b) => b !== He && b !== Be))
          throw _e;
        if (i)
          return;
      ...
      if (Object.keys(d(this, ee)).some((u) => u.length > 1 && u !== He && u !== Be))
        throw _e;
      if (i)
        return;
...
var ze;
var Nt;
var Dn = (Nt = /* @__PURE__ */ __name(class {
  constructor() {
...
function qn(t) {
  ...
  for (let u = 0, h = -1, b = r.length; u < b; u++) {
    const [w, M, P] = r[u];
    w ? s[M] = [P.map(([D]) => [D, /* @__PURE__ */ Object.create(null)]), Yt] : h++;
    let A;
    try {
      A = e.insert(M, h, w);
    } catch (D) {
      throw D === _e ? new zt(M) : D;
    }
    w || (n[h] = P.map(([D, m]) => {
...
var Wt;
var Mt;
var Fn = (Mt = /* @__PURE__ */ __name(class {
  constructor() {
    N(this, nt);
...
}, "Mt"), ue = /* @__PURE__ */ new WeakMap(), he = /* @__PURE__ */ new WeakMap(), nt = /* @__PURE__ */ new WeakSet(), Wt = /* @__PURE__ */ __name(function(t) {
  const e = [];
  let n = t === K;
...
var ie;
var kt;
var Gn = (kt = /* @__PURE__ */ __name(class {
  constructor(t) {
...
var xe;
var Pe;
var Kn = (Pe = /* @__PURE__ */ __name(class {
  constructor(e, n, r) {
    N(this, ae);
    N(this, pe);
    N(this, Y);
  ...
  search(e, n) {
    ...
    for (let l = 0, u = a.length; l < u; l++) {
      ...
      for (let M = 0, P = i.length; M < P; M++) {
        const A = i[M], D = d(A, Y)[h];
        D && ($(D, z, d(A, z)), b ? (d(D, Y)["*"] && r.push(...I(this, ae, xe).call(this, d(D, Y)["*"], e, d(A, z))), r.push(...I(this, ae, xe).call(this, D, e, d(A, z)))) : w.push(D));
...
}, "Pe"), pe = /* @__PURE__ */ new WeakMap(), Y = /* @__PURE__ */ new WeakMap(), ye = /* @__PURE__ */ new WeakMap(), Ie = /* @__PURE__ */ new WeakMap(), z = /* @__PURE__ */ new WeakMap(), ae = /* @__PURE__ */ new WeakSet(), xe = /* @__PURE__ */ __name(function(e, n, r, s) {
  const i = [];
...
var Se;
var It;
var Un = (It = /* @__PURE__ */ __name(class {
  constructor() {
...
var Xt = /* @__PURE__ */ __name(class extends Mn {
  constructor(t = {}) {
    ...
    if (l) {
      ...
      if (s.header("Content-Type", M || "application/octet-stream"), t.precompressed && (!M || Jn.test(M))) {
        ...
        for (const A of Xn) {
          if (!P.has(A))
            continue;
          const D = await c(o + Qt[A], s);
          if (D) {
            l = D, s.header("Content-Encoding", A), s.header("Vary", "Accept-Encoding", { append: true });
            break;
          }
        }
      }
...
var er = /* @__PURE__ */ __name(async (t, e) => {
  let n;
...
var tr = /* @__PURE__ */ __name((t) => async function(n, r) {
...
var nr = /* @__PURE__ */ __name((t) => tr(t), "nr");
var ne = new Xt();
...
function gr(t, e, n) {
  ...
  if (n === "standard") {
    ...
    for (const E of m)
      for (const T of E.sentences) {
        ...
        if (R) {
          ...
          const H = new Set(et(F)), B = lr(H), W = /* @__PURE__ */ new Set(["\uC624\uAC10", "\uAC10\uAC01", "\uAC10\uAC01\uC801", "\uCCB4\uD5D8", "\uACBD\uD5D8", "\uD65C\uB3D9", "\uD559\uC2B5"]);
          for (const q of W)
            B.delete(q);
    ...
    for (const [E, T] of y.entries()) {
      const R = T.flatMap((H) => H.citations).filter(Boolean), G = E.charAt(E.length - 1), F = /[가-힣]/.test(G) && (G.charCodeAt(0) - 44032) % 28 !== 0 ? "\uC740" : "\uB294";
      if (T.length === 1) {
        const H = T[0].original, B = (H.match(/,/g) || []).length;
        if (H.length > 80 && B >= 2) {
          const W = H.split(",").map((q) => q.trim()).filter((q) => q.length > 0);
          if (W.length >= 2) {
        ...
        for (const B of T) {
          ...
          W || H.push({ original: B.original, keywords: B.keywords, citations: [...B.citations] });
        }
        if (H.length === 1)
          S.push({ text: `${E}${F} ${H[0].original}`, citations: H.flatMap((B) => B.citations) });
        else if (H.length === 2)
          S.push({ text: `${E}${F} ${H[0].original}`, citations: H[0].citations }), S.push({ text: `${E}${F} ${H[1].original}`, citations: H[1].citations });
        else
          for (let B = 0; B < H.length; B++)
            S.push({ text: `${E}${F} ${H[B].original}`, citations: H[B].citations });
      }
    }
    if (S.length === 0)
      return "\uC694\uC57D\uD560 \uB0B4\uC6A9\uC774 \uBD80\uC871\uD569\uB2C8\uB2E4.";
...
__name(gr, "gr");
function xr(t, e, n) {
  const r = rn(t), s = e === "brief" ? Ee(Math.round(r.length * 0.15), 2, 4) : e === "standard" ? Ee(Math.round(r.length * 0.3), 5, 9) : Ee(Math.round(r.length * 0.55), 10, 18);
  let i = ur(r, s);
  if (e === "detail") {
    const o = ["\uC131\uBCC4", "\uD559\uB144", "\uB0A8\uD559\uC0DD", "\uC5EC\uD559\uC0DD", "\uCD08\uB4F1", "\uC911\uD559", "\uACE0\uD559\uB144", "\uC800\uD559\uB144", "\uBCC0\uC778", "\uCC28\uC774", "\uBE44\uAD50"], c = r.filter((l) => o.some((u) => l.includes(u)) && !i.includes(l)).slice(0, 5);
    c.length > 0 && (i = [...i, ...c]);
  }
  if (n === "narrative") {
    let o, c = null, l = null;
    return o = gr(i, t, e), o = sn(o), { kind: "summary", mode: e, viewType: n, narrative: o, ...c, ...l };
  }
  if (n === "structured")
...
function lt(t, e, n, r) {
  ...
  let a = (e || "").trim();
  const o = /* @__PURE__ */ __name(() => te(a), "o"), c = /* @__PURE__ */ __name(() => {
...
`);
  ...
  __name(A, "A");
  async function D({ llmCall: v, originalText: g, mode: f, format: x }) {
    if (!v)
  ...
  async function y({ llmCall: v, mode: g, purpose: f, format: x, summaryText: O, sentTable: p, anchors: _ }) {
    ...
    if (G.length > 0) {
      ...
      let H = await v({ system: u(), user: F, json: true }), B;
      try {
        B = JSON.parse(H);
      } catch {
        B = { items: [] };
  ...
  async function S({ llmCall: v, originalText: g, mode: f, format: x, purpose: O }) {
    const p = await D({ llmCall: v, originalText: g, mode: f, format: x }), _ = await y({ llmCall: v, mode: f, purpose: O, format: x, summaryText: p.summaryText, sentTable: p.sentTable, anchors: p.anchors });
  ...
  __name(S, "S");
  return { computeCharTargets: a, splitSentencesKR: o, makeSentenceTable: c, generateBundle: D, generateSelfTest: y, runPipeline: S, MasteryRunner: j };
})();
...
ne.post("/api/engine", async (t) => {
  ...
  if (b.hit && ((D = b.data) != null && D.narrative)) {
    const m = b.data.narrative;
    let y;
    return o === "narrative" ? y = { kind: s, mode: a, viewType: o, narrative: m } : o === "structured" ? y = { kind: s, mode: a, ...Ct(m) } : o === "mindmap" ? y = { kind: s, mode: a, ...Tt(m) } : y = { kind: s, mode: a, ...At(m) }, await De(n, l, c || "anon", y), t.json({ ok: true, data: y, meta: { cached: true, cacheStore: "derived", cacheType: "converted", engine: "local-convert", elapsedMs: Date.now() - e } }, 200);
  }
...
${m.detail["\uAD50\uC721\uC801 \uAC00\uCE58"]}`;
      ...
      await De(n, h, c || "anon", k);
      let j;
      return o === "narrative" ? j = k : o === "structured" ? j = { kind: s, mode: a, ...Ct(y) } : o === "mindmap" ? j = { kind: s, mode: a, ...Tt(y) } : j = { kind: s, mode: a, ...At(y) }, await De(n, l, c || "anon", j), t.json({ ok: true, data: j, meta: { cached: false, engine: "gemini-json-v3", elapsedMs: Date.now() - e } }, 200);
    } catch (m) {
      console.error("[Gemini JSON Error]", m);
    }
  const P = xr(i, a, o);
  if (await De(n, l, c || "anon", P), P.narrative) {
    const m = { kind: "summary", mode: a, viewType: "narrative", narrative: P.narrative };
    await De(n, h, c || "anon", m);
  }
...
// ../.wrangler/tmp/bundle-J4k7ie/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-J4k7ie/middleware-loader.entry.ts
...
//# sourceMappingURL=bundledWorker-0.21237474885500673.mjs.map
