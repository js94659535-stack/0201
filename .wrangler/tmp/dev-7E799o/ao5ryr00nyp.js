...
// .wrangler/tmp/bundle-NezAq6/checked-fetch.js
...
// .wrangler/tmp/bundle-NezAq6/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/pages-OmDb72/bundledWorker-0.5816744941796559.mjs
...
var Wt = /* @__PURE__ */ __name2((e, t, r) => t in e ? zt(e, t, { enumerable: true, configurable: true, writable: true, value: r }) : e[t] = r, "Wt");
var v = /* @__PURE__ */ __name2((e, t, r) => Wt(e, typeof t != "symbol" ? t + "" : t, r), "v");
...
var j = /* @__PURE__ */ __name2((e, t, r) => (We(e, t, "access private method"), r), "j");
...
var ar = /* @__PURE__ */ __name2((e) => nt(e, decodeURI), "ar");
var Ot = /* @__PURE__ */ __name2((e) => {
...
var Xe = /* @__PURE__ */ __name2((e) => /[%+]/.test(e) ? (e.indexOf("+") !== -1 && (e = e.replace(/\+/g, " ")), e.indexOf("%") !== -1 ? nt(e, Ct) : e) : e, "Xe");
var Rt = /* @__PURE__ */ __name2((e, t, r) => {
  ...
  if (!r && t && !/[%+]/.test(t)) {
    ...
    for (e.startsWith(t, a + 1) || (a = e.indexOf(`&${t}`, a + 1)); a !== -1; ) {
      ...
      if (l === 61) {
        ...
        return Xe(e.slice(c, o === -1 ? void 0 : o));
  ...
  for (; i !== -1; ) {
    ...
    if (n && (c = Xe(c)), i = a, c === "")
      continue;
    let o;
    l === -1 ? o = "" : (o = e.slice(l + 1, a === -1 ? void 0 : a), n && (o = Xe(o))), r ? (s[c] && Array.isArray(s[c]) || (s[c] = []), s[c].push(o)) : s[c] ?? (s[c] = o);
  }
  return t ? s[t] : s;
}, "Rt");
var cr = Rt;
var lr = /* @__PURE__ */ __name2((e, t) => Rt(e, t, true), "lr");
var Ct = decodeURIComponent;
var ut = /* @__PURE__ */ __name2((e) => nt(e, Ct), "ut");
var xe;
var N;
var V;
var Mt;
...
var $t = (wt = /* @__PURE__ */ __name2(class {
  constructor(e, t = "/", r = [[]]) {
    ...
    this.raw = e, this.path = t, y(this, N, r), y(this, xe, {});
  }
  param(e) {
    return e ? j(this, V, Mt).call(this, e) : j(this, V, _t).call(this);
  }
  query(e) {
...
}, "wt"), xe = /* @__PURE__ */ new WeakMap(), N = /* @__PURE__ */ new WeakMap(), V = /* @__PURE__ */ new WeakSet(), Mt = /* @__PURE__ */ __name2(function(e) {
  const t = d(this, N)[0][this.routeIndex][1][e], r = j(this, V, et).call(this, t);
  return r && /\%/.test(r) ? ut(r) : r;
}, "Mt"), _t = /* @__PURE__ */ __name2(function() {
  const e = {}, t = Object.keys(d(this, N)[0][this.routeIndex][1]);
  for (const r of t) {
    const n = j(this, V, et).call(this, d(this, N)[0][this.routeIndex][1][r]);
    n !== void 0 && (e[r] = /\%/.test(n) ? ut(n) : n);
  }
  return e;
}, "_t"), et = /* @__PURE__ */ __name2(function(e) {
  return d(this, N)[1] ? d(this, N)[1][e] : e;
}, "et"), J = /* @__PURE__ */ new WeakMap(), wt);
var ur = { Stringify: 1 };
var It = /* @__PURE__ */ __name2(async (e, t, r, n, s) => {
...
var Ye = /* @__PURE__ */ __name2((e, t) => ({ "Content-Type": e, ...t }), "Ye");
var $e;
var Me;
var G;
var ye;
...
var fe;
var St;
var hr = (St = /* @__PURE__ */ __name2(class {
  constructor(e, t) {
    S(this, z);
    S(this, $e);
    S(this, Me);
    ...
    v(this, "newResponse", (...e2) => j(this, z, fe).call(this, ...e2));
    v(this, "body", (e2, t2, r) => j(this, z, fe).call(this, e2, t2, r));
    v(this, "text", (e2, t2, r) => !d(this, se) && !d(this, ye) && !t2 && !r && !this.finalized ? new Response(e2) : j(this, z, fe).call(this, e2, t2, Ye(dr, r)));
    v(this, "json", (e2, t2, r) => j(this, z, fe).call(this, JSON.stringify(e2), t2, Ye("application/json", r)));
    v(this, "html", (e2, t2, r) => {
      const n = /* @__PURE__ */ __name2((s) => j(this, z, fe).call(this, s, t2, Ye("text/html; charset=UTF-8", r)), "n");
    ...
    y(this, $e, e), t && (y(this, B, t.executionCtx), this.env = t.env, y(this, we, t.notFoundHandler), y(this, Ne, t.path), y(this, Ie, t.matchResult));
  }
  get req() {
    return d(this, Me) ?? y(this, Me, new $t(d(this, $e), d(this, Ne), d(this, Ie))), d(this, Me);
  }
  get event() {
    if (d(this, B) && "respondWith" in d(this, B))
      return d(this, B);
...
}, "St"), $e = /* @__PURE__ */ new WeakMap(), Me = /* @__PURE__ */ new WeakMap(), G = /* @__PURE__ */ new WeakMap(), ye = /* @__PURE__ */ new WeakMap(), B = /* @__PURE__ */ new WeakMap(), M = /* @__PURE__ */ new WeakMap(), _e = /* @__PURE__ */ new WeakMap(), ve = /* @__PURE__ */ new WeakMap(), we = /* @__PURE__ */ new WeakMap(), se = /* @__PURE__ */ new WeakMap(), Ie = /* @__PURE__ */ new WeakMap(), Ne = /* @__PURE__ */ new WeakMap(), z = /* @__PURE__ */ new WeakSet(), fe = /* @__PURE__ */ __name2(function(e, t, r) {
...
var gr = /* @__PURE__ */ __name2((e) => e.text("404 Not Found", 404), "gr");
...
var Le;
var Se;
var xr = (Se = /* @__PURE__ */ __name2(class {
  constructor(t = {}) {
    S(this, k);
    v(this, "get");
    v(this, "post");
    ...
    v(this, "fetch", (t2, ...r) => j(this, k, Le).call(this, t2, r[1], r[0], t2.method));
    ...
    v(this, "fire", () => {
      addEventListener("fetch", (t2) => {
        t2.respondWith(j(this, k, Le).call(this, t2.request, t2, void 0, t2.request.method));
      });
    });
    [...pr, fr].forEach((i) => {
      this[i] = (a, ...l) => (typeof a == "string" ? y(this, P, a) : j(this, k, re).call(this, i, d(this, P), a), l.forEach((c) => {
        j(this, k, re).call(this, i, d(this, P), c);
      }), this);
    }), this.on = (i, a, ...l) => {
      for (const c of [a].flat()) {
        ...
        for (const o of [i].flat())
          l.map((u) => {
            j(this, k, re).call(this, o.toUpperCase(), d(this, P), u);
          });
      }
      return this;
    }, this.use = (i, ...a) => (typeof i == "string" ? y(this, P, i) : (y(this, P, "*"), a.unshift(i)), a.forEach((l) => {
      j(this, k, re).call(this, O, d(this, P), l);
    }), this);
    const { strict: n, ...s } = t;
  ...
  route(t, r) {
    ...
    return r.routes.map((s) => {
      var a;
      let i;
      r.errorHandler === dt ? i = s.handler : (i = /* @__PURE__ */ __name2(async (l, c) => (await lt([], r.errorHandler)(l, () => s.handler(l, c))).res, "i"), i[mr] = s.handler), j(a = n, k, re).call(a, s.method, s.path, i);
    }), this;
  }
  basePath(t) {
    const r = j(this, k, Dt).call(this);
  ...
  mount(t, r, n) {
    ...
    s || (s = (() => {
      const c = he(this._basePath, t), o = c === "/" ? 0 : c.length;
      return (u) => {
    ...
    return j(this, k, re).call(this, O, he(t, "*"), l), this;
  }
}, "Se"), P = /* @__PURE__ */ new WeakMap(), k = /* @__PURE__ */ new WeakSet(), Dt = /* @__PURE__ */ __name2(function() {
  ...
  if (s === "HEAD")
    return (async () => new Response(null, await j(this, k, Le).call(this, t, r, n, "GET")))();
  const i = this.getPath(t, { env: n }), a = this.router.match(s, i), l = new hr(t, { path: i, matchResult: a, env: n, executionCtx: r, notFoundHandler: d(this, D) });
  if (a[0].length === 1) {
    let o;
    try {
      o = a[0][0][0][0](l, async () => {
        l.res = await d(this, D).call(this, l);
      });
    } catch (u) {
      return j(this, k, He).call(this, u, l);
    }
    return o instanceof Promise ? o.then((u) => u || (l.finalized ? l.res : d(this, D).call(this, l))).catch((u) => j(this, k, He).call(this, u, l)) : o ?? d(this, D).call(this, l);
  }
  const c = lt(a[0], this.errorHandler, d(this, D));
  return (async () => {
    try {
      const o = await c(l);
      if (!o.finalized)
      ...
      return j(this, k, He).call(this, o, l);
    }
  })();
}, "Le"), Se);
var Ht = [];
...
var vr = new Set(".\\+*[^]$()");
function wr(e, t) {
  return e.length === 1 ? t.length === 1 ? e < t ? -1 : 1 : -1 : t.length === 1 || e === Ae || e === Oe ? 1 : t === Ae || t === Oe ? -1 : e === Ue ? 1 : t === Ue ? -1 : e.length === t.length ? e < t ? -1 : 1 : t.length - e.length;
}
__name(wr, "wr");
__name2(wr, "wr");
var ie;
...
var H;
var le;
var Sr = (le = /* @__PURE__ */ __name2(class {
  constructor() {
    S(this, ie);
    S(this, ae);
  ...
  insert(t, r, n, s, i) {
    ...
    const [a, ...l] = t, c = a === "*" ? l.length === 0 ? ["", "", Ae] : ["", "", Ue] : a === "/*" ? ["", "", Oe] : a.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);
    let o;
    if (c) {
      const u = c[1];
      let h = c[2] || Ue;
      if (u && c[2] && (h === ".*" || (h = h.replace(/^\((?!\?:)(?=[^)]+\)$)/, "(?:"), /\((?!\?:)/.test(h))))
        throw pe;
      if (o = d(this, H)[h], !o) {
        if (Object.keys(d(this, H)).some((f) => f !== Ae && f !== Oe))
          throw pe;
        if (i)
          return;
      ...
      if (Object.keys(d(this, H)).some((u) => u.length > 1 && u !== Ae && u !== Oe))
        throw pe;
      if (i)
        return;
      o = d(this, H)[a] = new le();
  ...
  buildRegExpStr() {
    const r = Object.keys(d(this, H)).sort(wr).map((n) => {
      const s = d(this, H)[n];
      return (typeof d(s, ae) == "number" ? `(${n})@${d(s, ae)}` : vr.has(n) ? `\\${n}` : n) + s.buildRegExpStr();
    });
...
var Pe;
var bt;
var br = (bt = /* @__PURE__ */ __name2(class {
  constructor() {
    S(this, Ve, { varIndex: 0 });
    S(this, Pe, new Sr());
  }
  insert(e, t, r) {
    const n = [], s = [];
    ...
    return d(this, Pe).insert(i, t, n, d(this, Ve), r), n;
  }
  buildRegExp() {
    let e = d(this, Pe).buildRegExpStr();
    if (e === "")
      return [/^$/, [], []];
    let t = 0;
    const r = [], n = [];
...
}, "bt"), Ve = /* @__PURE__ */ new WeakMap(), Pe = /* @__PURE__ */ new WeakMap(), bt);
...
var Ar = (Et = /* @__PURE__ */ __name2(class {
  constructor() {
    ...
    S(this, X);
    v(this, "match", yr);
    y(this, W, { [O]: /* @__PURE__ */ Object.create(null) }), y(this, X, { [O]: /* @__PURE__ */ Object.create(null) });
  }
  add(e, t, r) {
    var l;
    const n = d(this, W), s = d(this, X);
    if (!n || !s)
      throw new Error(Nt);
    n[e] || [n, s].forEach((c) => {
    ...
    if (/\*$/.test(t)) {
      ...
      }) : (l = n[e])[t] || (l[t] = de(n[e], t) || de(n[O], t) || []), Object.keys(n).forEach((o) => {
    ...
    for (let c = 0, o = a.length; c < o; c++) {
      ...
      Object.keys(s).forEach((h) => {
        var f;
        (e === O || e === h) && ((f = s[h])[u] || (f[u] = [...de(n[h], u) || de(n[O], u) || []]), s[h][u].push([r, i - o + c + 1]));
      });
    }
  }
  buildAllMatchers() {
    const e = /* @__PURE__ */ Object.create(null);
    return Object.keys(d(this, X)).concat(Object.keys(d(this, W))).forEach((t) => {
      e[t] || (e[t] = j(this, Je, qt).call(this, t));
    }), y(this, W, y(this, X, void 0)), Tr(), e;
  }
}, "Et"), W = /* @__PURE__ */ new WeakMap(), X = /* @__PURE__ */ new WeakMap(), Je = /* @__PURE__ */ new WeakSet(), qt = /* @__PURE__ */ __name2(function(e) {
  const t = [];
  let r = e === O;
  return [d(this, W), d(this, X)].forEach((n) => {
...
var K;
var Tt;
var Or = (Tt = /* @__PURE__ */ __name2(class {
  constructor(e) {
  ...
  match(e, t) {
    ...
    const r = d(this, Y), n = d(this, K), s = r.length;
    let i = 0, a;
    for (; i < s; i++) {
      const l = r[i];
      try {
      ...
      this.match = l.match.bind(l), y(this, Y, [l]), y(this, K, void 0);
      break;
    }
    if (i === s)
      throw new Error("Fatal error");
  ...
  get activeRouter() {
    if (d(this, K) || d(this, Y).length !== 1)
      throw new Error("No active router has been determined yet.");
    return d(this, Y)[0];
  }
}, "Tt"), Y = /* @__PURE__ */ new WeakMap(), K = /* @__PURE__ */ new WeakMap(), Tt);
...
var ne;
var Ee;
var kr = (Ee = /* @__PURE__ */ __name2(class {
  constructor(t, r, n) {
    S(this, U);
    S(this, Q);
    S(this, C);
    ...
    S(this, be, 0);
    S(this, R, je);
    if (y(this, C, n || /* @__PURE__ */ Object.create(null)), y(this, Q, []), t && r) {
  ...
  insert(t, r, n) {
    ...
    for (let l = 0, c = i.length; l < c; l++) {
      const o = i[l], u = i[l + 1], h = ir(o, u), f = Array.isArray(h) ? h[0] : o;
      if (f in d(s, C)) {
        s = d(s, C)[f], h && a.push(h[1]);
        continue;
      }
      d(s, C)[f] = new Ee(), h && (d(s, oe).push(h), a.push(h[1])), s = d(s, C)[f];
    }
    return d(s, Q).push({ [t]: { handler: n, possibleKeys: a.filter((l, c, o) => o.indexOf(l) === c), score: d(this, be) } }), s;
  }
  search(t, r) {
    var c;
    const n = [];
    ...
    for (let o = 0, u = a.length; o < u; o++) {
      ...
      for (let g = 0, b = i.length; g < b; g++) {
        const x = i[g], w = d(x, C)[h];
        w && (y(w, R, d(x, R)), f ? (d(w, C)["*"] && n.push(...j(this, U, ne).call(this, d(w, C)["*"], t, d(x, R))), n.push(...j(this, U, ne).call(this, w, t, d(x, R)))) : p.push(w));
        for (let m = 0, E = d(x, oe).length; m < E; m++) {
          const A = d(x, oe)[m], T = d(x, R) === je ? {} : { ...d(x, R) };
          if (A === "*") {
            const L = d(x, C)["*"];
            L && (n.push(...j(this, U, ne).call(this, L, t, d(x, R))), y(L, R, T), p.push(L));
            continue;
          }
          const [F, _, I] = A;
          if (!h && !(I instanceof RegExp))
            continue;
          const $ = d(x, C)[F], ee = a.slice(o).join("/");
          if (I instanceof RegExp) {
            const L = I.exec(ee);
            if (L) {
              if (T[_] = L[0], n.push(...j(this, U, ne).call(this, $, t, d(x, R), T)), Object.keys(d($, C)).length) {
                y($, R, T);
                const te = ((c = L[0].match(/\//)) == null ? void 0 : c.length) ?? 0;
                (l[te] || (l[te] = [])).push($);
              }
              continue;
            }
          }
          (I === true || I.test(h)) && (T[_] = h, f ? (n.push(...j(this, U, ne).call(this, $, t, T, d(x, R))), d($, C)["*"] && n.push(...j(this, U, ne).call(this, d($, C)["*"], t, T, d(x, R)))) : (y($, R, T), p.push($)));
        }
      }
      i = p.concat(l.shift() ?? []);
    }
...
}, "Ee"), Q = /* @__PURE__ */ new WeakMap(), C = /* @__PURE__ */ new WeakMap(), oe = /* @__PURE__ */ new WeakMap(), be = /* @__PURE__ */ new WeakMap(), R = /* @__PURE__ */ new WeakMap(), U = /* @__PURE__ */ new WeakSet(), ne = /* @__PURE__ */ __name2(function(t, r, n, s) {
  const i = [];
  for (let a = 0, l = d(t, Q).length; a < l; a++) {
    const c = d(t, Q)[a], o = c[r] || c[O], u = {};
...
var ce;
var jt;
var Rr = (jt = /* @__PURE__ */ __name2(class {
  constructor() {
...
}, "jt"), ce = /* @__PURE__ */ new WeakMap(), jt);
var Ft = /* @__PURE__ */ __name2(class extends xr {
  constructor(e = {}) {
...
var ht = /* @__PURE__ */ __name2((e, t = _r) => {
...
var Dr = /* @__PURE__ */ __name2((e) => {
  ...
  return async (s, i) => {
    ...
    if (o) {
      const g = e.mimes && ht(l, e.mimes) || ht(l);
      if (s.header("Content-Type", g || "application/octet-stream"), e.precompressed && (!g || $r.test(g))) {
        const b = new Set((h = s.req.header("Accept-Encoding")) == null ? void 0 : h.split(",").map((x) => x.trim()));
        for (const x of Nr) {
          if (!b.has(x))
            continue;
          const w = await c(l + Gt[x], s);
          if (w) {
...
var Lr = /* @__PURE__ */ __name2((e) => async function(r, n) {
...
var qr = /* @__PURE__ */ __name2((e) => Lr(e), "qr");
...
__name2(Te, "Te");
function Qe(e, t, r) {
  const n = tt(e), i = tt(t) / Math.max(n, 1), a = Bt[r];
...
function Kr(e, t, r) {
  ...
  if (a.over && s.length > 1)
    for (; s.length > 1 && (s.pop(), l = true, a = Qe(e, s.join(". ") + ".", r), !a.ok); )
      ;
  if (a.under) {
    const c = Br(r);
    for (const o of c)
      if (s.push(o), l = true, a = Qe(e, s.join(". ") + ".", r), a.ok)
        break;
  }
...
function Fe(e, t) {
  const r = Z(e);
  Te(e);
  const n = Fr(e), s = Bt[t], i = Math.floor(n * s.min), a = Math.floor(n * s.max), l = r[0] || "\uC6D0\uBB38\uC758 \uD575\uC2EC \uC8FC\uC7A5\uC744 \uD30C\uC545\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4", c = r.map((E, A) => {
    let T = 0;
    return /(정의|개념|의미|일컫|규정|정리)/.test(E) && (T += 5), /(특징|특성|요인|측면|경향|양상)/.test(E) && (T += 4), /(연구|학자|선행|본|분석|종합)/.test(E) && (T += 3), /(차이|비교|대조|반면|이에 반해)/.test(E) && (T += 2), A === 0 && (T += 3), E.length < 20 && (T -= 2), E.length > 200 && (T -= 1), { sentence: E, score: T, index: A };
  }), o = t === "brief" ? 2 : t === "standard" ? 3 : 5, u = c.sort((E, A) => A.score - E.score || E.index - A.index).slice(0, o).sort((E, A) => E.index - A.index).map((E) => E.sentence);
  let h = "";
  t === "brief" ? h = u.slice(0, 3).join(" ") : t === "standard" ? h = u.slice(0, 5).join(" ") : h = u.join(" ");
  const f = ["\uC2A4\uC6E8\uB374", "\uD55C\uAD6D", "\uACF5\uAD50\uC721", "\uC0AC\uAD50\uC721", "\uC120\uD589\uD559\uC2B5", "OECD", "GDP"];
  for (const E of f)
    !e.includes(E) && h.includes(E) && (h = Z(h).filter((T) => !T.includes(E)).join(" "));
  h = h.replace(/약\s*\d+\.?\d*배/g, "").replace(/\d+\.?\d*배\s*수준/g, "").replace(/를?\s*비교하면\s*약?\s*\d+/g, "").trim(), h = h.replace(/\.\s*\./g, ".").replace(/\s+/g, " ").trim();
  const p = Kr(e, h, t), g = p.text, b = tt(g), x = Z(g), w = x[0] || l, m = x.slice(1);
  for (; m.length < 3; )
...
__name2(Fe, "Fe");
function Ge(e, t) {
  const r = Z(e), n = Te(e), s = t === "brief" ? 2 : t === "standard" ? 4 : 6;
...
function Jr(e, t) {
  ...
  for (let l = 0; l < s && l < a.length; l++) {
    const c = a[l], o = zr(c), u = n.find((h) => h.includes(c)) || `${c}\uC5D0 \uB300\uD55C \uC124\uBA85`;
...
__name2(zr, "zr");
function Ke(e, t) {
  const r = Ur(e), n = Vr(e, t), s = Jr(e, t), i = Te(e), a = [{ title: `\uD559\uC2B5 \uB2E8\uC704: ${r.unitName}`, keywords: i.slice(0, 3), bullets: [`\uBC94\uC704: ${r.scope}`, `\uB300\uC0C1: ${r.targetLevel}`], children: n.map((o) => ({ title: o.title, keywords: Te(o.content.join(" ")).slice(0, 3), bullets: o.content, children: [] })) }], l = s.map((o) => ({ term: o.word, def: `${o.coreMeaning} \u2014 ${o.explanation}` })), c = n.map((o, u) => ({ title: o.title, anchor: `sec-${u + 1}` }));
...
__name2(ft, "ft");
function Wr(e) {
  const t = Fe(e, "detail"), r = Ke(e, "detail"), n = Ge(e, "detail"), s = Be(t.text, "detail", "exam"), i = e.length, a = Kt(e), l = t.coreClaim, c = t.grounds, o = t.comparisons || [], u = t.implications || [];
  let h = t.text;
  if (!h.includes(`
...
` + w.slice(m).join(". ") + ".";
  ...
  return { schemaVersion: "ms-v4", lang: "ko", source: { charCount: i, checksum: a }, narrative: { coreClaim: l, grounds: c, comparisons: o, implications: u, summaryDetail: h }, structured: { toc: f, hierarchy: p, glossary: g }, mindmap: b, selftest: x };
}
__name(Wr, "Wr");
__name2(Wr, "Wr");
function pt(e) {
...
`);
      ...
      const u = Fe(i, "brief"), h = Fe(i, "standard"), f = Fe(i, "detail"), p = Ke(i, "brief"), g = Ke(i, "standard"), b = Ke(i, "detail"), x = Ge(i, "brief"), w = Ge(i, "standard"), m = Ge(i, "detail"), E = Be(i, "brief", "preview"), A = Be(i, "standard", "preview"), T = Be(i, "detail", "preview"), F = { narrative: { text: u.text, coreClaim: u.coreClaim, grounds: u.grounds, comparisons: u.comparisons, implications: u.implications, ratio: u.ratio, ratioEnforcement: u.ratioEnforcement, targetRange: u.targetRange }, structured: p, mindmap: x, selftest: E }, _ = { narrative: { text: h.text, coreClaim: h.coreClaim, grounds: h.grounds, comparisons: h.comparisons, implications: h.implications, ratio: h.ratio, ratioEnforcement: h.ratioEnforcement, targetRange: h.targetRange }, structured: g, mindmap: w, selftest: A }, I = { narrative: { text: f.text, coreClaim: f.coreClaim, grounds: f.grounds, comparisons: f.comparisons, implications: f.implications, ratio: f.ratio, ratioEnforcement: f.ratioEnforcement, targetRange: f.targetRange }, structured: b, mindmap: m, selftest: T }, $ = Yr({ brief: F, standard: _, detail: I });
      if ($.length && l === false)
        return t.json({ ok: false, error: { code: "LEVEL_SEPARATION_FAIL", message: $.join(" | ") }, meta: { reqId: n, elapsedMs: Date.now() - r } }, 422);
      const ee = { ok: true, data: { schemaVersion: "ms-v4", levels: { brief: F, standard: _, detail: I }, views: { narrative: { brief: F.narrative, standard: _.narrative, detail: I.narrative }, structured: { brief: F.structured, standard: _.structured, detail: I.structured }, mindmap: { brief: F.mindmap, standard: _.mindmap, detail: I.mindmap }, selftest: { brief: F.selftest, standard: _.selftest, detail: I.selftest } } }, meta: { requestId: n, elapsedMs: Date.now() - r, promptVersion: "matrix-v4-detail+downsample", checksum: a } };
    ...
    var r;
    try {
      const { buildFailReport: n } = await Promise.resolve().then(() => wn), s = Number(t.req.query("hours")) || 168, i = (r = t.env) == null ? void 0 : r.DB, a = await n(i, { sinceHours: s });
...
__name2(tn, "tn");
function rn(e, t) {
  const r = Math.max(60, ge(e)), n = 0.53, s = Math.floor(r * n * 0.85), i = Math.ceil(r * n * 1.15), a = Math.floor(r * n), l = Math.ceil(r * 0.05);
  return { base: r, min: s, max: i, keep: a, tol: l };
}
__name(rn, "rn");
__name2(rn, "rn");
function nn(e) {
  const t = String((e == null ? void 0 : e.text) || "").trim(), r = tn((e == null ? void 0 : e.viewType) || "narrative"), n = en(e == null ? void 0 : e.level), s = "detail", { base: i, min: a, max: l } = rn(t), c = String((e == null ? void 0 : e.grade) || "general").toLowerCase(), o = String((e == null ? void 0 : e.subject) || "general").toLowerCase(), h = ["\uB2F9\uC2E0\uC740 \uD559\uC2B5 \uCF58\uD150\uCE20\uB97C \uCC38\uACE0\uC11C/\uAD50\uACFC\uC11C \uC218\uC900\uC73C\uB85C \uC7AC\uAD6C\uC131\uD558\uB294 \uC9C0\uC2DD \uAD6C\uC870\uD654 \uC5D4\uC9C4\uC785\uB2C8\uB2E4.", `
[\uAD6C\uC870\uD654 \uD575\uC2EC \uC9C0\uCE68(\uAC15\uC81C)]
- \uD559\uC2B5 \uB2E8\uC704(Learning Unit):
...
__name2(an, "an");
function me(e, t) {
  const n = ze(e).map((i, a) => ({ s: i, i: a, score: an(i) }));
...
function on(e) {
  ...
  return t.forEach((s, i) => {
    const a = Ze("sec", i + 1), l = { id: a, title: s.title, type: "section", collapsed: false, children: [] }, c = me(s.body, 6), o = [];
    for (const m of c)
      (m.match(/[가-힣A-Za-z·/()]{2,20}/g) || []).slice(0, 8).forEach((A) => {
    ...
    w.length && b.children.push({ id: Ze(a + "_adv", 1), title: w.join(" "), type: "advanced", collapsed: true, children: [] }), l.children.push(b), r.children.push(l);
...
function cn(e, t, r, n) {
  ...
  }), l = n === "brief" ? 4 : n === "standard" ? 6 : 10, c = r.slice(0, l).map((u) => ({ term: u.term, def: Re(e, u.def, n) })), o = [];
  return o.push("\u2160. \uBAA9\uCC28"), s.forEach((u, h) => o.push(`  ${h + 1}. ${u}`)), o.push(""), o.push("\u2161. \uD575\uC2EC \uC815\uB9AC(\uC704\uACC4)"), a.forEach((u, h) => {
    var f;
    o.push(`  ${h + 1}. ${u.title}`), (f = u.key) != null && f.length && o.push(`     - \uD575\uC2EC\uD0A4\uC6CC\uB4DC: ${u.key.join(" \xB7 ")}`), u.summary && o.push(`     - \uC694\uC9C0: ${Re(e, u.summary, n)}`), o.push("");
...
__name2(dn, "dn");
function xt(e) {
  const t = ue(e), { tree: r, glossary: n } = on(t), s = { originalMeta: { textHash: st(t), chars: t.length, ts: ke() }, modes: {} };
  return ["detail", "standard", "brief"].forEach((i) => {
    const a = ln(t, i), l = cn(t, r, n, i), c = Ut(r, i), o = un(t), h = gt(t, a, i).ok ? a : Re(t, a, i), f = l.renderText || "", p = gt(t, f, i);
    l.renderText = p.ok ? f : Re(t, f, i), s.modes[i] = { narrative: h, structured: l, mindmap: { tree: c }, selftest: o };
  }), s;
}
__name(xt, "xt");
__name2(xt, "xt");
...
q.post("/api/engine", async (e) => {
  ...
  const i = String((t == null ? void 0 : t.grade) || "general"), a = String((t == null ? void 0 : t.subject) || "general"), l = (t == null ? void 0 : t.useGemini) === true, c = ue(r);
  if (c.length < 5)
    return e.json({ ok: false, error: "text_too_short", message: "\uC785\uB825\uC740 5\uC790 \uC774\uC0C1\uC774\uC5B4\uC57C \uD569\uB2C8\uB2E4." }, 400);
  let o = "v5-local", u;
  if (l && e.env.GEMINI_API_KEY)
    try {
      const A = nn({ text: c, viewType: s, level: "detail", grade: i, subject: a }), T = e.env.GEMINI_MODEL || "gemini-2.0-flash-exp", _ = await (await fetch(`https://generativelanguage.googleapis.com/v1beta/models/${T}:generateContent?key=${e.env.GEMINI_API_KEY}`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ contents: [{ parts: [{ text: A }] }], generationConfig: { temperature: 0.7, maxOutputTokens: 8192 } }) })).json(), $ = (((w = (x = (b = (g = (p = _ == null ? void 0 : _.candidates) == null ? void 0 : p[0]) == null ? void 0 : g.content) == null ? void 0 : b.parts) == null ? void 0 : x[0]) == null ? void 0 : w.text) || "").match(/\{[\s\S]*\}/);
      if ($) {
        const ee = JSON.parse($[0]);
        u = { originalMeta: { textHash: st(c), chars: c.length, ts: ke() }, modes: { detail: { [s]: ee }, standard: { [s]: ee }, brief: { [s]: ee } } }, o = "gemini-" + T;
      } else
        throw new Error("Gemini \uC751\uB2F5\uC744 JSON\uC73C\uB85C \uD30C\uC2F1\uD560 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.");
    } catch (A) {
      console.error("[Gemini Error]", A), u = xt(c), o = "v5-local-fallback";
    }
  else
    u = xt(c);
  const h = (E = (m = u.modes) == null ? void 0 : m[n]) == null ? void 0 : E[s], f = { engine: o, mode: n, viewType: s, ts: ke(), textHash: u.originalMeta.textHash, grade: i, subject: a };
...
q.post("/api/saveSummary", async (e) => {
  ...
  const a = String((r == null ? void 0 : r.id) || `s_${Date.now()}_${Math.random().toString(36).slice(2, 8)}`), l = ke(), c = st(s), o = JSON.stringify(i);
...
var yt = new Ft();
var hn = Object.assign({ "/src/index.tsx": q });
var Vt = false;
for (const [, e] of Object.entries(hn))
  e && (yt.route("/", e), yt.notFound(e.notFoundHandler), Vt = true);
if (!Vt)
...
function mn(e, t, r) {
  ...
  const i = ((g = e.rubric) == null ? void 0 : g.mustIncludeAny) || [], a = ((b = e.rubric) == null ? void 0 : b.mustIncludeAll) || [], l = ((x = e.rubric) == null ? void 0 : x.forbid) || [], c = (w = e.rubric) == null ? void 0 : w.maxChars;
  let o = 100, u = [];
  c && n.length > c && (o -= 15, u.push(`\uBD84\uB7C9 \uCD08\uACFC(-15): ${n.length}/${c}`)), l.length && vt(n, l) && (o -= 20, u.push("\uAE08\uC9C0 \uD0A4\uC6CC\uB4DC \uD3EC\uD568(-20)")), a.length && !fn(n, a) && (o -= 40, u.push("\uD544\uC218 \uC694\uC18C \uC77C\uBD80 \uB204\uB77D(-40)")), i.length && !vt(n, i) && (o -= 25, u.push("\uD575\uC2EC \uD0A4\uC6CC\uB4DC \uBBF8\uD3EC\uD568(-25)")), o = pn(o, 0, 100);
...
__name(vn, "vn");
__name2(vn, "vn");
var wn = Object.freeze(Object.defineProperty({ __proto__: null, buildFailReport: vn, ensureFailLogTable: Jt }, Symbol.toStringTag, { value: "Module" }));
...
// .wrangler/tmp/pages-OmDb72/ao5ryr00nyp.js
...
// .wrangler/tmp/bundle-NezAq6/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-NezAq6/middleware-loader.entry.ts
...
//# sourceMappingURL=ao5ryr00nyp.js.map
