...
// ../.wrangler/tmp/bundle-pkR8QH/checked-fetch.js
...
// ../.wrangler/tmp/bundle-pkR8QH/strip-cf-connecting-ip-header.js
...
var Lr = (Re = /* @__PURE__ */ __name(class {
  ...
  route(t, r) {
    ...
    return r.routes.map((s) => {
      var a;
      let i;
      r.errorHandler === Ot ? i = s.handler : (i = /* @__PURE__ */ __name(async (c, l) => (await kt([], r.errorHandler)(c, () => s.handler(c, l))).res, "i"), i[Pr] = s.handler), $(a = n, P, le).call(a, s.method, s.path, i);
    }), this;
  }
  basePath(t) {
...
// ../.wrangler/tmp/bundle-pkR8QH/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-pkR8QH/middleware-loader.entry.ts
...
//# sourceMappingURL=bundledWorker-0.1417503391167374.mjs.map
