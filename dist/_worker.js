...
**교육적 가치**
${m.detail["교육적 가치"]}`;const k={kind:s,mode:a,viewType:"narrative",narrative:y,allSummaries:{brief:m.brief,standard:m.standard,detail:m.detail},meta:m.meta};await De(n,h,c||"anon",k);let j;return o==="narrative"?j=k:o==="structured"?j={kind:s,mode:a,...Ct(y)}:o==="mindmap"?j={kind:s,mode:a,...Tt(y)}:j={kind:s,mode:a,...At(y)},await De(n,l,c||"anon",j),t.json({ok:!0,data:j,meta:{cached:!1,engine:"gemini-json-v3",elapsedMs:Date.now()-e}},200)}catch(m){console.error("[Gemini JSON Error]",m)}const P=xr(i,a,o);if(await De(n,l,c||"anon",P),P.narrative){const m={kind:"summary",mode:a,viewType:"narrative",narrative:P.narrative};await De(n,h,c||"anon",m)}return t.json({ok:!0,data:P,meta:{cached:!1,engine:"local",elapsedMs:Date.now()-e}},200)});ne.get("/health",t=>t.json({ok:!0,service:"MindStory v2 Revised"}));ne.notFound(t=>t.json({ok:!1,error:{code:"NOT_FOUND",message:"Route not found"}},404));const _t=new Xt,Cr=Object.assign({"/src/index.tsx":ne});let ln=!1;for(const[,t]of Object.entries(Cr))t&&(_t.route("/",t),_t.notFound(t.notFoundHandler),ln=!0);if(!ln)throw new Error("Can't import modules from ['/src/index.tsx','/app/server.ts']");export{_t as default};
