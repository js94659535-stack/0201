...
`)}function mt(t,e){const n=Qe.structured[e],r=(t.sections||[]).slice(0,n).map(c=>({...c,keywords:(c.keywords||[]).slice(0,e==="brief"?4:6),lvl25:(c.lvl25||[]).slice(0,e==="brief"?2:3),explain:String(c.explain||"").trim()})),s=e==="brief"?8:e==="standard"?14:20,i=(t.glossary||[]).slice(0,s),a=new Set(r.map(c=>c.id)),o=(t.links||[]).filter(c=>c.from==="A0"&&a.has(c.to));return{...t,sections:r,glossary:i,links:o}}function gt(t,e){const n=Qe.mindmap[e],r=(t.nodes||[]).slice(0,Math.max(0,n-1)),s=new Set(["C0",...r.map(a=>a.id)]),i=(t.edges||[]).filter(a=>s.has(a.from)&&s.has(a.to));return{...t,nodes:r,edges:i}}function xt(t,e){const n=Qe.selftest[e];return{questions:(t.questions||[]).slice(0,n)}}function yt(t,e){const n=Qe.narrative[e],i=lr(t.summary||"").slice(0,n).join(" "),a=(t.keyPoints||[]).slice(0,e==="brief"?3:4),o=(t.examHints||[]).slice(0,e==="brief"?2:3);return{...t,summary:i,keyPoints:a,examHints:o}}async function Ge(t,e){const n=async()=>{const o=await Zt(t,e);return String(o||"")},r=await n(),s=ft(r);if(s)return s;const i=await n(),a=ft(i);if(a)return a;throw new Error("MODEL_JSON_PARSE_FAILED")}async function xr(t,e){const n=await Ge(t,pr(e));if(!(n!=null&&n.anchor)||!Array.isArray(n.sections))throw new Error("STRUCTURED_SCHEMA_INVALID");n.links=n.links||n.sections.map(u=>({from:"A0",to:u.id,rel:"covers"}));const r=await Ge(t,fr(e,n));if(!(r!=null&&r.summary))throw new Error("NARRATIVE_SCHEMA_INVALID");const s=await Ge(t,mr(n));if(!(s!=null&&s.center)||!Array.isArray(s.nodes)||!Array.isArray(s.edges))throw new Error("MINDMAP_SCHEMA_INVALID");s.center.id||(s.center.id="C0");const i=await Ge(t,gr(n));if(!Array.isArray(i.questions))throw new Error("SELFTEST_SCHEMA_INVALID");const a={detail:n,standard:mt(n,"standard"),brief:mt(n,"brief")},o={detail:r,standard:yt(r,"standard"),brief:yt(r,"brief")},c={detail:s,standard:gt(s,"standard"),brief:gt(s,"brief")},l={detail:i,standard:xt(i,"standard"),brief:xt(i,"brief")};return{structured:a,narrative:o,mindmap:c,selftest:l}}function Qt(t){if(!t)return"empty";let e=2166136261,n=0;for(let i=0;i<t.length;i++){const a=t.charCodeAt(i);e^=a,e+=(e<<1)+(e<<4)+(e<<7)+(e<<8)+(e<<24),n=(n<<5)-n+a,n|=0}const r=(e>>>0).toString(16),s=(Math.abs(n)>>>0).toString(16);return`${t.length.toString(16)}_${r}_${s}`}function yr(t,e,n,r){const s=Qt(n);return`${t}::${r||"anon"}::${e}::base::${s}`}function vr(t,e,n,r,s){const i=Qt(r);return`${t}::${s||"anon"}::${e}::${n}::${i}`}async function br(t){if(!nt){if(!t){nt=!0;return}await t.prepare(`CREATE TABLE IF NOT EXISTS summary_cache (
     ...
     VALUES (?,?,?,?)`).bind(e,n,JSON.stringify(r),Vt()).run()}async function wr(t,e){var c,l,u,h,g;const n=D(t.GEMINI_API_KEY).trim();if(!n)throw new Error("GEMINI_API_KEY is missing");const r=D(t.GEMINI_MODEL).trim()||"gemini-1.5-flash",s=`https://generativelanguage.googleapis.com/v1beta/models/${encodeURIComponent(r)}:generateContent?key=${encodeURIComponent(n)}`,i={contents:[{role:"user",parts:[{text:e}]}],generationConfig:{temperature:.3,topP:.9,maxOutputTokens:2048,topK:40},safetySettings:[{category:"HARM_CATEGORY_HARASSMENT",threshold:"BLOCK_NONE"},{category:"HARM_CATEGORY_HATE_SPEECH",threshold:"BLOCK_NONE"},{category:"HARM_CATEGORY_SEXUALLY_EXPLICIT",threshold:"BLOCK_NONE"},{category:"HARM_CATEGORY_DANGEROUS_CONTENT",threshold:"BLOCK_NONE"}]};let a=0,o=500;for(;a<3;){a++;const v=await fetch(s,{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify(i)});if(v.ok){const C=await v.json();return{ok:!0,text:((g=(h=(u=(l=(c=C==null?void 0:C.candidates)==null?void 0:c[0])==null?void 0:l.content)==null?void 0:u.parts)==null?void 0:h[0])==null?void 0:g.text)??"",raw:C}}if(v.status===429||v.status===503){await new Promise(C=>setTimeout(C,o)),o*=2;continue}const T=await v.text().catch(()=>"");throw new Error(`Gemini error ${v.status}: ${T.slice(0,200)}`)}throw new Error("Gemini retry exceeded")}async function Er(t,e,n){var l,u,h,g,v;const r=D(t.GEMINI_API_KEY).trim();if(!r)throw new Error("GEMINI_API_KEY is missing");const s=D(t.GEMINI_MODEL).trim()||"gemini-1.5-flash",i=`https://generativelanguage.googleapis.com/v1beta/models/${encodeURIComponent(s)}:generateContent?key=${encodeURIComponent(r)}`,a={system_instruction:{parts:[{text:e}]},contents:[{role:"user",parts:[{text:n}]}],generationConfig:{temperature:.3,topP:.9,maxOutputTokens:2048,topK:40},safetySettings:[{category:"HARM_CATEGORY_HARASSMENT",threshold:"BLOCK_NONE"},{category:"HARM_CATEGORY_HATE_SPEECH",threshold:"BLOCK_NONE"},{category:"HARM_CATEGORY_SEXUALLY_EXPLICIT",threshold:"BLOCK_NONE"},{category:"HARM_CATEGORY_DANGEROUS_CONTENT",threshold:"BLOCK_NONE"}]};let o=0,c=500;for(;o<3;){o++;const T=await fetch(i,{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify(a)});if(T.ok){const S=await T.json();return((v=(g=(h=(u=(l=S==null?void 0:S.candidates)==null?void 0:l[0])==null?void 0:u.content)==null?void 0:h.parts)==null?void 0:g[0])==null?void 0:v.text)??""}if(T.status===429||T.status===503){await new Promise(S=>setTimeout(S,c)),c*=2;continue}const C=await T.text().catch(()=>"");throw new Error(`Gemini error ${T.status}: ${C.slice(0,200)}`)}throw new Error("Gemini retry exceeded")}async function Zt(t,e){const n=await wr(t,e);return typeof n=="string"?n:((n==null?void 0:n.text)??"").toString()}const Sr=(()=>{const e={brief:{min:.1,max:.15},standard:{min:.25,max:.3},detail:{min:.45,max:.55}},n={brief:6,standard:10,detail:14},r=["narrative","structured","mindmap"],s=["preview","exam"];function i(b){return(b||"").replace(/\s+/g,"")}function a(b,f){const x=Math.max(200,i(b||"").length),y=e[f]||e.standard,m=Math.floor(x*y.min),O=Math.ceil(x*y.max);return{base:x,min:Math.max(80,m),max:Math.max(120,O)}}function o(b){const f=(b||"").trim();return f?f.replace(/\r/g,"").split(new RegExp("(?<=[\\.\\?\\!])\\s+|\\n+")).map(x=>x.trim()).filter(Boolean):[]}function c(b){return o(b).map((p,x)=>({sid:`S${x+1}`,text:p}))}function l(b,f,p){const x=b.find(y=>y.sid===f);return!x||!p||typeof p!="string"?!1:x.text.includes(p.trim())}function u(){return["당신은 교육공학 기반 요약·셀프테스트 생성 엔진이다.","추출형 복붙 금지. 반드시 의미 단위로 재구성하라.","가장 중요한 1순위는 문자수(공백 제외) 제한 준수다.","허위 정보(원문/요약에 없는 내용) 생성 금지.","JSON 출력이 요구되면 JSON만 출력하라."].join(`
`)}function h({originalText:b,mode:f,format:p}){const x=a(b,f),y=rr(b),m=p==="narrative"?"서술형: 연결어를 사용해 흐름/인과가 보이도록 1~3문단으로 구성":p==="structured"?"구조화: 상위-하위 위계가 드러나는 조목(가/나/다 또는 ①②③) 형태":"마인드맵: 텍스트로 표현된 노드-관계 목록(중심노드/하위노드/연결라벨) 형태";return["[TASK] 아래 학술 논문을 생성적 요약(Abstractive Summarization) 방식으로 지정된 형식에 맞춰 요약하라.",`- 모드: ${f} (간단/표준/상세)`,`- 형식: ${p} (${m})`,`- 문자수 목표(공백 제외): 최소 ${x.min}자 ~ 최대 ${x.max}자`,"","[🔹 C. 논문형 텍스트 전용 요약 구조 - 반드시 준수]","이 텍스트는 학술 논문입니다.","요약 시 반드시 다음 순서를 유지하세요:","1. 연구 목적 (무엇을 연구했는가?)","2. 연구 설계 및 방법 (어떻게 연구했는가?)","3. 핵심 결과 (무엇을 발견했는가?)","4. 결과 해석 (결과가 의미하는 바는?)","5. 교육적 의의 (실무/교육에 어떤 시사점을 주는가?)","각 단계는 1문단 이상을 넘지 마세요.","","[요약 품질 규칙]","1. 단순 추출/복붙 금지: 원문 문장을 그대로 나열하지 말고 생성적으로 재구성하여 매끄러운 글 작성","2. 텍스트 정제: 페이지 번호(p.XX), 각주, 특수기호, 질문형 문장 제거 → 학술적 평서문으로 전환","3. 스마트 편집: 중복 표현 통합, 전문 용어 일관성 유지, 한 문장 2줄 이내로 단문 위주","4. 퀴즈 연동: 핵심 키워드와 인과관계를 문장 내에 전략적으로 배치 (퀴즈 앵커 확보)","5. 할루시네이션 금지: 원문에 없는 주장/사례/인과/수치 추가 절대 금지","6. 🔹 B. 결과 단독 발췌 금지: 간단 모드에서는 DLPFC, VLPFC, OFC 등 세부 뇌 영역 명칭 사용 금지","","[비율 엄수]","- 간단 10~15%, 표준 25~30%, 상세 45~55% 글자수 비율은 절대적 기준","- 상세 요약이 표준보다 짧아지는 역전 현상 금지","- 각 단계마다 정보의 깊이와 양을 계층적으로 명확히 차별화","","[ORIGINAL]",y].join(`
`)}function g({summaryText:b,format:f}){return["[TASK] 아래 요약문에서 학습 앵커(핵심 개념/관계)를 추출하라.","- 출력은 JSON만. 한국어로.","- 앵커 수: 6~14개 범위(요약 길이에 맞춰 적절히).","- 각 앵커는 요약문에 실제로 등장하는 표현을 근거(quote)로 가져와야 한다.","- quote는 요약문 일부를 그대로 복사(짧게 8~25자).","","[OUTPUT JSON SCHEMA]",`{
  "anchors":[
    {
      "id":"A1",
      "label":"핵심 개념/관계 이름",
...
`)}function v({mode:b,purpose:f,format:p,summaryText:x,sentTable:y,anchors:m}){const O=n[b]||10,R=f==="preview"?"예습용 셀프테스트: 요약문 안에서 바로 확인 가능한 재인 중심(스키마 형성). 과도한 추론 금지.":"시험대비 셀프테스트: 요약문에 있는 근거를 바탕으로 인과/관계/분류를 인출하는 회상 중심. 요약에 없는 정보 금지.",G=p==="narrative"?"문항 스타일: 문장 빈칸, 문장 순서 배열, 인과관계 단답/서술(요약 근거 필수)":p==="structured"?"문항 스타일: 항목-정의 매칭, 분류 채우기, 상하위 체계, 사례-범주 매칭(요약 근거 필수)":"문항 스타일: 노드 라벨 맞추기, 연결 라벨링, 누락 노드/연결 복원, 관계 이유 단답(요약 근거 필수)";return["[TASK] 아래 요약문과 앵커만을 근거로 셀프테스트 문항을 생성하라.",`- 모드: ${b} (문항수 ${O})`,`- 목적: ${f} (${R})`,`- 요약 형식: ${p} (${G})`,"- 규칙1: 요약문에 없는 정보로 문제 만들지 말 것(할루시네이션 금지).","- 규칙2: 각 문항은 반드시 evidence를 포함: sid + quote(요약 문장 일부 8~25자).","- 규칙3: quote는 반드시 해당 sid 문장에 실제로 포함되어야 한다.","- 규칙4: 정답/해설은 간결하게. 해설은 evidence와 연결되게.","","[OUTPUT JSON ONLY]",`{
  "items":[
    {
      "id":"Q1",
...
}`,"","[SUMMARY SENTENCES WITH ID]",JSON.stringify(y,null,2),"","[ANCHORS]",JSON.stringify(m,null,2),"","[SUMMARY]",x].join(`
`)}function T(b,f){const p=f&&f.anchors?f.anchors:[],x=[],y=[];for(const m of p){const O=m==null?void 0:m.sid,R=m==null?void 0:m.quote;if(typeof(m==null?void 0:m.label)!="string"||!m.label.trim()){y.push({a:m,reason:"label missing"});continue}if(!l(b,O,R)){y.push({a:m,reason:"evidence not in sentence"});continue}x.push(m)}return{ok:x,bad:y}}function C(b,f){const p=f&&Array.isArray(f.items)?f.items:[],x=[],y=[];for(const m of p){const O=m==null?void 0:m.evidence;if(!(m!=null&&m.id)||!(m!=null&&m.question)||!(m!=null&&m.answer)||!(O!=null&&O.sid)||!(O!=null&&O.quote)){y.push({q:m,reason:"missing fields"});continue}if(!l(b,O.sid,O.quote)){y.push({q:m,reason:"evidence not in sentence"});continue}if(Array.isArray(m.choices)&&m.choices.length>0&&!m.choices.includes(m.answer)){y.push({q:m,reason:"answer not in choices"});continue}x.push(m)}return{ok:x,bad:y}}function S({summaryText:b,sentTable:f,anchors:p,badItems:x,mode:y,purpose:m,format:O}){return["[TASK] 아래는 검증에서 탈락한 문항들이다. 요약문 근거(sid+quote)를 만족하도록 문항을 다시 생성하라.",`- 재생성 문항 수: ${x.length}`,`- 모드: ${y}, 목적: ${m}, 형식: ${O}`,"- 규칙: 요약문 밖 정보 금지. 반드시 sid+quote가 실제로 해당 문장에 포함되어야 한다.","- 출력: JSON만. items 길이는 정확히 재생성 문항 수와 같아야 한다.","","[OUTPUT JSON ONLY]",'{"items":[{ "id":"Qx","type":"blank|match|order|label|short|mcq","question":"...","choices":[],"answer":"...","explanation":"...","evidence":{"sid":"S1","quote":"..." },"anchorIds":["A1"] }]}',"","[SUMMARY SENTENCES WITH ID]",JSON.stringify(f,null,2),"","[ANCHORS]",JSON.stringify(p,null,2),"","[BAD ITEMS]",JSON.stringify(x,null,2),"","[SUMMARY]",b].join(`
`)}async function N({llmCall:b,originalText:f,mode:p,format:x}){if(!b)throw new Error("llmCall is required");e[p]||(p="standard"),r.includes(x)||(x="narrative");const y=h({originalText:f,mode:p,format:x}),m=(await b({system:u(),user:y,json:!1})||"").trim()||"",O=c(m),R=g({summaryText:m,format:x});let G=await b({system:u(),user:R,json:!0}),K;try{K=JSON.parse(G)}catch{K={anchors:[]}}const{ok:M}=T(O,K),he=M.length>=4?M:q(O);return{summaryText:m,sentTable:O,anchors:he}}function q(b){const f=[];for(let p=0;p<Math.min(8,b.length);p++){const x=b[p],y=(x.text||"").slice(0,18);f.push({id:`A${p+1}`,label:`문장 핵심${p+1}`,type:"claim",sid:x.sid,quote:y,note:"요약 문장 기반 안전 앵커"})}return f}async function L({llmCall:b,mode:f,purpose:p,format:x,summaryText:y,sentTable:m,anchors:O}){e[f]||(f="standard"),s.includes(p)||(p="preview"),r.includes(x)||(x="narrative");const R=v({mode:f,purpose:p,format:x,summaryText:y,sentTable:m,anchors:O});let G=await b({system:u(),user:R,json:!0}),K;try{K=JSON.parse(G)}catch{K={items:[]}}let{ok:M,bad:he}=C(m,K);if(he.length>0){const re=S({summaryText:y,sentTable:m,anchors:O,badItems:he.map(on=>on.q),mode:f,purpose:p,format:x});let k=await b({system:u(),user:re,json:!0}),j;try{j=JSON.parse(k)}catch{j={items:[]}}const sn=C(m,j);M=M.concat(sn.ok);const an=n[f]||10;M=M.slice(0,an)}else{const re=n[f]||10;M=M.slice(0,re)}const we=n[f]||10;if(M.length<we){const re=z({sentTable:m,anchors:O,count:we-M.length,format:x,purpose:p});M=M.concat(re).slice(0,we)}return{items:M}}function z({sentTable:b,anchors:f,count:p,format:x,purpose:y}){const m=[],O=f.slice(0,Math.max(p,1));for(let R=0;R<p;R++){const G=O[R%O.length],K=G.sid,M=G.quote;m.push({id:`QF${R+1}`,type:"short",question:y==="preview"?`요약에서 '${M}'가 의미하는 핵심 개념을 한 문장으로 말해보세요.`:`요약에서 '${M}'가 포함된 문장의 핵심 인과/관계를 한 문장으로 인출해보세요.`,choices:[],answer:"(서술형 정답: 사용자 입력 비교는 해설 기반 채점 또는 키워드 채점으로 처리)",explanation:"근거 문장을 다시 읽고 핵심을 1문장으로 재구성하면 됩니다.",evidence:{sid:K,quote:M},anchorIds:[G.id]})}return m}class I{constructor(f,{passScore:p=90}={}){this.items=Array.isArray(f)?f:[],this.passScore=p,this.state={idx:0,attempts:1,correct:0,wrongIds:new Set,finished:!1}}gradeAnswer(f,p){if(!f)return{ok:!1,reason:"no item"};const x=f.type;if(x==="mcq"||x==="blank"||x==="match"||x==="order"||x==="label"||x==="short"){if(x==="short")return{ok:!0,reason:"short-auto-pass"};const y=(f.answer||"").trim(),m=(p||"").trim();return{ok:m===y,reason:m===y?"match":"mismatch"}}return{ok:!1,reason:"unknown type"}}getScore(){return this.items.length===0?0:Math.round(this.state.correct/this.items.length*100)}currentItem(){return this.items[this.state.idx]||null}submit(f){if(this.state.finished)return{done:!0,message:"already finished"};const p=this.currentItem();if(this.gradeAnswer(p,f).ok)return this.state.correct+=1,this.next(),{ok:!0,message:"정답 처리",score:this.getScore()};if(this.state.wrongIds.add(p.id),this.state.attempts===1)return this.state.attempts=2,{ok:!1,stage:1,hint:`힌트1: 근거 문장(${p.evidence.sid})을 다시 읽어보세요.`,score:this.getScore()};if(this.state.attempts===2)return this.state.attempts=3,{ok:!1,stage:2,hint:`힌트2: 근거 구절 = '${p.evidence.quote}'`,score:this.getScore()};{const y=p.explanation||"해설 없음";return this.next(),{ok:!1,stage:3,explanation:y,score:this.getScore()}}}next(){if(this.state.idx+=1,this.state.attempts=1,this.state.idx>=this.items.length)if(this.getScore()>=this.passScore)this.state.finished=!0;else{const p=this.items.filter(x=>this.state.wrongIds.has(x.id));this.items=p.length>0?p:this.items,this.state.idx=0,this.state.attempts=1,this.state.correct=0,this.state.wrongIds=new Set}}status(){return{idx:this.state.idx,total:this.items.length,score:this.getScore(),passScore:this.passScore,finished:this.state.finished}}}async function ne({llmCall:b,originalText:f,mode:p,format:x,purpose:y}){const m=await N({llmCall:b,originalText:f,mode:p,format:x}),O=await L({llmCall:b,mode:p,purpose:y,format:x,summaryText:m.summaryText,sentTable:m.sentTable,anchors:m.anchors});return{summary:{mode:p,format:x,text:m.summaryText,sentences:m.sentTable,anchors:m.anchors},selfTest:{purpose:y,passScore:90,items:O.items}}}return{computeCharTargets:a,splitSentencesKR:o,makeSentenceTable:c,generateBundle:N,generateSelfTest:L,runPipeline:ne,MasteryRunner:I}})(),Tr=`/* MindStory Engine Bundle (compat) */
(function(){
...
</html>`));X.get("/api/health",t=>{const e=!!D(t.env.GEMINI_API_KEY).trim(),n=D(t.env.USE_MOCK).trim().toLowerCase()==="true";return t.json({ok:!0,ts:Vt(),hasDB:!!t.env.DB,hasGeminiKey:e,engineMode:e&&!n?"gemini+fallback":"local-only"})});X.post("/api/gens/run",async t=>{const e=Date.now();let n=null;try{n=await t.req.json()}catch{return t.json({ok:!1,error:{code:"BAD_JSON",message:"요청 JSON이 올바르지 않습니다."}},400)}const r=D((n==null?void 0:n.text)||(n==null?void 0:n.originalText)||""),s=Xt((n==null?void 0:n.mode)||"standard"),i=Wt((n==null?void 0:n.format)||(n==null?void 0:n.viewType)||"narrative"),a=D((n==null?void 0:n.purpose)||"preview").trim().toLowerCase();if(!r)return t.json({ok:!1,error:{code:"NO_TEXT",message:"원문 텍스트가 필요합니다."}},400);const o=!!D(t.env.GEMINI_API_KEY).trim(),c=D(t.env.USE_MOCK).trim().toLowerCase()==="true";if(!o||c)return t.json({ok:!1,error:{code:"GEMINI_REQUIRED",message:"GENS Engine은 Gemini API가 필요합니다. .dev.vars에 GEMINI_API_KEY를 설정하세요."},guide:{step1:".dev.vars 파일 생성",step2:"GEMINI_API_KEY=your_api_key_here 추가",step3:"서비스 재시작: pm2 restart webapp"}},503);const l=async({system:u,user:h,json:g})=>{if(g){const v=`${u}

${h}

출력은 반드시 JSON만 출력하라. 다른 텍스트 금지.`;return await Zt(t.env,v)}else return(await Er(t.env,u,h)||"").toString()};try{const u=await Sr.runPipeline({llmCall:l,originalText:r,mode:s,format:i,purpose:a==="exam"?"exam":"preview"});return t.json({ok:!0,data:u,meta:{engine:"gens-v3",mode:s,format:i,purpose:a,elapsedMs:Date.now()-e}},200)}catch(u){return console.error("[GENS Engine Error]",u),t.json({ok:!1,error:{code:"GENS_ERROR",message:u.message||"GENS 엔진 오류",details:u.stack}},500)}});X.post("/api/engine",async t=>{var b;const e=Date.now(),n=t.env.DB;await br(n);let r=null;try{r=await t.req.json()}catch{return t.json({ok:!1,error:{code:"BAD_JSON",message:"요청 JSON이 올바르지 않습니다."}},400)}const s=cr(r==null?void 0:r.kind),i=D((r==null?void 0:r.text)||""),a=Xt((r==null?void 0:r.mode)||(r==null?void 0:r.level)),o=Wt((r==null?void 0:r.viewType)||(r==null?void 0:r.displayMode)),c=D(((b=r==null?void 0:r.options)==null?void 0:b.userId)||(r==null?void 0:r.userId)||"anon");if(!i.trim()||i.trim().length<5)return t.json({ok:!1,error:{code:"NO_TEXT",message:"입력 텍스트가 없습니다."}},200);const l=or(i),u=l.text,h=l.sentences;console.log("[Sanitize] Original length:",i.length,"→ Cleaned:",u.length),console.log("[Sanitize] Sentences extracted:",h.length);const g=vr(s,a,o,u,c||null),v=await vt(n,g);if(v.hit)return t.json({ok:!0,data:v.data,meta:{cached:!0,cacheStore:v.store,cacheType:"derived",engine:"cache",elapsedMs:Date.now()-e}},200);const T=yr(s,a,u,c||null),C=await vt(n,T);if(C.hit&&C.data&&o==="narrative"){let f;if(C.data.allSummaries&&C.data.allSummaries[a]?f=C.data.allSummaries[a]:C.data.narrative?f=C.data.narrative:console.warn("[Cache] Base cache has no narrative, skipping"),f){const p={kind:s,mode:a,viewType:o,narrative:f};return await je(n,g,c||"anon",p),t.json({ok:!0,data:p,meta:{cached:!0,cacheStore:"derived",cacheType:"base-narrative",engine:"cache",elapsedMs:Date.now()-e}},200)}}const S=!!D(t.env.GEMINI_API_KEY).trim(),N=D(t.env.USE_MOCK).trim().toLowerCase()==="true";if(s==="summary"&&S&&!N)try{const f=await xr(t.env,u),p=dr(a),x=ur(o);let y;if(x==="structured")y={kind:s,mode:a,viewType:o,...f.structured[p]};else if(x==="mindmap")y={kind:s,mode:a,viewType:o,...f.mindmap[p]};else if(x==="selftest")y={kind:s,mode:a,viewType:o,...f.selftest[p]};else{const R=f.narrative[p];y={kind:s,mode:a,viewType:o,title:R.title,narrative:R.summary,keyPoints:R.keyPoints,examHints:R.examHints}}const m=f.narrative[p],O={kind:s,mode:a,viewType:"narrative",narrative:m.summary,allSummaries:{brief:f.narrative.brief.summary,standard:f.narrative.standard.summary,detail:f.narrative.detail.summary},meta:{engine:"v4",hierarchy:"brief ⊂ standard ⊂ detail (server-downsample)",structuredFirst:!0}};return await je(n,T,c||"anon",O),await je(n,g,c||"anon",y),t.json({ok:!0,data:y,meta:{cached:!1,engine:"gemini-v4-structured-first",elapsedMs:Date.now()-e,hierarchy:"brief ⊂ standard ⊂ detail (guaranteed)"}},200)}catch(f){console.error("[Gemini V4 Error]",f)}const{buildAllSummariesV4_Quality:q}=await Promise.resolve().then(()=>Pr),L=q(u),z=L[a]||L.standard;let I;o==="narrative"?I={kind:s,mode:a,viewType:o,narrative:z.narrative}:o==="structured"?I={kind:s,mode:a,viewType:o,structured:z.structured}:o==="mindmap"?I={kind:s,mode:a,viewType:o,mindmap:z.mindmap}:o==="selftest"&&(I={kind:s,mode:a,viewType:o,selftest:z.selftest}),await je(n,g,c||"anon",I);const ne={kind:"summary",mode:a,viewType:"narrative",narrative:z.narrative,allSummaries:{brief:L.brief.narrative,standard:L.standard.narrative,detail:L.detail.narrative}};return await je(n,T,c||"anon",ne),t.json({ok:!0,data:I,meta:{cached:!1,engine:"quality-v4.2",elapsedMs:Date.now()-e,features:["압축률 강제 (중간 절단 금지)","구조화: 논지/대립/현황/괴리/변천/시사점","마인드맵: 노드 단위 축약","brief ⊂ standard ⊂ detail 강제"]}},200)});X.get("/health",t=>t.json({ok:!0,service:"MindStory v2 Revised"}));X.notFound(t=>t.json({ok:!1,error:{code:"NOT_FOUND",message:"Route not found"}},404));const bt=new Ut,Ar=Object.assign({"/src/index.tsx":X});let en=!1;for(const[,t]of Object.entries(Ar))t&&(bt.route("/",t),bt.notFound(t.notFoundHandler),en=!0);if(!en)throw new Error("Can't import modules from ['/src/index.tsx','/app/server.ts']");function wt(t,e,n){return Math.max(e,Math.min(n,t))}function at(t){return(t||"").replace(/\s+/g,"").length}function ue(t){return(t||"").replace(/[ \t]{2,}/g," ").replace(/\s+([,.;:!?])/g,"$1").trim()}function Cr(t,e){return`${t}_${e.toString(36)}`}function tn(t){if(!t)return"";let e=String(t);return e=e.replace(/\uFEFF/g,"").replace(/[\u200B-\u200D\u2060]/g,"").replace(/[\x00-\x08\x0B\x0C\x0E-\x1F]/g," "),e=e.replace(/(?:^|\n)\s*[-–—]?\s*\d{1,4}\s*[-–—]?\s*(?=\n|$)/g,`
`),e=e.replace(/([A-Za-z])-\s*\n\s*([A-Za-z])/g,"$1$2"),e=e.replace(/([가-힣0-9])\s*\n\s*([가-힣0-9])/g,"$1$2"),e=e.replace(/[「『〈《]/g,'"').replace(/[」』〉》]/g,'"'),e=e.replace(/\n{3,}/g,`

`),e=e.replace(/[ \t]{2,}/g," "),e.trim()}function Et(t){const e=(t||"").trim();if(!e)return[];const n=e.split(/\n{2,}/g),r=[];for(const s of n){const i=s.replace(/\n/g," ").replace(/[ \t]{2,}/g," ").trim();if(!i)continue;const a=i.split(new RegExp("(?<=[.?!])\\s+|(?<=(?:이다|된다|한다|있다|없다|말한다|주장한다)\\.)\\s+","g"));for(const o of a){const c=ue(o);c&&r.push(c)}}return r}function Or(t){const e=(t||"").trim();return!!(!e||e.length<12&&!(/[.?!]$/.test(e)||/(?:이다|된다|한다|있다|없다|말한다|주장한다)\.?$/.test(e))||/^["")\]\}]+$/.test(e)||/^["(\[\{]+$/.test(e)||/^(?:\(\d+\)|\d+\)|[①-⑳])\s*["")\]]*\s*$/.test(e)||/(완전\s*정복|쏙쏙|콕콕|실력을\s*쑥쑥|고득점|특강|전문\s*대비)/.test(e)&&(/[""]/.test(e)||/!$/.test(e)))}function St(t){const e=[],n=new Set;for(const r of t){const s=ue(r);if(!s||Or(s))continue;const i=s.replace(/\s+/g," ");n.has(i)||(n.add(i),e.push(i))}return e}function _r(t){const e=/(^|\n)\s*(\d+\.\d+)\.\s*([^\n]+)\n?/g,n=[];let r;for(;(r=e.exec(t))!==null;)n.push({idx:r.index,key:r[2],title:ue(r[3])});if(n.length===0)return[{key:"all",title:"본문",text:t}];const s=[];for(let i=0;i<n.length;i++){const a=n[i],o=n[i+1],c=a.idx,l=o?o.idx:t.length;s.push({key:a.key,title:a.title,text:t.slice(c,l).trim()})}return s}function kr(t){let e=1;/(교육부|공교육|정상화|사교육|입시|내신|대입|고입)/.test(t)&&(e+=2),/(방해|요인|우려|격차|부정적|증폭|현실)/.test(t)&&(e+=1.5),/(반해|반면|하지만|그러나|이에\s*반해)/.test(t)&&(e+=1.5),/(목표|역점|능력|국제|문화|듣기|말하기)/.test(t)&&(e+=1.2),/(현황|방법|프로그램|평가|설명회|학원|교육비|기숙)/.test(t)&&(e+=1),/(변천|과정|비율|가산점|전형|선발\s*시험)/.test(t)&&(e+=1.6);const n=at(t);return n>180&&(e-=.6),n>260&&(e-=1),e}function nn(t){let e=ue(t);return e=e.replace(/\([^)]*\d{4}[^)]*\)/g,"").trim(),e=e.replace(/"([^"]{60,})"/g,'"(인용문 요지)"'),e=e.replace(/본수업/g,"본 수업"),e=e.replace(/국력신장/g,"국력 신장"),e=e.replace(/내신대비/g,"내신 대비"),e=e.replace(/지원현황/g,"지원 현황"),e=e.replace(/또한출판/g,"또한 출판"),e=e.replace(/그리고입과/g,"그리고 고입과"),e=e.replace(/통한대비/g,"통한 대비"),/[.?!]$/.test(e)||(e+="."),ue(e)}function se(t,e,n){return t.map((s,i)=>({id:Cr(n,i),text:s,score:kr(s)})).sort((s,i)=>i.score-s.score).slice(0,e).map(s=>({id:s.id,text:nn(s.text),score:s.score}))}function Nr(t){var ne,b,f,p,x,y,m,O,R,G,K,M,he,we,re;const e=_r(t),n={};for(const k of e)n[k.key]=St(Et(k.text));const r=St(Et(t)),s=(ne=e[0])!=null&&ne.title?ue(e[0].title):"선행학습 구조화",i=r.filter(k=>/(정의|개념|선행학습|학습활동|교육과정)/.test(k)),a=r.filter(k=>/(쟁점|관점|차이|주장|해석|입장)/.test(k)),o=se(i.length?i:r,2,"def"),c=se(a.length?a:r,2,"issue"),l=r.filter(k=>/(교육부|공교육|정상화|우려|부정적|방해|격차|참여도|태도|창의|인성|전인교육)/.test(k)),u=se(l.length?l:r,4,"min"),h=r.filter(k=>/(사교육|학원|예습|효율|성과|긍정|흥미|자신감|구분|조력|대비)/.test(k)),g=se(h.length?h:r,3,"pri"),v=(b=n["2.2"])!=null&&b.length?n["2.2"]:r.filter(k=>/(목표|역점|듣기|말하기|일상|국제|이해|능력)/.test(k)),T=r.filter(k=>/(현실|성취|성적|고입|대입|전환)/.test(k)),C=se(v.length?v:r,2,"goal"),S=se(T.length?T:r,2,"rgoal"),N=((f=n["2.3"])!=null&&f.length?n["2.3"]:r).filter(k=>/(현황|방법|설명회|프로그램|평가|교육비|특강|기숙|방학|시험대비|내신|인증시험|운영|비용|강도)/.test(k)),q=se(N.length?N:r,4,"rea"),L=(p=n["2.4"])!=null&&p.length?n["2.4"]:r.filter(k=>/(변천|과정|비율|가산점|내신|추세|반영|영어|비중|확대)/.test(k)),z=se(L.length?L:r,2,"pol"),I={title:s,children:[{title:"정의·쟁점",type:"question",collapsed:!1,children:[{title:"선행학습 정의",type:"keyword",pack:["정규과정 이전","미리 학습","학습과정"],explain:((x=o[0])==null?void 0:x.text)||"교육부 기준 선행학습은 정규 교육과정보다 앞서 미리 학습하는 모든 학습활동을 뜻한다.",collapsed:!1,children:[]},{title:"쟁점(관점 차이)",type:"keyword",pack:["국가","학생·학부모","사교육"],explain:((y=c[0])==null?void 0:y.text)||"선행학습의 성격과 영향에 대해 국가·학생/학부모·사교육이 서로 다른 주장과 해석을 제시한다.",collapsed:!1,children:[]}]},{title:"교육부 관점",type:"question",collapsed:!1,children:u.length>0?u.slice(0,4).map((k,j)=>({title:["공교육 정상화 저해","전인교육 저해·사교육 증폭","영어 태도 조기 고착 우려","학습격차·수업참여 악영향"][j]||`관점 ${j+1}`,type:"keyword",pack:[["공교육 방해","정상화 저해","핵심 요인"],["창의·인성","전인교육","사교육 관행"],["호오 조기결정","자신감 과잉","무력감"],["수준 격차","태도","참여도"]][j]||[],explain:k.text,collapsed:!1,children:[]})):[{title:"공교육 정상화 저해",type:"keyword",pack:["공교육 방해","정상화 저해","핵심 요인"],explain:((m=r[0])==null?void 0:m.text)||"교육부는 선행학습이 공교육 정상화를 방해하는 요인으로 본다.",collapsed:!1,children:[]}]},{title:"사교육 관점",type:"question",collapsed:!1,children:g.length>0?g.slice(0,3).map((k,j)=>({title:["예습과 선행학습 구분 주장","예습의 효과 강조","현장의 선행학습 실태(모순)"][j]||`관점 ${j+1}`,type:"keyword",pack:[["예습≠선행","대비","조력"],["수업 성과","효율","흥미·자신감"],["고학년 교재","방학·특강","실질 선행"]][j]||[],explain:k.text,collapsed:!1,children:[]})):[{title:"예습과 선행학습 구분",type:"keyword",pack:["예습","수업 대비","조력"],explain:((O=r[1])==null?void 0:O.text)||((R=r[0])==null?void 0:R.text)||"사교육은 예습과 선행학습을 구분한다.",collapsed:!1,children:[]}]},{title:"목표(교육부 vs 현실)",type:"question",collapsed:!1,children:[{title:"1998 영어교육 목표",type:"keyword",pack:["듣기·말하기","일상영어","국제이해"],explain:((G=C[0])==null?void 0:G.text)||"교육부(1998)는 음성언어 중심(듣기·말하기)과 일상생활 영어 사용 능력, 국제사회·외국문화 이해 및 국가 발전 기여를 목표로 제시했다.",collapsed:!1,children:[]},{title:"현실 목표의 전환",type:"keyword",pack:["성취·성적","고입","대입"],explain:((K=S[0])==null?void 0:K.text)||"현장에서는 교육 목표와 달리 학업 성취·성적 향상, 고입·대입 대비가 학습의 중심 목표로 작동하는 경향이 있다.",collapsed:!1,children:[]}]},{title:"방법·현황(사례)",type:"question",collapsed:!1,children:q.length>0?q.slice(0,4).map((k,j)=>({title:["시험대비 프로그램(초등 A학원)","내신·인증시험 집중(어학 B·C학원)","운영·비용·강도","기숙형 선행학습(방학 30일 내외)"][j]||`방법 ${j+1}`,type:"keyword",pack:[["단원평가","서술형 특강","성취도 평가"],["중등 내신","인증시험","L/S/R/W"],["주5회","주말 특강","자습 운영"],["교육청 연계","기숙","스파르타식"]][j]||[],explain:k.text,collapsed:!1,children:[]})):[{title:"시험대비 프로그램",type:"keyword",pack:["프로그램","특강","평가"],explain:((M=r[2])==null?void 0:M.text)||((he=r[0])==null?void 0:he.text)||"시험 대비 프로그램과 특강이 운영된다.",collapsed:!1,children:[]}]},{title:"변천(입시 반영 구조)",type:"question",collapsed:!1,children:z.length>0?z.slice(0,2).map((k,j)=>({title:["내신 반영 비율이 좌우","영어 비중 확대 추세"][j]||`변천 ${j+1}`,type:"keyword",pack:[["고입","대입","내신 비중"],["필수과목","가산점","비중 증가"]][j]||[],explain:k.text,collapsed:!1,children:[]})):[{title:"입시 반영 구조",type:"keyword",pack:["내신","비율","반영"],explain:((we=r[r.length-1])==null?void 0:we.text)||((re=r[0])==null?void 0:re.text)||"내신 반영 비율이 선행학습에 영향을 준다.",collapsed:!1,children:[]}]}]};return{title:s,tree:I}}function rn(t,e,n){if(e>=n)return{...t,children:[]};const r={0:6,1:4,2:3}[e]||2;return{...t,children:t.children.slice(0,r).map(s=>rn(s,e+1,n))}}function Tt(t,e){const n=e==="brief"?2:e==="standard"?3:4;return{title:t.title,tree:rn(t.tree,0,n)}}function Rr(t,e){const n=Math.max(120,at(t)),r=e==="brief"?.13:e==="standard"?.3:.55,s=Math.floor(n*(r-.03)),i=Math.ceil(n*(r+.05));return{min:wt(s,80,999999),max:wt(i,110,999999)}}function rt(t,e,n){const{min:r,max:s}=Rr(n,e),i=[],a=e==="brief"?2:e==="standard"?4:6,o=e==="brief"?1:e==="standard"?2:4,c=(h,g,v,T)=>{g===0?h.children.slice(0,a).forEach((C,S)=>{c(C,g+1)}):g===1?h.children.slice(0,o).forEach((C,S)=>{c(C,g+1)}):g===2&&h.explain&&i.push(h.explain)};c(t.tree,0);const l=[];let u=0;for(const h of i){const g=at(h);if(u+g>s&&l.length>=2||(l.push(h),u+=g,u>=r&&l.length>=(e==="brief"?2:e==="standard"?4:6)))break}return ue(l.join(" "))}function Ir(t){const e=nn(t),n=e.split(/,\s+/g);return n.length>=3?ue(n.slice(0,2).join(", ")+"."):e}function Mr(t){const e=t.title||"핵심",n=(s,i)=>{const a=`${i}_${Math.random().toString(36).substring(7)}`;return{id:a,label:Ir(s.title),children:s.children.map((o,c)=>n(o,`${a}_${c}`))}},r=t.tree.children.map((s,i)=>n(s,`n${i}`));return{center:e,nodes:r}}function jr(t,e){const n=[],r=[],s=i=>{i.explain&&r.push(i.explain),i.children&&i.children.forEach(s)};return s(t.tree),n.push({q:"교육부는 선행학습을 왜 문제로 보는가?",a:r.find(i=>/(교육부|공교육|정상화|우려)/.test(i))||"공교육 정상화 저해 및 격차/태도 악화 우려.",hint:"공교육·격차·참여도"}),n.push({q:"사교육이 말하는 예습과 선행학습의 차이는 무엇인가?",a:r.find(i=>/(사교육|학원|예습|효율)/.test(i))||"예습은 수업 대비, 선행은 다음 학년 과정의 선학습.",hint:"수업 대비 vs 다음 학년"}),e!=="brief"&&n.push({q:"선행학습이 강화되는 제도적 배경은 무엇인가?",a:r.find(i=>/(변천|과정|비율|가산점|내신)/.test(i))||"내신 반영비율/전형/가산점 등 구조 변화가 영향을 준다.",hint:"내신·전형·비율"}),e==="detail"&&n.push({q:"선행학습의 현황(방법)에서 핵심 특징 1가지는?",a:r.find(i=>/(현황|방법|프로그램|평가)/.test(i))||"시험 대비 중심 프로그램과 특강/평가 체계가 운영된다.",hint:"프로그램·특강·평가"}),n}function $r(t){const e=tn(t),n=Nr(e),r=Tt(n,"standard"),s=Tt(n,"brief"),i=rt(n,"detail",e),a=rt(r,"standard",e),o=rt(s,"brief",e),c=(l,u,h)=>({mode:l,narrative:h,structured:u,mindmap:Mr(u),selftest:jr(u,l)});return{brief:c("brief",s,o),standard:c("standard",r,a),detail:c("detail",n,i)}}const Pr=Object.freeze(Object.defineProperty({__proto__:null,buildAllSummariesV4_Quality:$r,sanitizeKoreanAcademicText:tn},Symbol.toStringTag,{value:"Module"}));export{bt as default};
